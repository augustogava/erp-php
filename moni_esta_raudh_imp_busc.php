...
<script>
function seleciona(tipc_user, tip_user){
	opener.form1.usuario.value=tipc_user;
	opener.form1.usuarion.value=tip_user;
	window.close();
}
windowWidth=320;
windowHeight=300;
...
<table width="300" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    <td><form name="form1" method="post" action="">
        <table width="300" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr class="textobold"> 
            <td width="72">Descri&ccedil;&atilde;o:</td>
            <td width="228"> <input name="bcli" type="text" class="formularioselect" id="bcli"></td>
          </tr>
          <tr class="textobold"> 
            <td colspan="2" align="center"> <input name="imageField2" type="image" src="imagens/c_buscar.gif" border="0">
  ...
  <tr>
    <td align="center"><table width="300" border="0" cellpadding="0" cellspacing="1" bgcolor="#003366">
          <tr class="textoboldbranco"> 
            <td width="277">Descri&ccedil;&atilde;o do Usuário: </td>
		...
		?>
          ...
          <?php
			...
			if($results_tot>$maxpag){
				...
				$sql=mysql_query("SELECT * FROM funcionarios $busca ORDER BY nome ASC LIMIT $param, $maxpag");
          ...
          <td align="center"><table width="1%" border="0" cellspacing="0" cellpadding="0">
              <tr valign="top"> 
				...
				if($wp>1){
					$antz=true;
				?>
                  <a href="<?php print "moni_esta_raudh_imp_busc.php?wp=$pg_anterior&bcli=$bcli"; ?>" class="paginacao2"> 
                  <?php } ?>
                ...
                <td align="center"> 
                  ...
                  <a href="<?php print "moni_esta_raudh_imp_busc.php?wp=$link_impressos&bcli=$bcli"; ?>" class="paginacao"> 
                  <?php } ?>
                ...
                <td> 
                  ...
                  <a href="<?php print "moni_esta_raudh_imp_busc.php?wp=$pg_proxima&bcli=$bcli"; ?>" class="paginacao2"> 
                  <?php } ?>
