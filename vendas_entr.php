...
function seleciona(id,nome){
	opener.form1.l_entrega.value=id;
	opener.form1.lo_entrega.value=nome;
	window.close();
}
windowWidth=320;
windowHeight=300;
		...
		?>
          ...
          <?php
			...
			while($res=mysql_fetch_array($sql)){
				...
				$resnome=str_replace("'","",$resc["endereco"]);
		?>
		  <tr bgcolor="#FFFFFF" class="texto"> 
            <td>&nbsp;<?php print "$resnome $resc[bairro] $resc[cep] $resc[cidade] $resc[estado]";  ?></td>
            <td width="20" align="center"><a href="#" onClick="return seleciona('<?php print $res["id"]; ?>','<?php print "$resnome $resc[bairro] $resc[cep] $resc[cidade] $resc[estado]";  ?>');"><img src="imagens/icon_14_use.gif" alt="Selecionar" width="14" height="14" border="0"></a></td>
          </tr>
		  <?php
			}
		}
