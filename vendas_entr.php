...
<table width="300" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td align="center"><table width="300" border="0" cellpadding="0" cellspacing="1" bgcolor="#003366">
		...
		?>
		  <tr bgcolor="#FFFFFF" class="texto"> 
            <td>&nbsp;<? print "$resnome $resc[bairro] $resc[cep] $resc[cidade] $resc[estado]";  ?></td>
            <td width="20" align="center"><a href="#" onClick="return seleciona('<? print $res["id"]; ?>','<? print "$resnome $resc[bairro] $resc[cep] $resc[cidade] $resc[estado]";  ?>');"><img src="imagens/icon_14_use.gif" alt="Selecionar" width="14" height="14" border="0"></a></td>
          </tr>
		  <?
			}
		}
