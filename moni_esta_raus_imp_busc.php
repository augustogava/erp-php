...
<script>
function seleciona(tipc_id,tipc_desc){
	opener.form1.cliente.value=tipc_id;
	opener.form1.nome_cli.value=tipc_desc;
	window.close();
}
windowWidth=320;
windowHeight=300;
          ...
          <td align="center"><table width="1%" border="0" cellspacing="0" cellpadding="0">
              <tr valign="top"> 
				...
				if($wp>1){
					$antz=true;
				?>
                  <a href="<?php print "moni_esta_raus_imp_busc.php?wp=$pg_anterior&bcli=$bcli"; ?>" class="paginacao2"> 
                  <?php } ?>
                ...
                <td align="center"> 
                  ...
                  <a href="<?php print "moni_esta_raus_imp_busc.php?wp=$link_impressos&bcli=$bcli"; ?>" class="paginacao"> 
                  <?php } ?>
                ...
                <td> 
                  ...
                  <a href="<?php print "moni_esta_raus_imp_busc.php?wp=$pg_proxima&bcli=$bcli"; ?>" class="paginacao2"> 
                  <?php } ?>
