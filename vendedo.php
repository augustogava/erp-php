          ...
          <table width="594" border="0" cellpadding="0" cellspacing="1" bgcolor="#003366">
              ...
              <tr bgcolor="#FFFFFF" class="texto" onMouseover="changeto('#CCCCCC')" onMouseout="changeback('#FFFFFF')"> 
               ...
               <?php if($nivel=="1"){ ?>
				...
				<?php } ?>
                <td align="center"><a href="#" onClick="return pergunta('Deseja excluir este funcionário?','funcionarios.php?acao=exc&id=<?php print $res["id"]; ?>')"><img src="imagens/icon14_lixeira.gif" alt="Excluir" width="14" height="14" border="0"></a></td>
              </tr>
              <?php
			  	}
			  }
