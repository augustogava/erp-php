  ...
  <tr> 
    <td align="left" valign="top"><form name="form1" method="post" action="feriados_sql.php" onSubmit="return verifica(this)">
        <table width="400" border="0" cellspacing="0" cellpadding="0">
          <tr> 
            <td width="155" rowspan="7" align="center" valign="middle"> <?php include("calfer.php"); ?></td>
          ...
          <tr> 
            <td><input name="dia" type="text" class="formulario" id="dia" onKeyPress="return validanum(this, event)" onKeyUp="mdata(this)" value="<?php if(!empty($res["dia"])) print banco2data($res["dia"]); ?>" size="10" maxlength="10"> 
              <img src="imagens/dot.gif" width="20" height="8"> <input name="anual" type="checkbox" id="anual" value="S" <?php if($res["anual"]=="S") print "checked"; ?>> 
          ...
          <tr> 
            <td><input name="descricao" type="text" class="formularioselect" id="descricao" value="<?php print $res["descricao"]; ?>" maxlength="100"></td>
          </tr>
          <tr> 
            <td align="right">
<input name="acao" type="hidden" id="acao" value="<?php print $acao; ?>"> 
              <input name="id" type="hidden" id="id" value="<?php print $res["id"]; ?>"> 
              <input name="cal_dia" type="hidden" id="cal_dia" value="<?php print $cal_dia; ?>"> 
          ...
          <tr> 
            <td width="155" align="center" valign="middle"><table width="155" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr class="textobold"> 
                  <td width="15" bgcolor="#<?php print $cornaoutil; ?>">&nbsp;</td>
                ...
                <tr class="textobold"> 
                  <td bgcolor="#<?php print $corferiado; ?>">&nbsp;</td>
                  <td>&nbsp;Feriados</td>
                </tr>
              </table></td>
