...
<tr>
      ...
      <td width="50"><input name="sev[<?= $res["id"]; ?>]" type="text" class="formularioselectsemborda2222" id="sev<?= $res["id"]; ?>" onkeypress="return validanum(this, event)" onkeyup="calcula(<?= $res["id"]; ?>)" value="<?= $res["sev"]; ?>" size="3" maxlength="2" cclass="formulario"></td>
      ...
      <td><input name="causa[<?= $res["id"]; ?>]" type="text" class="formularioselectsemborda2222" id="causa<?= $res["id"]; ?>" size="25" maxlength="255"  value="<?= $res["causa"]; ?>"></td>
      <td width="50"><input name="ocor[<?= $res["id"]; ?>]" type="text" class="formularioselectsemborda2222" id="ocor<?= $res["id"]; ?>" size="3" maxlength="2" onkeypress="return validanum(this, event)" onkeyup="calcula(<?= $res["id"]; ?>)" value="<?= $res["ocor"]; ?>"></td>
      <td><input name="controle[<?= $res["id"]; ?>]" type="text" class="formularioselectsemborda2222" id="controle<?= $res["id"]; ?>" size="25" maxlength="255"  value="<?= $res["controle"]; ?>"></td>
      <td><input name="controle2[<?= $res["id"]; ?>]" type="text"class="formularioselectsemborda2222" id="controle2<?= $res["id"]; ?>" size="25" maxlength="255"  value="<?= $res["controle2"]; ?>"></td>
      <td width="50"><input name="det[<?= $res["id"]; ?>]" type="text" class="formularioselectsemborda2222" id="det<?= $res["id"]; ?>" size="3" maxlength="2" onkeypress="return validanum(this, event)" onkeyup="calcula(<?= $res["id"]; ?>)" value="<?= $res["det"]; ?>"></td>
      <td width="50"><input name="npr[<?= $res["id"]; ?>]" type="text" class="formularioselectsemborda2222" id="npr<?= $res["id"]; ?>" size="3" maxlength="3" onkeypress="return validanum(this, event)" onkeyup="calcula(<?= $res["id"]; ?>)" value="<?= $res["npr"]; ?>"></td>
      ...
      <td width="50"><input name="sev2[<?= $res["id"]; ?>]" type="text" class="formularioselectsemborda2222" id="sev2<?= $res["id"]; ?>" size="3" maxlength="2" onkeypress="return validanum(this, event)" onkeyup="calcula2(<?= $res["id"]; ?>)" value="<?= $res["sev2"]; ?>"></td>
      <td width="50"><input name="ocor2[<?= $res["id"]; ?>]" type="text" class="formularioselectsemborda2222" id="ocor2<?= $res["id"]; ?>" size="3" maxlength="2" onkeypress="return validanum(this, event)" onkeyup="calcula2(<?= $res["id"]; ?>)" value="<?= $res["ocor2"]; ?>"></td>
      <td width="50"><input name="det2[<?= $res["id"]; ?>]" type="text" class="formularioselectsemborda2222" id="det2<?= $res["id"]; ?>" size="3" maxlength="2" onkeypress="return validanum(this, event)" onkeyup="calcula2(<?= $res["id"]; ?>)" value="<?= $res["det2"]; ?>"></td>
