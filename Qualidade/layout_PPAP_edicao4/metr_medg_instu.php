            ...
            <tr>
              <td align="center">
				...
				if($wp>1){
					$antz=true;
				?>
                      <a href="<?php print "metr_medg_instu.php?wp=$pg_anterior&bdesc=$bdesc&bcod=$bcod"; ?>" class="texto">
                      <?php } ?>
            ...
            Anterior</a>
				...
				?>
                    <td align="center">
                      ...
                      <a href="<?php print "metr_medg_instu.php?wp=$link_impressos&bdesc=$bdesc&bcod=$bcod"; ?>" class="texto">
                      <?php } ?>
				...
				?>
                    <td>
                      ...
                      <a href="<?php print "metr_medg_instu.php?wp=$pg_proxima&bdesc=$bdesc&bcod=$bcod"; ?>" class="texto">
                      <?php } ?>
