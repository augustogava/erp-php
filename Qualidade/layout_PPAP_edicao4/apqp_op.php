...
<table width="590" border="0" cellpadding="0" cellspacing="0" class="texto">
      <tr>
        ...
        <td width="563" align="right"><div align="left" class="textobold style1 style1 style1 style1 style1 style1 style1 style1">APQP - Opera&ccedil;&otilde;es <? print $npc; ?></div></td>
      </tr>
      <tr>
        <td align="center">&nbsp;</td>
        <td align="right">&nbsp;</td>
      ...
      <tr>
        <td align="left" valign="top"><form action="apqp_op_sql.php" method="post" name="frmop" id="frmop" onSubmit="return verifica(this);">
            <table width="100" border="0" cellpadding="3" cellspacing="1" bgcolor="#003366">
              <tr>
                <td align="center" bgcolor="#004993" class="textoboldbranco"><? if($acao=="alt"){ print "Alterar"; }else{ print "Incluir"; } ?>
              ...
              <tr>
                <td bgcolor="#FFFFFF"><table width="594" border="0" cellspacing="0" cellpadding="3">
                    <tr class="textobold">
                      ...
                      <td width="115"><input name="numero" type="text" class="formulario" id="numero" value="<? print $res["numero"]; ?>" size="5" maxlength="20">
                          <input name="id" type="hidden" id="id5" value="<? print $id; ?>">
                          <input name="acao" type="hidden" id="acao5" value="<? print $acao; ?>">
                          <input name="op" type="hidden" id="car5" value="<? print $res["id"]; ?>"></td>
                      <td width="93">M&aacute;quina / Local </td>
                      <td width="271"><input name="macloc" type="text" class="formularioselect" id="espec3" value="<? print $res["macloc"]; ?>" maxlength="200"></td>
                    ...
                    <tr class="textobold">
                      ...
                      <td colspan="3"><input name="descricao" type="text" class="formularioselect" id="descricao" value="<? print $res["descricao"]; ?>" maxlength="200"></td>
                    ...
                    <tr class="textobold">
                      ...
                      <td colspan="3"><input name="obs" type="text" class="formularioselect" id="obs" value="<? print $res["obs"]; ?>" size="96" maxlength="200"></td>
                      <td align="center">&nbsp;</td>
                    </tr>
                    <tr class="textobold">
                      <td colspan="5" align="center"><table width="410" border="0" cellpadding="3" cellspacing="1" bgcolor="#999999">
                          ...
                          <tr bgcolor="#FFFFFF" class="textobold">
                            <td width="338" align="center"><input name="tipo" type="radio" value="1" <? if(empty($res["tipo"]) or $res["tipo"]=="1") print "checked"; ?> onClick="return pinta(this.value);">
                          Opera&ccedil;&atilde;o
                          <input name="tipo" type="radio" value="2" <? if($res["tipo"]=="2") print "checked"; ?> onClick="return pinta(this.value);">
                          Opera&ccedil;&atilde;o com Inspe&ccedil;&atilde;o
                          <input name="tipo" type="radio" value="3" <? if($res["tipo"]=="3") print "checked"; ?> onClick="return pinta(this.value);">
                          Inspe&ccedil;&atilde;o</td>
                            <td width="57" rowspan="2" align="center" valign="middle"><span class="texto"><img src="imagens/op_<? if(empty($res["tipo"])){ print "1"; }else{ print $res["tipo"]; } ?>.jpg" name="imop" width="30" height="30" id="imop"></span></td>
                          </tr>
                          <tr bgcolor="#FFFFFF" class="textobold">
                            <td align="center"><input name="tipo" type="radio" value="4" <? if($res["tipo"]=="4") print "checked"; ?>  onClick="return pinta(this.value);">
                          Estocagem
                            <input name="tipo" type="radio" value="5" <? if($res["tipo"]=="5") print "checked"; ?>  onClick="return pinta(this.value);">
                          Transporte
                          <input name="tipo" type="radio" value="6" <? if($res["tipo"]=="6") print "checked"; ?>  onClick="return pinta(this.value);">
                          Decis&atilde;o</td>
                          </tr>
                      </table></td>
                    </tr>
...
&nbsp;&nbsp;
                    <input name="im2" type="button" class="microtxt" value="Continuar" onClick="<?= $btn; ?>">
                      </td>
                    </tr>
                </table></td>
              </tr>
...
?>
            ...
            <form name="frm3" action="apqp_op_sql.php" method="post">
              <tr bgcolor="#FFFFFF">
                <td align="center" class="textobold"><input name="imageField" onClick="<?= $btn3; ?>" type="image" src="imagens/icon14_lixeira.gif" width="14" height="14" border="0">
...
?>
              <tr bgcolor="#FFFFFF" class="textopreto" onMouseover="changeto('#CCCCCC')" onMouseout="changeback('#FFFFFF')">
                <td align="center"><input name="del[<? print $res["id"]; ?>]" type="checkbox" id="del"></td>
                <td align="center"><a href="apqp_op.php?acao=alt&op=<? print $res["id"]; ?>&id=<? print $id; ?>"><img src="imagens/icon14_alterar.gif" alt="Alterar" width="14" height="14" border="0"></a></td>
                <td align="center"><? print $res["numero"]; ?></td>
                <td>&nbsp;<? print $res["descricao"]; ?></td>
                <td>&nbsp;<? print $res["macloc"]; ?></td>
                <td align="center"><img src="imagens/op_<? print $res["tipo"]; ?>.jpg" width="15" height="15"></td>
                <td >&nbsp;<? print $res["obs"]; ?></td>
              </tr>
              <? } ?>
              <tr bgcolor="#FFFFFF">
