      ...
      <table width="102%" border="1" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC">
        <tr>
          <td><table width="377" border="0" cellpadding="0" cellspacing="3">
            ...
            <tr class="textobold">
              <td>&nbsp;CNPJ:</td>
              <td><input name="cnpj" type="text" class="formulario" id="cnpj" value="<? print $cnpj; ?>" size="20" maxlength="15" onKeyPress="return validanum(this, event)" onKeyUp="mcgc(this)" onBlur="bloqueia2();"></td>
            </tr>
            <tr class="textobold">
              <td>&nbsp;Ins. Estadual:</td>
      ...
      <table width="70%" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td><div align="center">
            ...
            <input name="button12" type="button" class="microtxt" value="Voltar" onClick="window.location='rec_forn_busca.php<? if(!empty($bcod) or!empty($bnome)) print "?webmst=cpp"; if(!empty($bcod)) print "&bcod=$bcod"; if(!empty($bnome)) print "&bnome=$bnome";?>';">
  &nbsp;&nbsp;&nbsp;&nbsp;
  <? if($acao=="inc"){?>
