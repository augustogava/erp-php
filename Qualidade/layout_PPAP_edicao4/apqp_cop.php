...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
      ...
      <table width="300" border="0" cellpadding="3">
        ...
        <tr>
          ...
          <td width="248"><input name="bnum" type="text" class="formulario" id="bnum" size="15">
            ...
            <span class="textobold">            </span>            <input name="buscar" type="hidden" id="buscar5" value="true"></td>
        </tr>
      </table>
    </form></td>
  </tr>
  <tr>
    ...
    <td align="left" valign="top">
	  <div align="left"> </div>
	  <table width="80%" border="0" cellpadding="3" cellspacing="1" bgcolor="#999999">
      ...
      <?php
				...
				if($results_tot>$maxpag){
					...
					$sql=mysql_query("SELECT apqp_pc.id,apqp_pc.numero,apqp_pc.nome,apqp_pc.rev,apqp_pc.dtrev,apqp_pc.status,clientes.fantasia FROM apqp_pc,clientes $cond ORDER BY numero ASC, rev ASC LIMIT $param, $maxpag");
