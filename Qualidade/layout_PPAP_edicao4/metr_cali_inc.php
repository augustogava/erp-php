...
$id=Input::request("id");
$data_usoi=Input::request("data_usoi");
$emitido=Input::request("emitido");
$escala1=Input::request("escala1");
$escala2=Input::request("escala2");
$temp=Input::request("temp");
$umidade=Input::request("umidade");
$custo=Input::request("custo");
$tip_inst=Input::request("tip_inst");
$usuario=Input::request("usuario");
$setor=Input::request("setor");
$periodo=Input::request("periodo");
$validade=Input::request("validade");
$marca=Input::request("marca");
$modelo=Input::request("modelo");
$numserie=Input::request("numserie");
$fabricante=Input::request("fabricante");
$tecnico=Input::request("tecnico");
$eng=Input::request("eng");
$end=Input::request("end");
$os=Input::request("os");
$ie=Input::request("ie");
$instrucao=Input::request("instrucao");
$localizacao=Input::request("localizacao");
$revisao=Input::request("revisao");
$unid_med=Input::request("unid_med");
$desenho=Input::request("desenho");
$tensao=Input::request("tensao");
$potencia=Input::request("potencia");
$precisao=Input::request("precisao");
$leitura=Input::request("leitura");
$obs=Input::request("obs");
$cond_rec=Input::request("cond_rec");
$botao_apr=Input::request("botao_apr");
$limpar=Input::request("limpar");
if(!empty($acao)){
...
if($acao=="incluir"){
	$sql=mysql_query("INSERT INTO metrologia_cad (metr_tipi,metr_func_codi,metr_cad_seto,metr_cad_peri,metr_cad_vali,metr_cad_marc,metr_cad_mode,metr_cad_nser,metr_cad_emit,metr_fabr,metr_cust,metr_cad_tecr,metr_cad_enge,metr_cad_ende,metr_cad_os,metr_cad_ie,metr_cad_temp,metr_cad_umur,metr_inst,metr_loca,metr_esca1,metr_esca2,metr_rev,metr_unid,metr_dese,metr_tena,metr_usoi,metr_pote,metr_prec,metr_leit,metr_cad_obsl,metr_stat_a,metr_stat_e) VALUES ('$tip_inst','$usuario','$setor','$periodo','$validade','$marca','$modelo','$numserie','$data3','$fabricante','$val5','$tecnico','$eng','$end','$os','$ie','$val3','$val4','$instrucao','$localizacao','$val','$val2','$revisao','$unid_med','$desenho','$tensao','$data2','$potencia','$precisao','$leitura','$obs','Aguardando Aprovação','Aguardando Aprovação')") or erp_db_fail();
	if($sql){
