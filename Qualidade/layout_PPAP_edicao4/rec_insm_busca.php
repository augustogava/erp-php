          ...
          <td><table width="445" border="0" cellpadding="0" cellspacing="1" bgcolor="#999999">
            <tr class="textobold">
              ...
              <tr bgcolor="#FFFFFF" class="textopreto" onMouseover="changeto('#CCCCCC')" onMouseout="changeback('#FFFFFF')"> 
                <td align="center"><? print $res["metr_inst_cod"]; ?></td>
                <td>&nbsp;<? 
				 print $res["metr_tipi_nome"]; ?></td>
                <td align="center">
				<? if($res["metr_inst_sit"]=="1"){ 
					print "Ativo";
                ...
                <td width="20" align="center"><a href="rec_insm.php?acao=alt&id=<? print $res["metr_cad_id"]; ?>"><img src="imagens/icon14_alterar.gif" alt="Alterar" width="14" height="14" border="0"></a></td>
                <td width="24" align="center"><a href="#" onClick="return pergunta('Deseja excluir este instrumento?','rec_insm_busca.php?acao=exc&id=<? print $res["metr_cad_id"]; ?>')"><img src="imagens/icon14_lixeira.gif" alt="Excluir" width="14" height="14" border="0"></a></td>
              </tr>
              <?
			  	}
			  }
    ...
    <td align="center"> <table width="1%" border="0" cellspacing="0" cellpadding="0">
        <tr valign="top"> 
          <td align="right"> 
            <? 
				...
				if($wp>1){
					$antz=true;
				?>
            <a href="<? print "rec_insm_busca.php?wp=$pg_anterior&bnome=$bnome&bcod=$bcod"; ?>" class="paginacao2"> 
            <? } ?>
          ...
          <td align="center"> 
            ...
            <a href="<? print "rec_insm_busca.php?wp=$link_impressos&bnome=$bnome&bcod=$bcod"; ?>" class="paginacao"> 
            <? } ?>
          ...
          <td> 
            ...
            <a href="<? print "rec_insm_busca.php?wp=$pg_proxima&bnome=$bnome&bcod=$bcod"; ?>" class="paginacao2"> 
            <? } ?>
