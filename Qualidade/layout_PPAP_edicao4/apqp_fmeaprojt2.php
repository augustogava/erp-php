...
?>
    <tr>
      <td width="20" align="center"><input name="del[<?= $res["id"]; ?>]" type="checkbox" id="del[<?= $res["id"]; ?>]" value="<?= $res["id"]; ?>"></td>
      <td width="225"><input name="modo[<?= $res["id"]; ?>]" type="text" class="formularioselectsemborda2222" id="modo<?= $res["id"]; ?>" size="25" maxlength="255"  value="<?= $res["modo"]; ?>"></td>
      <td width="225"><input name="efeitos[<?= $res["id"]; ?>]" type="text" class="formularioselectsemborda2222" id="efeitos<?= $res["id"]; ?>" size="25" maxlength="255"  value="<?= $res["efeitos"]; ?>"></td>
      <td width="50"><input name="sev[<?= $res["id"]; ?>]" type="text" class="formularioselectsemborda2222"' id="sev<?= $res["id"]; ?>" onkeypress="return validanum(this, event)" onkeyup="calcula(<?= $res["id"]; ?>)" value="<?= $res["sev"]; ?>" size="3" maxlength="4" cclass="formulario"></td>
      <td width="24" align="center"><a href="#"  onClick="return abre('apqp_simbolpopup.php?linha=<?= $res["id"]; ?>','icones','width=520,height=280,scrollbars=1');"><img src="<? if(empty($res["icone"])){ print "imagens/quad.gif"; }else{ print "apqp_fluxo/$res[icone].jpg"; }?>" name="simbol<?= $res["id"]; ?>" width="20" height="20" border="0" id="simbol<?= $res["id"]; ?>"></a><input name="simbolo[<?= $res["id"]; ?>]" type="hidden" id="simbolo<?= $res["id"]; ?>" value="<?= $res["icone"]; ?>"></td>
      <td width="193"><input name="causa[<?= $res["id"]; ?>]" type="text" class="formularioselectsemborda2222"' id="causa<?= $res["id"]; ?>" size="25" maxlength="255"  value="<?= $res["causa"]; ?>"></td>
      <td width="50"><input name="ocor[<?= $res["id"]; ?>]" type="text" class="formularioselectsemborda2222"' id="ocor<?= $res["id"]; ?>" size="3" maxlength="5" onkeypress="return validanum(this, event)" onkeyup="calcula(<?= $res["id"]; ?>)" value="<?= $res["ocor"]; ?>">
      </td>
      <td width="58"><input name="controle[<?= $res["id"]; ?>]" type="text" class="formularioselectsemborda2222"' id="controle<?= $res["id"]; ?>" size="25" maxlength="255"  value="<?= $res["controle"]; ?>"></td>
      <td width="150"><input name="controle2[<?= $res["id"]; ?>]" type="text"class="formularioselectsemborda2222"' id="controle2<?= $res["id"]; ?>" size="25" maxlength="255"  value="<?= $res["controle2"]; ?>"></td>
      <td width="50"><input name="det[<?= $res["id"]; ?>]" type="text" class="formularioselectsemborda2222"' id="det<?= $res["id"]; ?>" size="3" maxlength="4" onkeypress="return validanum(this, event)" onkeyup="calcula(<?= $res["id"]; ?>)" value="<?= $res["det"]; ?>"></td>
      <td width="50"><input name="npr[<?= $res["id"]; ?>]" type="text" class="formularioselectsemborda2222"' id="npr<?= $res["id"]; ?>" size="3" maxlength="6" onkeypress="return validanum(this, event)" onkeyup="calcula(<?= $res["id"]; ?>)" value="<?= $res["npr"]; ?>"></td>
      <td width="125"><input name="ar[<?= $res["id"]; ?>]" type="text" class="formularioselectsemborda2222"' id="ar<?= $res["id"]; ?>" size="25" maxlength="255"  value="<?= $res["ar"]; ?>"></td>
      <td width="125"><input name="resp[<?= $res["id"]; ?>]" type="text" class="formularioselectsemborda2222"' id="resp<?= $res["id"]; ?>" size="10" maxlength="50"  value="<?= $res["resp"]; ?>"></td>
      <td width="100"><input name="prazo[<?= $res["id"]; ?>]" type="text" class="formularioselectsemborda2222"' id="prazo<?= $res["id"]; ?>" size="10" maxlength="10" onkeyup="mdata(this)" onkeypress="return validanum(this, event)"  value="<?= banco2data($res["prazo"]); ?>"></td>
      <td width="125"><input name="at[<?= $res["id"]; ?>]" type="text" class="formularioselectsemborda2222"' id="at<?= $res["id"]; ?>" size="25" maxlength="255"  value="<?= $res["at"]; ?>"></td>
      <td width="50"><input name="sev2[<?= $res["id"]; ?>]" type="text" class="formularioselectsemborda2222"' id="sev2<?= $res["id"]; ?>" size="3" maxlength="4" onkeypress="return validanum(this, event)" onkeyup="calcula2(<?= $res["id"]; ?>)" value="<?= $res["sev2"]; ?>"></td>
      <td width="50"><input name="ocor2[<?= $res["id"]; ?>]" type="text" class="formularioselectsemborda2222"' id="ocor2<?= $res["id"]; ?>" size="3" maxlength="5" onkeypress="return validanum(this, event)" onkeyup="calcula2(<?= $res["id"]; ?>)" value="<?= $res["ocor2"]; ?>"></td>
      <td width="50"><input name="det2[<?= $res["id"]; ?>]" type="text" class="formularioselectsemborda2222"' id="det2<?= $res["id"]; ?>" size="3" maxlength="4" onkeypress="return validanum(this, event)" onkeyup="calcula2(<?= $res["id"]; ?>)" value="<?= $res["det2"]; ?>"></td>
      <td width="85"><input name="npr2[<?= $res["id"]; ?>]" type="text" class="formularioselectsemborda2222"' id="npr2<?= $res["id"]; ?>" size="3" maxlength="6" onkeypress="return validanum(this, event)" onkeyup="calcula2(<?= $res["id"]; ?>)" value="<?= $res["npr2"]; ?>"></td>
    </tr>
<?
	}
...
?><input name="salva" type="hidden" id="salva" value="<?= $salva; ?>"><input name="maisum" type="hidden" id="maisum" value="0"><input name="delsel" type="hidden" id="delsel" value="0">
  </table>
</form>
</body>
</html>
