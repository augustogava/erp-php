...
<table width="590" border="0" cellpadding="0" cellspacing="0" class="texto">
      <tr>
        ...
        <td width="563" align="right"><div align="left" class="textobold style4">APQP - Viabilidade <? print $npc; ?></div></td>
      </tr>
      <tr>
        <td align="center">&nbsp;</td>
        <td align="right">&nbsp;</td>
              ...
              <form name="form1" method="post" action="apqp_viabilidade_sql.php">
                <td bgcolor="#FFFFFF"><table width="571"  border="0" cellspacing="0" cellpadding="3">
                    <tr>
                      ...
                      <td width="89"><input name="data" type="text" class="formularioselect" id="data" onKeyPress="return validanum(this, event)" onKeyUp="mdata(this)" value="<?= banco2data($res["data"]); ?>" size="7" maxlength="10"></td>
                    ...
                    <tr bgcolor="#E6EBF1">
                      <td align="right"><input name="conclusao" type="radio" value="v1" <? if($res["conclusao"]=="v1") print "checked"; ?>></td>
                    ...
                    <tr bgcolor="#E6EBF1">
                      <td align="right"><input name="conclusao" type="radio" value="v2" <? if($res["conclusao"]=="v2") print "checked"; ?>></td>
                    ...
                    <tr bgcolor="#E6EBF1">
                      <td align="right"><input name="conclusao" type="radio" value="in" <? if($res["conclusao"]=="in") print "checked"; ?>></td>
