        ...
        <tr>
          <td><table width="479" border="0" cellpadding="0" cellspacing="3">
            ...
            <tr>
              ...
              <td><input name="valc" type="text" class="formulario" id="valc" size="20" maxlength="20" onKeyPress="return validanum(this, event)" onKeyUp="mdata(this)" value="<? print banco2data($valc);?>" readonly=""></td>
            </tr>
            <tr>
