          ...
          <td><table width="445" border="0" cellpadding="0" cellspacing="1" bgcolor="#999999">
            <tr class="textobold">
              ...
              <tr bgcolor="#FFFFFF" class="textopreto" onMouseover="changeto('#CCCCCC')" onMouseout="changeback('#FFFFFF')"> 
                ...
                <td width="20" align="center"><a href="metr_insm.php?acao=alt&id=<?php print $res["metr_cad_id"]; ?>"><img src="imagens/icon14_alterar.gif" alt="Alterar" width="14" height="14" border="0"></a></td>
                <td width="24" align="center"><a href="#" onClick="return pergunta('Deseja excluir este instrumento?','metr_insm_busca.php?acao=exc&id=<?php print $res["metr_cad_id"]; ?>')"><img src="imagens/icon14_lixeira.gif" alt="Excluir" width="14" height="14" border="0"></a></td>
              </tr>
              <?php
			  	}
			  }
