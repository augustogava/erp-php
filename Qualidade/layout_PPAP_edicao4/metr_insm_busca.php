    ...
    <td width="446"><table width="445" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          ...
          <tr>
            ...
            <td width="363" align="right"><div align="left" class="titulos">Instrumento de Medi&ccedil;&atilde;o</div></td>
          </tr>
          <tr>
            <td align="center">&nbsp;</td>
            <td align="right">&nbsp;</td>
        ...
        <tr> 
          <td><table width="445" border="0" cellpadding="0" cellspacing="1" bgcolor="#999999">
            <tr class="textobold">
              <td colspan="5" align="center" bgcolor="#FFFFFF" class="textobold"><a href="metr_insm.php?acao=inc" class="textobold">Incluir Instrumento </a></td>
              </tr>
              ...
              <tr bgcolor="#FFFFFF" class="textopreto" onMouseover="changeto('#CCCCCC')" onMouseout="changeback('#FFFFFF')"> 
                ...
                <td width="20" align="center"><a href="metr_insm.php?acao=alt&id=<? print $res["metr_cad_id"]; ?>"><img src="imagens/icon14_alterar.gif" alt="Alterar" width="14" height="14" border="0"></a></td>
                <td width="24" align="center"><a href="#" onClick="return pergunta('Deseja excluir este instrumento?','metr_insm_busca.php?acao=exc&id=<? print $res["metr_cad_id"]; ?>')"><img src="imagens/icon14_lixeira.gif" alt="Excluir" width="14" height="14" border="0"></a></td>
              </tr>
              <?
			  	}
			  }
