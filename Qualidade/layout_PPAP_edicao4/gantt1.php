...
/*пппппппппппппппппппппппппппппппппппппппппппппппппппппппппппппппппппппппппппппп
...
$definitions['planned']['legend'] = 'Inэcio';
$definitions['planned_adjusted']['legend'] = 'Plan. Ajustсvel';
...
$definitions['status_report']['legend'] = '┌ltimo Status';
...
$definitions['title_string'] = "Projeto Teste "; //project title
...
$definitions['limit']['end'] = mktime(23,59,11,3,28,2005); //graphic and time limits
...
$definitions['milestones']['milestone'][0]['title']='MILESTONE ETC';
