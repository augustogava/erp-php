...
<table width="590" border="0" cellpadding="0" cellspacing="0" class="texto">
      <tr>
        ...
        <td width="563" align="right"><div align="left" class="textobold style1">APQP - Viabilidade <? print $npc; ?></div></td>
      </tr>
      <tr>
        <td align="center">&nbsp;</td>
        <td align="right">&nbsp;</td>
            ...
            <tr>
              <td bgcolor="#FFFFFF"><table width="571" border="0" cellspacing="0" cellpadding="3">
                  <tr>
                    ...
                    <td width="193" ><input name="tap1" type="text" class="formularioselect" id="tap1" value="<?= $res["ap1"]; ?>"></td>
					 
                    <td width="39"  align="center" class="textobold">Data:</td>
                    <td><input name="dt1" type="text" class="formularioselect" id="dt1" onKeyPress="return validanum(this, event)" onKeyUp="mdata(this)" value="<?= banco2data($res["dt1"]); ?>" size="7" maxlength="10"></td>
				<? 
				  if(empty($res["ap1"])){
				 ...
				 ?>
                  	<td width="160" align="center"><input name="ap1" type="submit" class="microtxt" id="ap1" value="aprovar" onClick="<?= $javas; ?>">
                        &nbsp;
						<input name="lap1" type="submit" class="microtxt" id="lap1" value="limpar" onClick="<?= $javalimp;?>"></td></tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td><input name="dt2" type="text" class="formularioselect" id="dt2" onKeyPress="return validanum(this, event)" onKeyUp="mdata(this)" value="<?= banco2data($res["dt2"]); ?>" size="7" maxlength="10"></td>
					<? 
				  if(empty($res["ap2"])){
				 ...
				 ?>
                  	<td align="center"><input name="ap2" type="submit" class="microtxt" id="ap2" value="aprovar" onClick="<?= $javas2; ?>">
                        &nbsp;
                        <input name="lap2" type="submit" class="microtxt" id="lap2" value="limpar" onClick="<?= $javalimp2;?>"></td>
                  </tr>
                  <tr>
                    <td colspan="5" align="center"><img src="imagens/dot.gif" width="50" height="8"></td>
                  </tr>
                  <tr>
                    ...
                    <td align="center" class="textobold">Data:</td>
                    <td><input name="dt3" type="text" class="formularioselect" id="dt3" onKeyPress="return validanum(this, event)" onKeyUp="mdata(this)" value="<?= banco2data($res["dt3"]); ?>" size="7" maxlength="10"></td>
					<? 
				  if(empty($res["ap3"])){
				 ...
				 ?>
                  <td align="center"><input name="ap3" type="submit" class="microtxt" id="ap3" value="aprovar" onClick="<?= $javas3; ?>">
                        &nbsp;
						<input name="lap3" type="submit" class="microtxt" id="lap3" value="limpar" onClick="<?= $javalimp3;?>"></td></tr>
                  <tr>
                    <td colspan="5" align="center"><img src="imagens/dot.gif" width="50" height="8"></td>
                  </tr>
                  <tr>
                    ...
                    <td align="center" class="textobold">Aprovado por: </td>
                    <td><input name="tap14" type="text" class="formularioselect" id="tap14" value="<?= $res["ap4"]; ?>"></td>
                    <td align="center" class="textobold">Data:</td>
                    <td><input name="dt4" type="text" class="formularioselect" id="dt4" onKeyPress="return validanum(this, event)" onKeyUp="mdata(this)" value="<?= banco2data($res["dt4"]); ?>" size="7" maxlength="10"></td>
					<? 
				  if(empty($res["ap4"])){
				 ...
				 ?>
                  <td align="center"><input name="ap4" type="submit" class="microtxt" id="ap4" value="aprovar" onClick="<?= $javas4; ?>">
                        &nbsp;
						<input name="lap4" type="submit" class="microtxt" id="lap4" value="limpar" onClick="<?= $javalimp4;?>"></td></tr>
                  <tr>
                    <td colspan="5" align="center"><img src="imagens/dot.gif" width="50" height="8"></td>
                  </tr>
                  <tr>
                    ...
                    <td align="center" class="textobold">Aprovado por: </td>
                    <td><input name="tap15" type="text" class="formularioselect" id="tap15" value="<?= $res["ap5"]; ?>"></td>
                    <td align="center" class="textobold">Data:</td>
                    <td><input name="dt5" type="text" class="formularioselect" id="dt5" onKeyPress="return validanum(this, event)" onKeyUp="mdata(this)" value="<?= banco2data($res["dt5"]); ?>" size="7" maxlength="10"></td>
					<? 
				  if(empty($res["ap5"])){
				 ...
				 ?>
                  	<td align="center"><input name="ap5" type="submit" class="microtxt" id="ap5" value="aprovar" onClick="<?= $javas5; ?>">
                        &nbsp;
						<input name="lap5" type="submit" class="microtxt" id="lap5" value="limpar" onClick="<?= $javalimp5;?>"></td></tr>
                  <tr>
                    <td colspan="5" align="center"><img src="imagens/dot.gif" width="50" height="8"></td>
                  </tr>
                  <tr>
                    ...
                    <td align="center" class="textobold">Aprovado por: </td>
                    <td><input name="tap16" type="text" class="formularioselect" id="tap16" value="<?= $res["ap6"]; ?>"></td>
                    <td align="center" class="textobold">Data:</td>
                    <td><input name="dt6" type="text" class="formularioselect" id="dt6" onKeyPress="return validanum(this, event)" onKeyUp="mdata(this)" value="<?= banco2data($res["dt6"]); ?>" size="7" maxlength="10"></td>
					<? 
				  if(empty($res["ap6"])){
				 ...
				 ?>
                  <td align="center"><input name="ap6" type="submit" class="microtxt" id="ap6" value="aprovar" onClick="<?= $javas6; ?>">
                    &nbsp;
					    <input name="lap6" type="submit" class="microtxt" id="lap6" value="limpar" onClick="<?= $javalimp6;?>"></td></tr>
