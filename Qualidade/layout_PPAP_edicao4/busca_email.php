...
<script>
function seleciona(email){
	opener.form1.email.value=email;
	window.close();
}
windowWidth=320;
windowHeight=400;
...
<table width="300" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    <td><form name="form1" method="post" action="">
        <table width="300" border="0" cellspacing="0" cellpadding="3">
          ...
          <tr class="textobold"> 
            <td width="46">&nbsp;Nome:</td>
            <td width="242"> <input name="bcli" type="text" class="formulario" id="bcli" size="35">
            <a href="#" onClick="form1.submit();"><img src="imagens/icon_busca.gif" border="0"></a>
  ...
  <tr>
    <td><table width="300" border="0" cellpadding="3" cellspacing="1" bgcolor="#003366">
		...
		?>
		<tr bgcolor="#FFFFFF" class="textopreto" onMouseover="changeto('#CCCCCC')" onMouseout="changeback('#FFFFFF')"> <a href="#" onClick="return seleciona('<?php print $res["email"]; ?>');">
