...
$pdf->SetXY(5, 5);
$pdf->MultiCell(290,5,"AMFE DE PROCESO",0,'C');
$pdf->SetFont('Arial','',8);
$cliente=$res[pecacli];
...
$pdf->SetXY(55, 18);
$pdf->MultiCell(50,4,"Revisión/Fecha del Plano \n $rev",1);
$pdf->SetXY(105, 18);
...
$pdf->SetXY(105, 26);
$pdf->MultiCell(80,4,"Reponsable por el Proceso \n $resp[resp]",1);
$pdf->SetXY(185, 26);
...
$pdf->SetXY(105, 34);
$pdf->MultiCell(80,4,"Identificación del Producto \n ",1);
$pdf->SetXY(185, 34);
...
$pdf->SetXY(121, 60);
$pdf->MultiCell(70,4," \n Controles Actuales del Proceso (Prevención) \n ",1,'C');
$pdf->SetXY(121, 72);
$pdf->MultiCell(35,8,"Prevención",1,'C');
$pdf->SetXY(156, 72);
$pdf->MultiCell(35,8,"Detección",1,'C');
$pdf->SetXY(191, 60);
...
$pdf->MultiCell(24,4," \n Responsable / Plazo \n \n ",1,'C');
$pdf->SetXY(249, 60);
$pdf->MultiCell(41,4,"Resultado de las Acciones",1,'C');
$pdf->SetXY(249, 64);
