...
$pdf->Cell(35);
$pdf->Cell(0, 18,'Aprobación de Piezas para Produción Resultados');
$pdf->SetXY(68, 5);
$pdf->Cell(0,18,'de las Pruebas de Materiales');
...
//linha 2
$pdf->SetXY(5, 28);
$pdf->MultiCell(50,5,"Nombre del equipo de Inspección \n $local",1);
$pdf->SetXY(55, 28);
...
$pdf->SetXY(20, 40);
$pdf->MultiCell(15,5,"Tipo de Prueba",1,'C');
$pdf->SetXY(35, 40);
$pdf->MultiCell(70,5,"Número especificación de Material \n /Fecha/Especificación",1,'C');
$pdf->SetXY(105, 40);
$pdf->MultiCell(12,5,"Caract. Esp.",1,'C');
$pdf->SetXY(117, 40);
$pdf->MultiCell(70,10,"Resultados de las pruebas del Proveedor ",1,'C');
$pdf->SetXY(187, 40);
...
if(mysql_num_rows($sql)){
	while($res=mysql_fetch_array($sql)){
		if($y>=250){
			...
			$pdf->MultiCell(15,5,"Tipo de Prueba",1,'C');
			$pdf->SetXY(35, 40);
			$pdf->MultiCell(70,5,"Número especificación de \n Material/Fecha/Especificación",1,'C');
			$pdf->SetXY(105, 40);
			$pdf->MultiCell(12,5,"Caract. Esp.",1,'C');
			$pdf->SetXY(117, 40);
			$pdf->MultiCell(70,10,"Resultados de las pruebas del Proveedor ",1,'C');
