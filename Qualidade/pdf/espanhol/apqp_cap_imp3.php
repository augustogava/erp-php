...
$pdf->SetFont('Arial','',8);
$pdf->SetXY(155, 18);
$pdf->MultiCell(50,4,"Nº Plano / Nivel E/C / Fecha (Cliente) \n ",1);
$pdf->SetFont('Arial','',8);
$pdf->SetXY(155, 22);
...
$pdf->SetXY(105, 26);
$pdf->SetFont('Arial','',8);
$pdf->MultiCell(50,4,"Número de la Pieza (Proveedor) \n ",1);
$pdf->SetXY(105, 30);
$pdf->SetFont('Arial','',8);
$pdf->MultiCell(100,4,$numero,0);
$pdf->SetFont('Arial','',8);
$pdf->SetXY(155, 26);
$pdf->MultiCell(50,4,"Nivel (Suministrador)\n ",1);
$pdf->SetFont('Arial','',8);
$pdf->SetXY(155, 30);
...
$pdf->SetXY(50, 42);
$pdf->MultiCell(105,4,"Ìndice (Cavidade/Molde) \n ",1);
$pdf->SetXY(50, 46);
...
$pdf->SetXY(15, 68);
$pdf->MultiCell(20,4,"Muestra 1",1,'C');
$pdf->SetXY(35, 68);
$pdf->MultiCell(25,4,"Muestra 2",1,'C');
$pdf->SetXY(60, 68);
$pdf->MultiCell(25,4,"Muestra 3",1,'C');
$pdf->SetXY(85, 68);
$pdf->MultiCell(25,4,"Muestra 4",1,'C');
$pdf->SetXY(110, 68);
$pdf->MultiCell(25,4,"Muestra 5",1,'C');
$pdf->SetXY(135, 68);
$pdf->MultiCell(30,4,"Média",1,'C');
$pdf->SetXY(165, 68);
$pdf->MultiCell(40,4,"Rango",1,'C');
//linha 7
$x=72;
for($i=1;$i<=$resp["nli"];$i++){
	if($x>=250){
		...
		$pdf->SetFont('Arial','',8);
		$pdf->SetXY(105, 18);
		$pdf->MultiCell(50,4,"Número  Pieza (Client) \n ",1);
		$pdf->SetFont('Arial','',8);
		$pdf->SetXY(105, 22);
		$pdf->MultiCell(100,4,$peca,0);
		$pdf->SetFont('Arial','',8);
...
$pdf->SetXY(5, $x);
$pdf->SetFont('Arial','B',14);
$pdf->MultiCell(200,5,"RESULTADOS DEL ESTUDIO",0,'C');
$x=$x+10;
//linha 7
$pdf->SetFont('Arial','B',8);
$pdf->SetXY(5, $x);
$pdf->MultiCell(200,5,"Información del Muestreo",1,'C');
$x=$x+5;
$pdf->SetXY(5, $x);
$pdf->MultiCell(200,5,"",1);
//linha 8
$pdf->SetXY(5, $x);
$pdf->MultiCell(35,5,"LII: ".banco2valor3($resc["lie"])."",0,'C');
$pdf->SetXY(40, $x);
$pdf->MultiCell(35,5,"LSI:".banco2valor3($resc["lse"])."",0,'C');
$pdf->SetXY(75, $x);
$pdf->MultiCell(35,5,"X:".banco2valor3($resp["xbar"])."",0,'C');
$pdf->SetXY(110, $x);
$pdf->MultiCell(30,5,"R:".banco2valor3($resp["rbar"])."",0,'C');
$pdf->SetXY(140, $x);
$pdf->MultiCell(30,5,"Menor Med:".banco2valor3($resp["min"])."",0,'C');
$pdf->SetXY(170, $x);
$pdf->MultiCell(30,5,"Mayor Med:".banco2valor3($resp["max"])."",0,'C');
//linha nova
$x=$x+5;
$pdf->SetXY(5, $x);
$pdf->MultiCell(200,5,"Cantidad d Puntos Fuera de las Especificaciones: ".$resp["pf"]."",1,'L');
$pdf->SetXY(140, $x);
$pdf->MultiCell(30,5,"Menor Ran:".banco2valor3($resp["rmin"])."",0,'C');
$pdf->SetXY(170, $x);
$pdf->MultiCell(30,5,"Mayor Ran:".banco2valor3($resp["rmax"])."",0,'C');
//linha 9
$x=$x+10;
$pdf->SetFont('Arial','B',8);
$pdf->SetXY(5, $x);
$pdf->MultiCell(200,5,"Limites de Control",1,'C');
//linha 10
$x=$x+5;
$pdf->SetXY(5, $x);
$pdf->MultiCell(100,5,"Gráfico de Médias",1,'C');
$pdf->SetXY(105, $x);
$pdf->MultiCell(100,5,"Gráfico de Rangos",1,'C');
//linha 11
$x=$x+5;
$pdf->SetXY(5, $x);
$pdf->MultiCell(100,5,"Límite de Control Inferior (LCI): ".banco2valor3($resp["lcl"])."",1);
$pdf->SetXY(105, $x);
$pdf->MultiCell(100,5,"Límite de Control Inferior (LCI): ".banco2valor3(0)."",1);
//linha 12
$x=$x+5;
$pdf->SetXY(5, $x);
$pdf->MultiCell(100,5,"Límite de Control Superior (LCS): ".banco2valor3($resp["uclx"])."",1);
$pdf->SetXY(105, $x);
$pdf->MultiCell(100,5,"Límite de Control Superior (LCS): ".banco2valor3($resp["uclr"])."",1);
//linha nova P_F media e amp
$x=$x+5;
$pdf->SetXY(5, $x);
$pdf->MultiCell(100,5,"Cantidad de Puntos Fuera de los Límites de control: ".$resp["mpf"]."",1);
$pdf->SetXY(105, $x);
$pdf->MultiCell(100,5,"Cantidad de Puntos Fuera de los Límites de control: ".$resp["apf"]."",1);
//linha 13
$x=$x+10;
$pdf->SetXY(5, $x);
$pdf->MultiCell(100,5,"Capacidad del Proceso",1,'C');
$pdf->SetXY(105, $x);
$pdf->MultiCell(100,5,"Funcionamento del Proceso",1,'C');
//linha 14
$x=$x+5;
$pdf->SetXY(5, $x);
...
$pdf->MultiCell(100,10,"",1,'C');
$pdf->SetXY(7, $x);
$pdf->MultiCell(60,5,"Desviación Típica: ".banco2valor3($resp["sigma"])."",0,'C');
$pdf->SetXY(107, $x);
$pdf->MultiCell(60,5,"Desviación Típica: ".banco2valor3($resp["sigma"])."",0,'C');
$pdf->SetXY(57, $x);
...
$pdf->SetXY(5, $x);
if($resp["sit"]==0){ $show="pendente"; }elseif($resp["sit"]==1){ $show="approbado"; }else{ $show="reprovado"; }
$pdf->MultiCell(65,5,"Disposición: ".$show."",0,'C');
$pdf->SetXY(70, $x);
$pdf->MultiCell(65,5,"Responsable: ".$resp["quem"]."",0,'C');
$pdf->SetXY(135,$x);
$pdf->MultiCell(65,5,"Fecha: ".banco2data($resp["dtquem"])."",0,'C');
//fim
