...
$pdf->SetXY(115, 38);
$pdf->MultiCell(90,5,"Nombre del laboratorio: $local",1);

//linha 3/
$pdf->SetFont('Arial','B',7.5);
$pdf->SetXY(5, 43);
$pdf->MultiCell(61,10,"Nº de Espec. Material / Rev / Fecha",1,'C');
$pdf->SetXY(66, 43);
...
$pdf->SetFont('Arial','B',7.5);
$pdf->SetXY(115, 43);
$pdf->MultiCell(72,10,"Resultados de la Prueba del Surtidor (Fecha)",1,'C');
$pdf->SetXY(187, 43);
