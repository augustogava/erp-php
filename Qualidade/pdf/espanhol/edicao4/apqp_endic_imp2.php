...
$pdf->SetXY(17, 43);
$pdf->MultiCell(43,10,"Dimension/Especificación",1,'C');
$pdf->SetXY(60, 43);
...
$pdf->SetFont('Arial','B',7.5);
$pdf->SetXY(109, 43);
$pdf->MultiCell(80,5,"Resultados das Mediciones (fecha)",1,'C');
$pdf->SetXY(109, 48);
$pdf->MultiCell(40,5,"Por el Organización",1,'C');
$pdf->SetXY(149, 48);
$pdf->MultiCell(40,5,"Por el Cliente",1,'C');
$pdf->SetXY(189, 43);
$pdf->MultiCell(8,10,"OK",1,'C');
$pdf->SetXY(197, 43);
$pdf->MultiCell(8,5,"No \nOK",1,'C');
