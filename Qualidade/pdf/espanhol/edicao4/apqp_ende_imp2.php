...
$pdf->SetXY(40, 5);
$pdf->Cell(27);
$pdf->Cell(0, 8, 'Resultado de las Pruebas de Funcionamento');
...
$pdf->SetXY(5, 28);
$pdf->MultiCell(110,5,"Nombre del laboratorio: $local");
$pdf->SetXY(5, 33);
...
$pdf->SetXY(5, 43);
$pdf->MultiCell(61,10,"Prueba Espec. / Rev / Fecha",1,'C');
$pdf->SetXY(66, 43);
...
$pdf->SetFont('Arial','B',7.5);
$pdf->SetXY(115, 43);
$pdf->MultiCell(72,5,"Resultados de la Prueba del Surtidor (Fecha) Condiciones De Prueba",1,'C');
$pdf->SetXY(187, 43);
...
if(mysql_num_rows($sql)){
	while($res=mysql_fetch_array($sql)){
		...
		$pdf->SetFont('Arial','',6);
		$pdf->SetXY(5,$y);
		$pdf->MultiCell(61,$w,"$res[descricao] - $res[espec]",0);
		if(!empty($res["lie"])){
			$pdf->SetXY(66,$y);
