...
if($tipo=="msa"){
	$sql=mysql_query("SELECT * FROM msa_cap WHERE id='$idc' $s");
	if(mysql_num_rows($sql)) $resp=mysql_fetch_array($sql);
	$sql=mysql_query("SELECT * FROM msa_car WHERE id='$resp[car]'");
...
$pdf->AddPage();
if($logo=="OK"){
$pdf->Image('empresa_logo/logo.jpg',5,1,25); // fora do pdf
}else{
$pdf->Image('../empresa_logo/logo.jpg',5,1,25); // dentro do pdf
}
//campos do cabeçario
$cliente=$res["nomecli"];
$peca=$res["pecacli"];
...
$pdf->SetXY(15, 68);
$pdf->MultiCell(20,4,"Amostra 1",1,'C');
$pdf->SetXY(35, 68);
$pdf->MultiCell(25,4,"Amostra 2",1,'C');
$pdf->SetXY(60, 68);
$pdf->MultiCell(25,4,"Amostra 3",1,'C');
$pdf->SetXY(85, 68);
$pdf->MultiCell(25,4,"Amostra 4",1,'C');
$pdf->SetXY(110, 68);
$pdf->MultiCell(25,4,"Amostra 5",1,'C');
$pdf->SetXY(135, 68);
...
$pdf->SetXY(5, $x);
$pdf->SetFont('Arial','B',14);
$pdf->MultiCell(200,5,"Resultado Dos Estudos",0,'C');
$x=$x+10;
//linha 7
$pdf->SetFont('Arial','B',8);
$pdf->SetXY(5, $x);
$pdf->MultiCell(200,5,"Informações das Amostras",1,'C');
$x=$x+5;
$pdf->SetXY(5, $x);
$pdf->MultiCell(200,5,"",1);
//linha 8
$pdf->SetXY(5, $x);
$pdf->MultiCell(35,5,"LIE: ".banco2valor3($resc["lie"])."",0,'C');
$pdf->SetXY(40, $x);
$pdf->MultiCell(35,5,"LSE:".banco2valor3($resc["lse"])."",0,'C');
$pdf->SetXY(75, $x);
$pdf->MultiCell(35,5,"X:".banco2valor3($resp["xbar"])."",0,'C');
$pdf->SetXY(110, $x);
$pdf->MultiCell(30,5,"R:".banco2valor3($resp["rbar"])."",0,'C');
$pdf->SetXY(140, $x);
$pdf->MultiCell(30,5,"Menor Me:".banco2valor3($resp["min"])."",0,'C');
$pdf->SetXY(170, $x);
$pdf->MultiCell(30,5,"Maior Me:".banco2valor3($resp["max"])."",0,'C');
//linha nova
$x=$x+5;
$pdf->SetXY(5, $x);
$pdf->MultiCell(200,5,"Número de Pontos fora das especificações: ".$resp["pf"]."",1,'L');
$pdf->SetXY(140, $x);
$pdf->MultiCell(30,5,"Menor Amp:".banco2valor3($resp["rmin"])."",0,'C');
$pdf->SetXY(170, $x);
$pdf->MultiCell(30,5,"Maior Amp:".banco2valor3($resp["rmax"])."",0,'C');
//linha 9
$x=$x+10;
$pdf->SetFont('Arial','B',8);
$pdf->SetXY(5, $x);
$pdf->MultiCell(200,5,"Limites de Controle",1,'C');
//linha 10
$x=$x+5;
$pdf->SetXY(5, $x);
$pdf->MultiCell(100,5,"Cartas de Médias",1,'C');
$pdf->SetXY(105, $x);
$pdf->MultiCell(100,5,"Cartas de Amplitudes",1,'C');
//linha 11
$x=$x+5;
$pdf->SetXY(5, $x);
$pdf->MultiCell(100,5,"Limite de Controle Inferior (LCI): ".banco2valor3($resp["lcl"])."",1);
$pdf->SetXY(105, $x);
$pdf->MultiCell(100,5,"Limite de Controle Inferior (LCI): ".banco2valor3(0)."",1);
//linha 12
$x=$x+5;
$pdf->SetXY(5, $x);
$pdf->MultiCell(100,5,"Limite de Controle Superior (LCS): ".banco2valor3($resp["uclx"])."",1);
$pdf->SetXY(105, $x);
$pdf->MultiCell(100,5,"Limite de Controle Superior (LCS): ".banco2valor3($resp["uclr"])."",1);
//linha nova P_F media e amp
$x=$x+5;
$pdf->SetXY(5, $x);
$pdf->MultiCell(100,5,"Número de Pontos fora das especificações: ".$resp["mpf"]."",1);
$pdf->SetXY(105, $x);
$pdf->MultiCell(100,5,"Número de Pontos fora das especificações: ".$resp["apf"]."",1);
//linha 13
$x=$x+10;
$pdf->SetXY(5, $x);
$pdf->MultiCell(100,5,"Capabilidade",1,'C');
$pdf->SetXY(105, $x);
$pdf->MultiCell(100,5,"Performace",1,'C');
//linha 14
$x=$x+5;
$pdf->SetXY(5, $x);
...
$pdf->MultiCell(100,10,"",1,'C');
$pdf->SetXY(7, $x);
$pdf->MultiCell(60,5,"Desvio Padrão: ".banco2valor3($resp["sigma"])."",0,'C');
$pdf->SetXY(107, $x);
$pdf->MultiCell(60,5,"Desvio Padrão: ".banco2valor3($resp["sigma"])."",0,'C');
$pdf->SetXY(57, $x);
...
$pdf->MultiCell(65,5,"Disposição: ".$show."",0,'C');
$pdf->SetXY(70, $x);
$pdf->MultiCell(65,5,"Responsável: ".$resp["quem"]."",0,'C');
$pdf->SetXY(135,$x);
$pdf->MultiCell(65,5,"Data: ".banco2data($resp["dtquem"])."",0,'C');
//em baixo rodape
