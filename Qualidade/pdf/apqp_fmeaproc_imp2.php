...
$pdf->SetXY(185, 18);
$pdf->MultiCell(105,4,"Número da FMEA \n $fmea",1);
//linha 2
$pdf->SetXY(5, 26);
...
$sql=mysql_query("SELECT apqp_fmeaproci.* FROM apqp_fmeaproci,apqp_fmeaproc,apqp_op WHERE apqp_op.id=apqp_fmeaproci.item AND apqp_fmeaproc.peca='$pc' AND apqp_op.peca='$pc' AND apqp_fmeaproci.fmea=apqp_fmeaproc.id order by apqp_op.numero,apqp_fmeaproci.ordem,apqp_fmeaproci.id asc");
