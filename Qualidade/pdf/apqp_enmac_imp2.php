...
$pdf->SetXY(117, 40);
$pdf->MultiCell(70,5,"Resultados dos Ensaios",1,'C');
$pdf->SetXY(117, 45);
$pdf->MultiCell(35,5,"Pelo Fornecedor",1,'C');
$pdf->Line(152,50,152,255);
$pdf->SetXY(152, 45);
$pdf->MultiCell(35,5,"Pelo Cliente",1,'C');
$pdf->SetXY(187, 40);
...
if(mysql_num_rows($sql)){
	while($res=mysql_fetch_array($sql)){
		...
		$tam1[3]=1;
		$tam1[4]=flinha($res["forn"],35);
		if($tam1[4]==0){$tam1[4]=1;}
		$tam1[5]=flinha($res["cli"],35);
		...
		$pdf->SetXY(117, $y);
		$pdf->MultiCell(35,$w,$res["forn"],0);
		$pdf->SetXY(152, $y);
		$pdf->MultiCell(35,$w,$res["cli"],0);
