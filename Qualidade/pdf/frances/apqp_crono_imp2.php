...
$pdf->Cell(70);
$pdf->Cell(0, 18, 'PROGRAMME DE LA PLANIFICATION ANTECIPÉE DE LA QUALITÉ');
$pdf->SetXY(260, 5);
...
$pdf->SetXY(105, 18);
$pdf->MultiCell(80,5,"Nom de la Piéce \n $res[nome]",1);
$pdf->SetXY(185, 18);
$pdf->MultiCell(105,5,"Client\n $res[nomecli]",1);
$pdf->SetXY(5, 28);
$pdf->MultiCell(100,5,"Fournisseur\n $rese[razao]",1);
$pdf->SetXY(105, 28);
$pdf->MultiCell(80,5,"Numéro de Piéce / Révision (Fournisseur) \n $res[numero] - $res[rev]",1);
$pdf->SetXY(185, 28);
$pdf->MultiCell(75,5,"Approuvé Par  \n $res[crono_quem]",1);
$pdf->SetXY(260, 28);
$pdf->MultiCell(30,5,"Date \n ".banco2data($res["crono_dtquem"])."",1);
$pdf->SetXY(5, 45);
$pdf->SetFont('Arial','B',8);
$pdf->Cell(90,5,'Activité',1,1,'C');
$pdf->SetXY(95, 45);
$pdf->Cell(45,5,'Responsable',1,1,'C');
$pdf->SetXY(140, 45);
$pdf->Cell(25,5,'Début Proposée',1,1,'C');
$pdf->SetXY(165, 45);
$pdf->Cell(20,5,'Prazo',1,1,'C');
$pdf->SetXY(185, 45);
$pdf->Cell(22.5,5,'Fin Proposée',1,1,'C');
$pdf->SetXY(207.5, 45);
$pdf->Cell(17.5,5,'% Compl.',1,1,'C');
$pdf->SetXY(225, 45);
$pdf->Cell(65,5,'Remarques',1,1,'C');
$pdf->SetFont('Arial','',8);
$i=50;
...
if(mysql_num_rows($sql)){
	while($res=mysql_fetch_array($sql)){
		...
		$pdf->SetXY(185, $i);
		$pdf->Cell(22.5,5,banco2data($res["fim"]),1,1,'C');
		$pdf->SetXY(207.5, $i);
