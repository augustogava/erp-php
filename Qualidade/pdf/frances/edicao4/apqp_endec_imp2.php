...
$pdf->SetXY(40, 5);
$pdf->Cell(38);
$pdf->Cell(0, 10, 'Résultats Essais Performance');
...
$pdf->SetXY(109, 18);
$pdf->MultiCell(90,5,"Numéro Piéce (Client): $num");
//linha 2
$pdf->SetXY(5, 28);
$pdf->MultiCell(104,15,"",1);
$pdf->SetXY(5, 28);
$pdf->MultiCell(110,5,"Nom de Laboratoire: $local");
$pdf->SetXY(5, 33);
$pdf->MultiCell(110,5,"* Code de Fournisseur Indiqué Par Client.");

$pdf->SetFont('Arial','',6);
$pdf->SetXY(5, 38);
$pdf->MultiCell(110,5,"* si l'approbation de source est requered, incluent le fournisseur (source) et le code assigné par client.");
...
$pdf->SetXY(5, 43);
$pdf->MultiCell(55,10,"Nº De Spécif. Matérielles/Rév./Date",1,'C');
$pdf->SetXY(60, 43);
$pdf->MultiCell(25,5,"Spécifications / Limites",1,'C');
$pdf->SetXY(85, 43);
$pdf->MultiCell(12,5,"Date \nd'essai",1,'C');
$pdf->SetXY(97, 43);
$pdf->MultiCell(12,5,"Quant.\nExam.",1,'C');
$pdf->SetXY(109, 43);
$pdf->MultiCell(80,5,"Résultats d'essai (Date)Conditions d'essai",1,'C');
$pdf->SetXY(109, 48);
$pdf->MultiCell(40,5,"Par Le Fournisseur",1,'C');
$pdf->SetXY(149, 48);
$pdf->MultiCell(40,5,"Par Le Client",1,'C');
$pdf->SetXY(189, 43);
$pdf->MultiCell(8,10,"Con",1,'C');
$pdf->SetFont('Arial','B',7);
$pdf->SetXY(197, 43);
$pdf->MultiCell(8,5,"Non Conf",1,'C');
$pdf->SetFont('Arial','B',7.5);
