...
$pdf->SetXY(6, 11);
$pdf->MultiCell(50,5,"Désignation de Piéce:");
$pdf->SetXY(33, 11);
$pdf->MultiCell(80,5,$res["nome"]);
$pdf->Line(33,16,100,16);
$pdf->SetXY(100, 11);
$pdf->MultiCell(40,5,"Numéro de Piéce (Client):");
$pdf->SetXY(130, 11);
...
// linha 2
$pdf->SetXY(6, 16);
$pdf->MultiCell(70,5,"Nombre de l'ordre de l'achat de l'outil:");
$pdf->SetXY(49, 16);
$pdf->MultiCell(50,5,$res["num_ferram"]); 
$pdf->Line(49,21,100,21);
$pdf->SetXY(101, 16);
$pdf->MultiCell(70,5,"Modification Technique:");
$pdf->SetXY(130, 16);
...
$pdf->Line(38,36,55,36);
$pdf->SetXY(55, 31);
$pdf->MultiCell(100,5,"Vérification Du Niveau De Changement D'Enginnering D'Aide:");
$pdf->SetXY(125, 31);
$pdf->MultiCell(35,5,$res["aux_nivel"]);
$pdf->Line(125,36,153,36);
$pdf->SetXY(160, 31);
$pdf->MultiCell(10,5,"Daté:");
$pdf->SetXY(170, 31);
...
$pdf->SetXY(25, 79.5);
$pdf->MultiCell(77.5,2.5,"Est-ce que des substances client-exigées d'information de souci a été rapportées?",0,'');
...
$pdf->SetXY(25, 89.5);
$pdf->MultiCell(77.5,2.5,"Les piéces en matiére plastic sont-elles identifiées par les codes de marquage ISO appropriés?",0,'');
...
$pdf->SetFont('Arial','',7);
$pdf->SetXY(6,172);
$pdf->MultiCell(195,4,"J'affirme que les échantillons représentés par cette garantie sont représentant de nos pièces et ont été faits aux schémas et aux caractéristiques applicables de client et sont faits à partir des matériaux indiqués sur l'outillage régulier de production sans des opérations autres que le procédé de production régulier. Je certifie également que l'évidence documentée d'une telle conformité est sur le dossier et disponible pour la revue. J'ai noté toutes les déviations de cette déclaration ci-dessous.");
$pdf->SetXY(6,187);
$pdf->MultiCell(40,5,"EXPLICATION/COMMENTAIRES:");
$pdf->SetXY(45,187);
$pdf->MultiCell(155,5,$resp["coments"]);
$pdf->Line(45,192,200,192);
$pdf->Line(45,197,200,197);
// linha 17
$pdf->SetXY(6,197);
$pdf->MultiCell(70,5,"Moule / Cavité / Processus de Production");
$pdf->SetXY(54,197);
$pdf->MultiCell(70,5,$resp["atende_pq"]);
$pdf->Line(54,202,200,202);

//linha 18
$pdf->SetXY(6,202);
$pdf->MultiCell(55,5,"L'Organisation A autorisé La Signature");
$pdf->SetXY(50,202);
if($resp["assi_for"]=="D"){
	//Assinatura - - 
...
$pdf->SetFont('Arial','B',7);
$pdf->SetXY(0,219);
$pdf->MultiCell(200,5,"RESERVE AU CLIENT SEULEMENT",0,'C');
$pdf->SetFont('Arial','',7);
$pdf->SetXY(6,224);
$pdf->MultiCell(50,5,"Disposition De Garantie de PPAP:");
...
$pdf->MultiCell(3,3," ",1);
$pdf->SetXY(55,229);
$pdf->MultiCell(50,5,"Approbation D'Intérim");
...
$pdf->SetXY(6,239);
$pdf->MultiCell(30,5,"Nom");
$pdf->SetXY(14,239);
$pdf->MultiCell(64,5,"$res[nomecli]");
$pdf->Line(14,244,65,244);

$pdf->Line(100,224,100,255); // divide coluna

$pdf->SetXY(105,224);
$pdf->MultiCell(60,5,"Commentaire:");
$pdf->SetXY(110,230);
