...
$pdf->SetXY(45, 5);
$pdf->Cell(47);
$pdf->Cell(0, 10, 'Résultats Essais Matiére');
...
$pdf->SetXY(5, 28);
$pdf->MultiCell(110,5,"Fournisseur Matériel: $resp[forn_mat]");
$pdf->SetXY(5, 33);
...
$pdf->SetXY(109, 38);
$pdf->MultiCell(96,5,"Nom de Laboratoire: $local",1);
...
$pdf->SetXY(109, 43);
$pdf->MultiCell(80,5,"Résultats d'essai (Date)",1,'C');
$pdf->SetXY(109, 48);
$pdf->MultiCell(40,5,"Par Le Fournisseur",1,'C');
$pdf->SetXY(149, 48);
$pdf->MultiCell(40,5,"Par Client",1,'C');
$pdf->SetXY(189, 43);
