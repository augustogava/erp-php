...
$pdf->SetXY(5, 4);
$pdf->MultiCell(290,5,"PLAN DE SURVEILLANCE",0,'C');
$pdf->SetFont('Arial','',8);
$pdf->SetXY(260, 8);
$pg=1;
$pdf->SetXY(260, 5);
...
$pdf->SetXY(135, 18);
$pdf->MultiCell(50,5,"Plan / Indice de Révision / Date \n $rev",1);
$pdf->SetXY(185, 18);
...
$pdf->SetXY(225, 18);
$pdf->MultiCell(30,10,"Pré-Production");
if($resp["fase"]==3){ $fig3="2"; }else{ $fig3="1"; }
$pdf->Image("imagens/icon14_check$fig3.jpg",250,20,4,4);
$pdf->SetXY(255, 18);
$pdf->MultiCell(30,10,"Série");
//linha 2
$pdf->SetXY(5, 28);
$pdf->MultiCell(35,5,"No. Plan de Surv. \n $resp[numero]",1);
$pdf->SetXY(40, 28);
$pdf->MultiCell(95,5,"Nom de Piéce \n $res[nome]",1);
$pdf->SetXY(135, 28);
$pdf->MultiCell(90,5,"Fournisseur / Usine \n $rese[razao]",1);
$pdf->SetXY(225, 28);
$pdf->MultiCell(30,5,"Code Fournisseur \n ",1);
$pdf->SetXY(255, 28);
$pdf->MultiCell(35,5,"Rév. Date \n ".banco2data($resp["rev"])."",1);
//linha 3
$pdf->SetXY(5, 38);
$pdf->MultiCell(130,5,"Equipe Principale \n $resp[equipe]",1);
$pdf->SetXY(135, 38);
$pdf->MultiCell(50,5,"Approbation du Fournisseur / Date  \n ".$resp["quem"]." / ".banco2data($resp["dtquem"])."",1);
$pdf->SetXY(185, 38);
$pdf->MultiCell(70,5,"Numéro Piéce / Niveau de modification(Fournisseur) \n ".$res["numero"]." - ".$res["rev"]."",1);
$pdf->SetXY(255, 38);
$pdf->MultiCell(35,5,"Date (Original) \n ".banco2data($resp["ini"])."",1);
//linha 4
$pdf->SetXY(5, 48);
$pdf->MultiCell(130,5,"Approbaation Technique du Client / Date (Si nécessaire) \n ".$resp["apro1"]." / ".banco2data($resp["apro1_data"])."",1);
$pdf->SetXY(135, 48);
$pdf->MultiCell(90,5,"Approbation Qualité du Cliente / Date (Si nécessaire) \n ".$resp["apro2"]." / ".banco2data($resp["apro2_data"])."",1);
$pdf->SetXY(225, 48);
$pdf->MultiCell(65,5,"Contact Principal / Téléphone  \n $resp[contato]",1);
//linha 5
$pdf->SetXY(5, 58);
$pdf->MultiCell(130,5,"Autre accord / Date (Si nécessaire)  \n ".$resp["apro3"]." / ".banco2data($resp["apro3_data"])."",1);
$pdf->SetXY(135, 58);
$pdf->MultiCell(155,5,"Autre accord / Date (Si nécessaire)   \n ".$resp["apro4"]." / ".banco2data($resp["apro4_data"])."",1);
//linha 6
$pdf->SetXY(5, 70);
$pdf->MultiCell(15,5,"Numéro Piéce/Processus",1,'C');
$pdf->SetXY(20, 70);
$pdf->MultiCell(35,5,"Nom du Processus Description de Opération \n ",1,'C');
$pdf->SetXY(55, 70);
$pdf->MultiCell(35,5,"Machine, Instrument, gabarit, Outils, D´usinage \n ",1,'C');
$pdf->SetXY(90, 70);
$pdf->MultiCell(50,10,"Caractéristiques",1,'C');
	$pdf->SetXY(90, 80);
	$pdf->MultiCell(6,5,"Nº",1,'C');
	$pdf->SetXY(96, 80);
	$pdf->MultiCell(20,5,"Produit",1,'C');
	$pdf->SetXY(116, 80);
	$pdf->MultiCell(24,5,"Processus",1,'C');
$pdf->SetXY(140, 70);
$pdf->MultiCell(5,5,"C a r",1,'C');
$pdf->SetXY(145, 70);
$pdf->MultiCell(115,5,"Méthode",1,'C');
	$pdf->SetXY(145, 75);
	$pdf->MultiCell(30,5,"Spécification et Tolérances",1,'C');
	$pdf->SetXY(175, 75);
	$pdf->MultiCell(25,5,"Moyens de Contrôle ",1,'C');
	$pdf->SetXY(200, 75);
	$pdf->MultiCell(30,5,"Echantillon",1,'C');
		$pdf->SetXY(200, 80);
		$pdf->MultiCell(15,5,"Taile",1,'C');
		$pdf->SetXY(215, 80);
		$pdf->MultiCell(15,5,"Fréque.",1,'C');
	$pdf->SetXY(230, 75);
	$pdf->MultiCell(30,10,"Méthode de Contrôle",1,'C');
$pdf->SetXY(260, 70);
$pdf->MultiCell(30,5,"Réaction Sur le \n Produit et / ou le processus",1,'C');
