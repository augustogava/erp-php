...
$pdf->Cell(60);
$pdf->Cell(0, 18, 'DIAGRAMME FLUX DE PROCESSUS');
...
$pdf->SetXY(105, 28);
$pdf->MultiCell(100,5,"Nom Piéce \n $nome",1);
//linha 3
$pdf->SetXY(5, 38);
$pdf->MultiCell(100,5,"Approuvé Par \n $quem",1);
$pdf->SetXY(105, 38);
$pdf->MultiCell(50,5,"Date \n $dtquem",1);
$pdf->SetXY(155, 38);
$pdf->MultiCell(50,5,"Numéro Piéce / Rév. (Fournisseur) \n $num2",1);
//linha 4
$pdf->Image('imagens/op_1.jpg',8,51,6,6);
$pdf->SetXY(15, 50);
$pdf->MultiCell(30,10,"Opération");
$pdf->Image('imagens/op_2.jpg',38,51,6,6);
$pdf->SetXY(45, 50);
$pdf->MultiCell(40,10,"Opération avec Contrôle");
$pdf->Image('imagens/op_3.jpg',78,51,6,6);
$pdf->SetXY(85, 50);
$pdf->MultiCell(30,10,"Contrôle");
$pdf->Image('imagens/op_4.jpg',108,51,6,6);
$pdf->SetXY(115, 50);
$pdf->MultiCell(30,10,"Stockage Temporaire");
$pdf->Image('imagens/op_5.jpg',138,51,6,6);
$pdf->SetXY(145, 50);
$pdf->MultiCell(30,10,"Mouvement");
$pdf->Image('imagens/op_6.jpg',168,51,6,6);
$pdf->SetXY(175, 50);
$pdf->MultiCell(30,10,"Décision");
//linha 5
$pdf->SetFont('Arial','B',8);
$pdf->SetXY(5, 60);
$pdf->MultiCell(30,10,"Flux",1,'C');
$pdf->SetXY(35, 60);
$pdf->MultiCell(20,10,"Nº Opé.",1,'C');
$pdf->SetXY(55, 60);
$pdf->MultiCell(70,10,"Description de la Opération",1,'C');
$pdf->SetXY(125, 60);
$pdf->MultiCell(80,10,"Remarques",1,'C');
