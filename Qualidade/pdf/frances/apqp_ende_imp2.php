...
$pdf->MultiCell(200,5,"HOMOLOGATION DE PIÉCAS DE PRODUTION RÉSULTATS ESSAIS PERFORMANCE",'C');
...
//linha 2
$pdf->SetXY(5, 28);
$pdf->MultiCell(50,5,"Nom du Laboratoire \n $local",1);
$pdf->SetXY(55, 28);
$pdf->MultiCell(50,5,"Numéro de Piéca / Rév. (Founisseur) \n $num",1);
$pdf->SetXY(105, 28);
...
$pdf->SetXY(30, 40);
$pdf->MultiCell(75,10,"Exigences",1,'C');
$pdf->SetXY(105, 40);
$pdf->MultiCell(15,5,"Freq. estées",1,'C');
$pdf->SetXY(120, 40);
$pdf->MultiCell(10,5,"Qtd. Essai",1,'C');
$pdf->SetXY(130, 40);
$pdf->MultiCell(55,5,"Resultat et exigences d´Essai du Fournisseur ",1,'C');
$pdf->SetXY(185, 40);
$pdf->MultiCell(10,10,"Conf",1,'C');
$pdf->SetXY(195, 40);
...
$pdf->SetXY(107, $y);
$pdf->MultiCell(80,5,"Fournisseur Signature \n $resp[rep]",1,'');
$pdf->SetXY(187, $y);
