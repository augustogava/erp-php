...
$pdf->SetXY(5, 5);
$pdf->MultiCell(290,5,"AMDEC DE PROCESSUS",0,'C');
$pdf->SetFont('Arial','',8);
$cliente=$res[pecacli];
...
$pdf->SetFont('Arial','',8);
$pdf->SetXY(5, 18);
$pdf->MultiCell(50,4,"Numéro de Piéce (Client) \n $cliente",1);
$pdf->SetXY(55, 18);
$pdf->MultiCell(50,4,"Numéro de Plan / Rév. / Date \n $rev",1);
$pdf->SetXY(105, 18);
$pdf->MultiCell(80,4,"Nom de Piéce \n $peca",1);
$pdf->SetXY(185, 18);
$pdf->MultiCell(105,4,"Numéro AMDEC \n $fmea",1);
//linha 2
$pdf->SetXY(5, 26);
$pdf->MultiCell(100,4,"Prépare Par \n $resp[prep]",1);
$pdf->SetXY(105, 26);
$pdf->MultiCell(80,4,"Responsable du Processus \n $resp[resp]",1);
$pdf->SetXY(185, 26);
$pdf->MultiCell(105,4,"Client \n $res[nomecli]",1);
//linha3
$pdf->SetXY(5, 34);
$pdf->MultiCell(100,4,"Fournisseur \n $rese[razao]",1);
$pdf->SetXY(105, 34);
$pdf->MultiCell(80,4,"Identification de Processus / Demande \n ",1);
$pdf->SetXY(185, 34);
$pdf->MultiCell(105,4,"Numéro de Piéce / Révision (Fournisseur) \n $res[numero] - $res[rev]",1);
//linha4
$pdf->SetXY(5, 42);
$pdf->MultiCell(180,4,"Équipe \n $resp[equipe] ",1);
$pdf->SetXY(185, 42);
$pdf->MultiCell(75,4,"Approuvé Par \n $resp[quem]",1);
$pdf->SetXY(260, 42);
$pdf->MultiCell(30,4,"Date \n ".banco2data($resp["dtquem"])."",1);
//linha5
$pdf->SetXY(5, 50);
$pdf->MultiCell(180,4,"Remarques \n $resp[obs]",1);
$pdf->SetXY(185, 50);
$pdf->MultiCell(37.5,4,"Début Date \n ".banco2data($resp["ini"])."",1);
$pdf->SetXY(222.5, 50);
$pdf->MultiCell(37.5,4,"Mise à Jour \n ".banco2data($resp["rev"])."",1);
$pdf->SetXY(260, 50);
$pdf->MultiCell(30,4,"Date Clef \n ".banco2data($resp["chv"])."",1);
//linha6
$pdf->SetFont('Arial','B',8);
$pdf->SetXY(5, 60);
$pdf->MultiCell(19,4," \n Article ou Fonction \n \n ",1,'C');
...
$pdf->SetXY(46, 60);
$pdf->MultiCell(35,4," \n Effect(s) de la Défaillance \n \n ",1,'C');
$pdf->SetXY(81, 60);
$pdf->MultiCell(4,4,"Sévé  ",1);
$pdf->SetXY(85, 60);
$pdf->MultiCell(4,4,"Class",1);
$pdf->SetXY(89, 60);
$pdf->MultiCell(28,4," \n Cause(s) de la Défaillance \n \n ",1,'C');
$pdf->SetXY(117, 60);
$pdf->MultiCell(4,4,"Ocorr",1,'C');
$pdf->SetXY(121, 60);
$pdf->MultiCell(70,4," \n Contrôle de processus Actuelle\n ",1,'C');
$pdf->SetXY(121, 72);
$pdf->MultiCell(35,8,"Prévention",1,'C');
$pdf->SetXY(156, 72);
$pdf->MultiCell(35,8,"Détection",1,'C');
$pdf->SetXY(191, 60);
$pdf->MultiCell(4,4,"Val i  ",1,'C');
$pdf->SetXY(195, 60);
$pdf->MultiCell(6,4,"   C  r   i     ",1,'C');
$pdf->SetXY(201, 60);
$pdf->MultiCell(24,4," \n Recommandé Actions \n \n ",1,'C');
$pdf->SetXY(225, 60);
$pdf->MultiCell(24,4," \n Responsabilité Et Cible Date d´Achévement \n ",1,'C');
$pdf->SetXY(249, 60);
$pdf->MultiCell(41,4,"Resultats",1,'C');
$pdf->SetXY(249, 64);
$pdf->MultiCell(23,4," \n Actions Prises \n ",1,'C');
$pdf->SetXY(272, 64);
$pdf->MultiCell(4,4,"Sévé",1,'C');
$pdf->SetXY(276, 64);
...
$sql=mysql_query("SELECT apqp_fmeaproci.* FROM apqp_fmeaproci,apqp_fmeaproc,apqp_op WHERE apqp_op.id=apqp_fmeaproci.item AND apqp_fmeaproc.peca='$pc' AND apqp_fmeaproci.fmea=apqp_fmeaproc.id order by apqp_op.numero,apqp_fmeaproci.ordem,apqp_fmeaproci.id asc");
