...
switch($anexo){
	case 1: $anexo2="FMEA du Projet"; break;
	case 2: $anexo2="L'information du projet"; break;
	case 3: $anexo2="Nouveau support d'équipement, d'outil et équipement d'essai"; break;
	case 4: $anexo2="Qualité du produit / Processus"; break;
	case 5: $anexo2="Installations"; break;
	case 6: $anexo2="Organigramme du Processus"; break;
	case 7: $anexo2="FMEA du Processus"; break;
	case 8: $anexo2="Plan de Commande"; break;
}
$y=50;
$pecacli=$res["pecacli"];
$rev=$res["rev"];
...
$pdf->SetXY(50, 7);
$pdf->MultiCell(200,5,"Liste de Vérification de APQP - A$anexo - $anexo2",0,'C');
$pdf->SetXY(260, 5);
$pdf->SetFont('Arial','B',8);
$pdf->MultiCell(40,5,"PPAP Nº $numero \n Page: $pg");
$pdf->SetXY(5, 18);
$pdf->SetFont('Arial','',8);
$pdf->MultiCell(60,5,"Numéro de Piéce (Client) \n $pecacli",1);
$pdf->SetXY(65, 18);
$pdf->MultiCell(60,5,"Numéro du Plan / Rév. / Date \n $rev",1);
$pdf->SetXY(125, 18);
$pdf->MultiCell(80,5,"Nom de Piéce \n $nome",1);
$pdf->SetXY(205, 18);
$pdf->MultiCell(85,5,"Client \n $nomecli",1);
//linha 2
$pdf->SetXY(5, 28);
$pdf->MultiCell(120,5,"Fournisseur \n $razao",1);
$pdf->SetXY(125, 28);
$pdf->MultiCell(80,5,"Numéro de Piéce / Rév (Fournisseur) \n $num",1);
$pdf->SetXY(205, 28);
$pdf->MultiCell(60,5,"Approuvé Par  \n $quem",1);
$pdf->SetXY(265, 28);
$pdf->MultiCell(25,5,"Date \n $dtquem",1);
//linha 3		
$pdf->SetFont('Arial','B',8);
$pdf->SetXY(5, 40);
$pdf->MultiCell(130,10,"Question",1,'C');
$pdf->SetXY(135, 40);
$pdf->MultiCell(10,10,"Qui",1,'C');
$pdf->SetXY(145, 40);
$pdf->MultiCell(10,10,"Non",1,'C');
$pdf->SetXY(155, 40);
$pdf->MultiCell(60,10,"Commentaire / Action ",1,'C');
$pdf->SetXY(215, 40);
$pdf->MultiCell(45,10,"Responsable",1,'C');
$pdf->SetXY(260, 40);
$pdf->MultiCell(30,10,"Date ",1,'C');
//linha 4
