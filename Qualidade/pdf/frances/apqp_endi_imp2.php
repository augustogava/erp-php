...
$pdf->Cell(35);
$pdf->Cell(0, 18, 'HOMOLOGATION DE PIÉCAS DE PRODUCTION');
$pdf->SetXY(35, 5);
$pdf->Cell(35);
$pdf->Cell(0, 18, 'RELEVÉ DIMENSIONAL');
...
$pdf->SetXY(5, 18);
$pdf->SetFont('Arial','',8);
$pdf->MultiCell(110,5,"Fournisseur \n $razao",1);
$pdf->SetXY(115, 18);
$pdf->MultiCell(45,5,"Numéro Piéce (Client) \n $cliente",1);
$pdf->SetXY(160, 18);
$pdf->MultiCell(45,5,"Numéro de Plan / Rév. / Date \n $rev",1);
//linha 2
$pdf->SetXY(5, 28);
$pdf->MultiCell(50,5,"Lieu de la Verification \n $local",1);
$pdf->SetXY(55, 28);
$pdf->MultiCell(60,5,"Numéro de Piéce / Rév (Fournisseur) \n $num",1);
$pdf->SetXY(115, 28);
$pdf->MultiCell(90,5,"Designation de la Piéce \n $nome",1);
//linha 3
$pdf->SetFont('Arial','B',8);
$pdf->SetXY(5, 40);
$pdf->MultiCell(10,10,"Car.",1,'C');
$pdf->SetXY(15, 40);
$pdf->MultiCell(80,10,"Specification Dimensionnelle",1,'C');
$pdf->SetXY(95, 40);
$pdf->MultiCell(12,5,"Caract. Esp.",1,'C');
$pdf->SetXY(107, 40);
$pdf->MultiCell(80,10,"Resultat des Dimensions Relevées par le Fournisseur ",1,'C');
$pdf->SetXY(187, 40);
...
if(mysql_num_rows($sql)){
	while($res=mysql_fetch_array($sql)){
		if($y>=250){
			...
			$pdf->SetXY(5, 18);
			$pdf->SetFont('Arial','',8);
			$pdf->MultiCell(85,5,"Fournisseur \n $razao",1);
			$pdf->SetXY(90, 18);
			$pdf->MultiCell(65,5,"Numéro Piéce (Client) \n $cliente",1);
			$pdf->SetXY(155, 18);
			$pdf->MultiCell(50,5,"Numéro de Plan / Rév. / Date \n $rev",1);
			//linha 2
			$pdf->SetXY(5, 28);
			$pdf->MultiCell(75,5,"Lieu de la Verification \n $local",1);
			$pdf->SetXY(80, 28);
			$pdf->MultiCell(55,5,"Numéro de Piéce / Rév (Fournisseur) \n $num",1);
			$pdf->SetXY(135, 28);
			$pdf->MultiCell(70,5,"Designation de la Piéce \n $nome",1);
			//linha 3
			$pdf->SetFont('Arial','B',8);
			$pdf->SetXY(5, 40);
			$pdf->MultiCell(10,10,"Car.",1,'C');
