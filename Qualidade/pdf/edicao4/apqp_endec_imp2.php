...
$pdf->SetXY(40, 5);
$pdf->Cell(27);
$pdf->Cell(0, 8, 'Resultados dos Ensaios de Desempenho');
...
$pdf->SetXY(5, 28);
$pdf->MultiCell(110,5,"Nome do Laboratório: $local");
$pdf->SetXY(5, 33);
...
$pdf->SetXY(109, 28);
$pdf->MultiCell(90,5,"Nível de alteração do projeto: $proj");
$pdf->SetXY(109, 33);
...
$pdf->SetXY(5, 43);
$pdf->MultiCell(55,10,"Especificação do Teste / Rev / Data",1,'C');
$pdf->SetXY(60, 43);
...
$pdf->SetXY(109, 43);
$pdf->MultiCell(80,5,"Resultados das Medições (Data) / Condições do Ensaio",1,'C');
$pdf->SetXY(109, 48);
