...
$pdf->Cell(38);
$pdf->Cell(0, 8, 'Aprovação de Peça de');
$pdf->SetXY(40, 5);
$pdf->Cell(25);
$pdf->Cell(0, 8, 'Produção Resultados Dimensionais');
...
$pdf->SetXY(115, 18);
$pdf->MultiCell(90,5,"Número da Peça: $cliente");
//linha 2
$pdf->SetXY(5, 28);
$pdf->MultiCell(110,15,"",1);
$pdf->SetXY(5, 28);
$pdf->MultiCell(110,5,"Local da Inspeção: \n $local");
$pdf->SetXY(115, 23);
...
$pdf->SetXY(17, 43);
$pdf->MultiCell(43,10,"Dimensão / Especificação",1,'C');
$pdf->SetXY(60, 43);
...
if(mysql_num_rows($sql)){
	while($res=mysql_fetch_array($sql)){
		if($y>=250){
			...
			$pdf->MultiCell(110,5,"Organização: $razao");
			$pdf->SetXY(5, 23);
			$pdf->MultiCell(110,5,"Código do Fornecedor/Vendedor: $res[cod_forn]");
			$pdf->SetXY(115, 18);
			$pdf->MultiCell(90,25,"",1);
			$pdf->SetXY(115, 18);
			$pdf->MultiCell(90,5,"Número da Peça: $cliente");
		...
		$tam1[2]=flinha("$res[lie]",15.5);
		$tam1[3]=flinha("$res[lse]",15.5);
		$tam1[4]=flinha("$data_teste",13);
		$tam1[5]=flinha("$res[quant_test]",12);
		$tam1[6]=1;
		$tam1[7]=flinha($res["forn"],72);
