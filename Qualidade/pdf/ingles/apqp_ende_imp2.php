...
$pdf->MultiCell(200,5,"Production Part Approval Performance Test Results",'C');
...
//linha 2
$pdf->SetXY(5, 28);
$pdf->MultiCell(50,5,"Teste Facility Name \n $local",1);
$pdf->SetXY(55, 28);
...
$pdf->SetXY(5, 40);
$pdf->MultiCell(10,5,"Char. Nº",1,'C');
$pdf->SetXY(15, 40);
$pdf->MultiCell(15,10,"Ref. Nº",1,'C');
$pdf->SetXY(30, 40);
$pdf->MultiCell(75,10,"Requirements",1,'C');
$pdf->SetXY(105, 40);
$pdf->MultiCell(15,5,"Test Freq. \n ",1,'C');
$pdf->SetXY(120, 40);
$pdf->MultiCell(10,5,"Qty. Tested",1,'C');
$pdf->SetXY(130, 40);
$pdf->MultiCell(55,5,"Supplier test results and Other Conditions \n ",1,'C');
$pdf->SetXY(185, 40);
...
if(mysql_num_rows($sql2)){
	while($res2=mysql_fetch_array($sql2)){
		if($y>=250){
			...
			//linha 2
			$pdf->SetXY(5, 28);
			$pdf->MultiCell(50,5,"Test Facility Name \n $local",1);
			$pdf->SetXY(55, 28);
			$pdf->MultiCell(50,5,"Part Number / Revision (Supplier) \n $num",1);
			$pdf->SetXY(105, 28);
			$pdf->MultiCell(100,5,"Part Name \n $nome",1);
			...
			$pdf->MultiCell(15,10,"Ref. Nº",1,'C');
			$pdf->SetXY(30, 40);
			$pdf->MultiCell(75,10,"Requiremts",1,'C');
			$pdf->SetXY(105, 40);
			$pdf->MultiCell(15,5,"Test Freq. \n ",1,'C');
			$pdf->SetXY(120, 40);
			$pdf->MultiCell(10,5,"Qty. tested",1,'C');
