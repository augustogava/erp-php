...
$pdf->Cell(70);
$pdf->Cell(0, 18, 'ADVANCED QUALITY PLANNING SCHEDULE');
$pdf->SetXY(260, 5);
$pdf->SetFont('Arial','B',8);
$pdf->MultiCell(40,5,"PPAP Nº $numero \n Page: $pg");
$pdf->SetXY(5, 18);
$pdf->SetFont('Arial','',8);
$pdf->MultiCell(50,5,"Customer part Number\n $res[pecacli]",1);
$pdf->SetXY(55, 18);
$pdf->MultiCell(50,5,"Drawing Rev./Date\n $res[niveleng] - ".banco2data($res["dteng"])."",1);
$pdf->SetXY(105, 18);
$pdf->MultiCell(80,5,"Part Name \n $res[nome]",1);
$pdf->SetXY(185, 18);
$pdf->MultiCell(105,5,"Customer\n $res[nomecli]",1);
$pdf->SetXY(5, 28);
$pdf->MultiCell(100,5,"Supplier\n $rese[razao]",1);
$pdf->SetXY(105, 28);
$pdf->MultiCell(80,5,"Supplier Part Number / Revision) \n $res[numero] - $res[rev]",1);
$pdf->SetXY(185, 28);
$pdf->MultiCell(75,5,"Approved By  \n $res[crono_quem]",1);
$pdf->SetXY(260, 28);
$pdf->MultiCell(30,5,"Date \n ".banco2data($res["crono_dtquem"])."",1);
$pdf->SetXY(5, 45);
$pdf->SetFont('Arial','B',8);
$pdf->Cell(90,5,'Activity',1,1,'C');
$pdf->SetXY(95, 45);
$pdf->Cell(45,5,'Responsible',1,1,'C');
$pdf->SetXY(140, 45);
$pdf->Cell(25,5,'Proposed Start',1,1,'C');
$pdf->SetXY(165, 45);
$pdf->Cell(25,5,'Proposed End',1,1,'C');
$pdf->SetXY(190, 45);
$pdf->Cell(17.5,5,'Pred. Durat.',1,1,'C');
$pdf->SetXY(207.5, 45);
$pdf->Cell(17.5,5,'% Compl.',1,1,'C');
$pdf->SetXY(225, 45);
$pdf->Cell(65,5,'Remarks',1,1,'C');
$pdf->SetFont('Arial','',8);
$i=50;
...
if(mysql_num_rows($sql)){
	while($res=mysql_fetch_array($sql)){
		...
		$pdf->SetXY(140, $i);
		$pdf->Cell(25,5,banco2data($res["ini"]),1,1,'C');
		$pdf->SetXY(165, $i);
		$pdf->Cell(25,5,banco2data($res["prazo"]),1,1,'C');
		$pdf->SetXY(190, $i);
		$pdf->Cell(17.5,5,banco2data($res["fim"]),1,1,'C');
		$pdf->SetXY(207.5, $i);
		$pdf->Cell(17.5,5,$res["perc"],1,1,'C');
		$pdf->SetXY(225, $i);
...
$pdf->Line(165,50,165,185);
$pdf->Line(190,50,190,185);
$pdf->Line(207.5,50,207.5,185);
