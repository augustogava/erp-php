...
$pdf->SetXY(20, 42);
$pdf->MultiCell(40,4,"Characteristic description \n ",1);
$pdf->SetXY(20, 46);
$pdf->MultiCell(40,4,$desc,0);
$pdf->SetXY(60, 42);
$pdf->MultiCell(95,4,"Index (Cavity / Mold) \n ",1);
$pdf->SetXY(60, 46);
$pdf->MultiCell(95,4,$espec,0);
$pdf->SetXY(155, 42);
...
$pdf->SetXY(165, 68);
$pdf->MultiCell(40,4,"Amplitude",1,'C');
//linha 7
$x=72;
...
$pdf->SetXY(5, $x);
$pdf->SetFont('Arial','B',14);
$pdf->MultiCell(200,5,"Study Results",0,'C');
$x=$x+10;
//linha 7
$pdf->SetFont('Arial','B',8);
$pdf->SetXY(5, $x);
...
$x=$x+5;
$pdf->SetXY(5, $x);
$pdf->MultiCell(200,5,"Number of points Outside the control Limits: ".$resp["pf"]."",1,'L');
$pdf->SetXY(140, $x);
...
$pdf->SetXY(105, $x);
$pdf->MultiCell(100,5,"Lower Control Limit (LCL): ".banco2valor3(0)."",1);
//linha 12
$x=$x+5;
$pdf->SetXY(5, $x);
$pdf->MultiCell(100,5,"Upper Control Limit (UCL): ".banco2valor3($resp["uclx"])."",1);
$pdf->SetXY(105, $x);
