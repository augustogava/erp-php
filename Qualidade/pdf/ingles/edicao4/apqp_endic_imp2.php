...
$pdf->SetXY(40, 5);
$pdf->Cell(35);
$pdf->Cell(0, 10, 'Dimensional Test Results');
...
$pdf->SetXY(109, 18);
$pdf->MultiCell(90,5,"Part Number (Customer): $cliente");
//linha 2
$pdf->SetXY(5, 28);
$pdf->MultiCell(104,15,"",1);
$pdf->SetXY(5, 28);
$pdf->MultiCell(110,5,"Inspection Facility: \n $local");
$pdf->SetXY(109, 23);
...
$pdf->SetXY(17, 43);
$pdf->MultiCell(43,10,"Dimension / Specification",1,'C');
$pdf->SetXY(60, 43);
...
$pdf->SetXY(109, 43);
$pdf->MultiCell(80,5,"Measurement Results (Date)",1,'C');
$pdf->SetXY(109, 48);
$pdf->MultiCell(40,5,"By Organization",1,'C');
$pdf->SetXY(149, 48);
