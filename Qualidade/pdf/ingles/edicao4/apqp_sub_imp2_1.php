...
if($resp["assi_cli"]=="E"){
	$pdf->SetXY(32,243);
	$pdf->MultiCell(124,5,"*Electronic document emitted. Signature not necessary*");
	$pdf->SetXY(30,246.5);
	$pdf->SetFont('Arial','B',6);
}
$pdf->SetFont('Arial','',7);
...
$pdf->SetXY(90,248);
$pdf->MultiCell(64,5,"Customer Tracking Number (optional)");
$pdf->SetXY(135,248);
