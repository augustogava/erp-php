...
$pdf->SetXY(40, 5);
$pdf->Cell(35);
$pdf->Cell(0, 10, 'Performance Test Results');
...
$pdf->SetXY(5, 28);
$pdf->MultiCell(110,5,"Name of Laboratory: $local");
$pdf->SetXY(5, 33);
...
$pdf->SetXY(5, 43);
$pdf->MultiCell(55,10,"Test Specification / Rev / Date",1,'C');
$pdf->SetXY(60, 43);
...
$pdf->SetXY(115, 43);
$pdf->MultiCell(72,10,"Supplier Test Results (Data) Test Conditions",1,'C');
$pdf->SetXY(187, 43);
