...
$pdf->Cell(70);
$pdf->Cell(0, 18, 'CAPABILITY STUDY');
$pdf->SetFont('Arial','',8);
$pg=1;
$pdf->SetXY(180, 5);
...
$pdf->SetFont('Arial','',8);
$pdf->SetXY(5, 18);
$pdf->MultiCell(100,4,"Customer \n ",1);
$pdf->SetFont('Arial','',8);
$pdf->SetXY(5, 22);
$pdf->MultiCell(100,4,$cliente,0);
$pdf->SetFont('Arial','',8);
$pdf->SetXY(105, 18);
$pdf->MultiCell(50,4,"Customer Part Number \n ",1);
$pdf->SetFont('Arial','',8);
$pdf->SetXY(105, 22);
...
$pdf->SetXY(105, 26);
$pdf->SetFont('Arial','',8);
$pdf->MultiCell(50,4,"Supplier Part Number \n ",1);
$pdf->SetXY(105, 30);
$pdf->SetFont('Arial','',8);
$pdf->MultiCell(100,4,$numero,0);
$pdf->SetFont('Arial','',8);
$pdf->SetXY(155, 26);
$pdf->MultiCell(50,4,"Part Revision (Supplier) \n ",1);
$pdf->SetFont('Arial','',8);
$pdf->SetXY(155, 30);
$pdf->MultiCell(100,4,$rev1,0);
//linha 3
$pdf->SetXY(5, 34);
$pdf->MultiCell(100,4,"Part Name \n ",1);
$pdf->SetXY(5, 38);
$pdf->MultiCell(100,4,$nome,0);
$pdf->SetXY(105, 34);
$pdf->MultiCell(100,4,"Operation Number/Description \n ",1);
$pdf->SetXY(105, 38);
$pdf->MultiCell(100,4,$ope,0);
//linha 4
$pdf->SetXY(5, 42);
$pdf->MultiCell(15,4,"Char. No. \n ",1);
$pdf->SetXY(5, 46);
$pdf->MultiCell(15,4,$num,0);
$pdf->SetXY(20, 42);
$pdf->MultiCell(30,4,"Characteristic \n ",1);
$pdf->SetXY(20, 46);
$pdf->MultiCell(30,4,$desc,0);
$pdf->SetXY(50, 42);
$pdf->MultiCell(105,4,"Index \n ",1);
$pdf->SetXY(50, 46);
...
//linha 5
$pdf->SetXY(5, 50);
$pdf->MultiCell(100,4,"Performed By \n ",1);
$pdf->SetXY(5, 54);
...
$pdf->SetXY(135, 50);
$pdf->MultiCell(40,4,"Subgroup Size \n ",1);
$pdf->SetXY(135, 54);
$pdf->MultiCell(100,4,$tam,0);
$pdf->SetXY(175, 50);
$pdf->MultiCell(30,4,"Subgroup Count \n ",1);
$pdf->SetXY(175, 54);
$pdf->MultiCell(100,4,$qtd,0);
//linha 6
$pdf->SetXY(5, 58);
$pdf->MultiCell(200,4,"Remarks \n ",1);
$pdf->SetXY(5, 62);
...
$pdf->SetXY(15, 68);
$pdf->MultiCell(20,4,"Sample 1",1,'C');
$pdf->SetXY(35, 68);
$pdf->MultiCell(25,4,"Sample 2",1,'C');
$pdf->SetXY(60, 68);
$pdf->MultiCell(25,4,"Sample 3",1,'C');
$pdf->SetXY(85, 68);
$pdf->MultiCell(25,4,"Sample 4",1,'C');
$pdf->SetXY(110, 68);
$pdf->MultiCell(25,4,"Sample 5",1,'C');
$pdf->SetXY(135, 68);
$pdf->MultiCell(30,4,"Average",1,'C');
$pdf->SetXY(165, 68);
$pdf->MultiCell(40,4,"Range",1,'C');
//linha 7
$x=72;
for($i=1;$i<=$resp["nli"];$i++){
	if($x>=250){
		...
		$pdf->MultiCell(30,4,$desc,0);
		$pdf->SetXY(50, 42);
		$pdf->MultiCell(105,4,"Index (Cavity / Mold) \n ",1);
		$pdf->SetXY(50, 46);
		$pdf->MultiCell(105,4,$espec,0);
		$pdf->SetXY(155, 42);
		$pdf->MultiCell(25,4,"LSL \n ",1);
...
$pdf->SetXY(5, $x);
$pdf->SetFont('Arial','B',14);
$pdf->MultiCell(200,5,"CAPABILITY STUDY",0,'C');
$x=$x+10;
//linha 7
$pdf->SetFont('Arial','B',8);
$pdf->SetXY(5, $x);
$pdf->MultiCell(200,5,"Sampling Information",1,'C');
$x=$x+5;
$pdf->SetXY(5, $x);
...
$pdf->SetXY(140, $x);
$pdf->MultiCell(30,5,"Mi. Value:".banco2valor3($resp["min"])."",0,'C');
$pdf->SetXY(170, $x);
$pdf->MultiCell(30,5,"Max. Value:".banco2valor3($resp["max"])."",0,'C');
//linha nova
$x=$x+5;
$pdf->SetXY(5, $x);
$pdf->MultiCell(200,5,"Points out of Specification: ".$resp["pf"]."",1,'L');
$pdf->SetXY(140, $x);
$pdf->MultiCell(30,5,"Mi.Range:".banco2valor3($resp["rmin"])."",0,'C');
$pdf->SetXY(170, $x);
$pdf->MultiCell(30,5,"Max. Range:".banco2valor3($resp["rmax"])."",0,'C');
//linha 9
$x=$x+10;
$pdf->SetFont('Arial','B',8);
$pdf->SetXY(5, $x);
$pdf->MultiCell(200,5,"Control Limits",1,'C');
//linha 10
$x=$x+5;
$pdf->SetXY(5, $x);
$pdf->MultiCell(100,5,"Xbar Chart",1,'C');
$pdf->SetXY(105, $x);
$pdf->MultiCell(100,5,"Range Chart",1,'C');
//linha 11
$x=$x+5;
$pdf->SetXY(5, $x);
$pdf->MultiCell(100,5,"Lower Control Limit (LCL): ".banco2valor3($resp["lcl"])."",1);
$pdf->SetXY(105, $x);
$pdf->MultiCell(100,5,"Upper Control Limit (UCL): ".banco2valor3(0)."",1);
//linha 12
$x=$x+5;
$pdf->SetXY(5, $x);
$pdf->MultiCell(100,5,"Lower Control Limit (LCL): ".banco2valor3($resp["uclx"])."",1);
$pdf->SetXY(105, $x);
$pdf->MultiCell(100,5,"Upper Control Limit (UCL): ".banco2valor3($resp["uclr"])."",1);
//linha nova P_F media e amp
$x=$x+5;
$pdf->SetXY(5, $x);
$pdf->MultiCell(100,5,"Number of points Outside the control Limits: ".$resp["mpf"]."",1);
$pdf->SetXY(105, $x);
$pdf->MultiCell(100,5,"Number of points Outside the control Limits: ".$resp["apf"]."",1);
//linha 13
$x=$x+10;
$pdf->SetXY(5, $x);
$pdf->MultiCell(100,5,"Capability",1,'C');
$pdf->SetXY(105, $x);
...
$pdf->MultiCell(100,10,"",1,'C');
$pdf->SetXY(7, $x);
$pdf->MultiCell(60,5,"Standard Deviation: ".banco2valor3($resp["sigma"])."",0,'C');
$pdf->SetXY(107, $x);
$pdf->MultiCell(60,5,"Standard Deviation: ".banco2valor3($resp["sigma"])."",0,'C');
$pdf->SetXY(57, $x);
...
$pdf->SetXY(5, $x);
if($resp["sit"]==0){ $show="pendente"; }elseif($resp["sit"]==1){ $show="aproved"; }else{ $show="rejected"; }
$pdf->MultiCell(65,5,"Disposition: ".$show."",0,'C');
$pdf->SetXY(70, $x);
$pdf->MultiCell(65,5,"Responsible: ".$resp["quem"]."",0,'C');
$pdf->SetXY(135,$x);
