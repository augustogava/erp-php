...
switch($anexo){
	case 1: $anexo2="FMEA of Project"; break;
	case 2: $anexo2="Information of the Project"; break;
	case 3: $anexo2="New Equipment, Tool rack and Equipment of Test"; break;
	case 4: $anexo2="Product quality / Process"; break;
	case 5: $anexo2="Installations"; break;
	case 6: $anexo2="Flowchart of Process"; break;
	case 7: $anexo2="FMEA of Process"; break;
	case 8: $anexo2="Plan of Control"; break;
}
$y=50;
$pecacli=$res["pecacli"];
$rev=$res["rev"];
...
$pdf->SetXY(50, 7);
$pdf->MultiCell(200,5,"Check-list of the APQP - A$anexo - $anexo2",0,'C');
$pdf->SetXY(260, 5);
...
$pdf->SetXY(65, 18);
$pdf->MultiCell(60,5,"Drawing Rev./Date \n $rev",1);
$pdf->SetXY(125, 18);
$pdf->MultiCell(80,5,"Part Name \n $nome",1);
$pdf->SetXY(205, 18);
$pdf->MultiCell(85,5,"Customer \n $nomecli",1);
//linha 2
$pdf->SetXY(5, 28);
$pdf->MultiCell(120,5,"Supplier \n $razao",1);
$pdf->SetXY(125, 28);
$pdf->MultiCell(80,5,"Supplier part Number / Revision \n $num",1);
$pdf->SetXY(205, 28);
$pdf->MultiCell(60,5,"Approved By  \n $quem",1);
$pdf->SetXY(265, 28);
...
$pdf->SetXY(135, 40);
$pdf->MultiCell(10,10,"Yes",1,'C');
$pdf->SetXY(145, 40);
$pdf->MultiCell(10,10,"No",1,'C');
$pdf->SetXY(155, 40);
$pdf->MultiCell(60,10,"Comment / Action Required ",1,'C');
$pdf->SetXY(215, 40);
$pdf->MultiCell(45,10,"Person Responsible",1,'C');
$pdf->SetXY(260, 40);
$pdf->MultiCell(30,10,"Due Date ",1,'C');
//linha 4
