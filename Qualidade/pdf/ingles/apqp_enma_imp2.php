...
$pdf->Cell(35);
$pdf->Cell(0, 18,'Production Part Approval Material Test Results');
...
$pdf->SetFont('Arial','B',8);
$pdf->SetXY(5, 40);
$pdf->MultiCell(15,10,"Chr. Nº",1,'C');
$pdf->SetXY(20, 40);
$pdf->MultiCell(15,5,"Type of Test",1,'C');
$pdf->SetXY(35, 40);
$pdf->MultiCell(70,10,"Material Spec. Number/Revision/Date",1,'C');
$pdf->SetXY(105, 40);
$pdf->MultiCell(12,5,"Spec Char",1,'C');
$pdf->SetXY(117, 40);
$pdf->MultiCell(70,10,"Supplier Test Results ",1,'C');
$pdf->SetXY(187, 40);
...
if(mysql_num_rows($sql)){
	while($res=mysql_fetch_array($sql)){
		if($y>=250){
			...
			$pdf->SetFont('Arial','B',8);
			$pdf->SetXY(5, 40);
			$pdf->MultiCell(15,10,"Char. Nº",1,'C');
			$pdf->SetXY(20, 40);
			$pdf->MultiCell(15,5,"Type of Test",1,'C');
			$pdf->SetXY(35, 40);
			$pdf->MultiCell(70,10,"Material Spec. number/Revision/Date",1,'C');
