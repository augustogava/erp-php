...
while($resp=mysql_fetch_array($sqla)){
	...
	//linha 4
	$pdf->SetXY(5, 42);
	$pdf->MultiCell(25,4,"Caract. No. \n ",1);
	$pdf->SetXY(5, 46);
	$pdf->MultiCell(25,4,$num,0);
	$pdf->SetXY(30, 42);
	$pdf->MultiCell(50,4,"Characteristic description \n ",1);
	$pdf->SetXY(30, 46);
	$pdf->MultiCell(50,4,$desc,0);
	$pdf->SetXY(80, 42);
	$pdf->MultiCell(75,4,"Index (Cavity/Mold) \n ",1);
	$pdf->SetXY(80, 46);
	...
	$pdf->SetXY(5, 70);
	$pdf->SetFont('Arial','B',14);
	$pdf->MultiCell(205,5,"Averages",0,'C');
	$pdf->SetXY(5, 145);
	$pdf->MultiCell(205,5,"Range",0,'C');
	$pdf->SetXY(5, 215);
	$pdf->MultiCell(205,5,"Histogramm",0,'C');
	//linha 7
	$pdf->SetFont('Arial','B',8);
	//gerando os graficos
	$num_graf=$resp["id"];
	include('pdf/apqp_cap_xbar2.php');
	...
	include('pdf/apqp_cap_rbar2.php');
	...
	include('pdf/apqp_cap_hbar2.php');
