...
$pdf->SetXY(5, 5);
$pdf->MultiCell(290,5,"POTENTIAL FAILURE MODE AND EFFECTS ANALYSIS PROCESS FMEA",0,'C');
$pdf->SetFont('Arial','',8);
$cliente=$res[pecacli];
...
$pdf->SetXY(105, 26);
$pdf->MultiCell(80,4,"Process responsibility \n $resp[resp]",1);
$pdf->SetXY(185, 26);
...
$pdf->SetXY(105, 34);
$pdf->MultiCell(80,4,"Product Identification / Application \n ",1);
$pdf->SetXY(185, 34);
...
$pdf->SetXY(89, 60);
$pdf->MultiCell(28,4," \n Potencial Cause(s) mechanisms of Failure  ",1,'C');
$pdf->SetXY(117, 60);
