...
$pdf->Cell(35);
$pdf->Cell(0, 18, 'TEAM FEASIBILITY COMMITMENT');
$pdf->SetXY(100, 18);
$pdf->SetFont('Arial','',8);
...
$pdf->SetXY(5, 64);
$pdf->SetFont('Arial','',8);
$pdf->MultiCell(200,5,"Our product quality planning team has considered the following questions, not intended to be all-inclusive in performing a feasibility evaluation, Tha drawings and/or specifications provided have been used as a basis for analyzing the ability to mett all specified requirements. All \"no\" answers are supported with attached comments identifying our concerns and/or proposed changes to enable us to meet the specified requirements.");
//linha 6
	//inicio da tabela
	$pdf->SetXY(5, 90);
	$pdf->SetFont('Arial','B',8);
	$pdf->MultiCell(10,5,"Yes",1);
	$pdf->SetXY(15, 90);
	$pdf->MultiCell(10,5,"No",1);
	$pdf->SetXY(25, 90);
	$pdf->MultiCell(180,5,"Consideration",1,'C');
	//linha 1 da tabela
	$pdf->SetFont('Arial','',8);
	$pdf->SetXY(5, 95);
	...
	$pdf->SetXY(25, 95);
	$pdf->MultiCell(180,5,"Is the product adequately defined(application requirements, etc.) to enable feasibility evaluation?",1);
	//linha 2 da tabela
	$pdf->SetXY(5, 100);
	...
	$pdf->MultiCell(10,5,$msg1,1,'C');
	$pdf->SetXY(25, 100);
	$pdf->MultiCell(180,5,"Can engineering Performance Specifications be met as written? ",1);
	//linha 3 da tabela
	$pdf->SetXY(5, 105);
	...
	$pdf->MultiCell(10,5,$msg1,1,'C');
	$pdf->SetXY(25, 105);
	$pdf->MultiCell(180,5,"Can product be manufactured to tolerances specified on drawings? ",1);
	//linha 4 da tabela
	$pdf->SetXY(5, 110);
	...
	$pdf->MultiCell(10,5,$msg1,1,'C');
	$pdf->SetXY(25, 110);
	$pdf->MultiCell(180,5,"Can product be manufactured with Cpk´s that mett requirements? ",1);
	//linha 5 da tabela
	$pdf->SetXY(5, 115);
	...
	$pdf->MultiCell(10,5,$msg1,1,'C');
	$pdf->SetXY(25, 115);
	$pdf->MultiCell(180,5,"Is there adequate capacity to produce product?",1);
	//linha 6 da tabela
	$pdf->SetXY(5, 120);
	...
	$pdf->SetFont('Arial','B',8);
	$pdf->SetXY(5, 125);
	$pdf->MultiCell(200,5,"Can the product be manufactured without incurring any unusual: ",1,'C');
	//linha 8 da tabela
	...
	$pdf->MultiCell(10,5,$msg1,1,'C');
	$pdf->SetXY(25, 130);
	$pdf->MultiCell(180,5,"- Costs for capital equipment? ",1);
	//linha 9 da tabela
	$pdf->SetXY(5, 135);
	...
	$pdf->MultiCell(10,5,$msg1,1,'C');
	$pdf->SetXY(25, 135);
	$pdf->MultiCell(180,5,"- Costs for tooling?",1);
	//linha 10 da tabela
	$pdf->SetXY(5, 140);
	...
	$pdf->MultiCell(10,5,$msg1,1,'C');
	$pdf->SetXY(25, 140);
	$pdf->MultiCell(180,5,"-Alternative manufacturing methods? ",1);
	//linha 11 da tabela
	$pdf->SetXY(5, 145);
	...
	$pdf->MultiCell(10,5,$msg1,1,'C');
	$pdf->SetXY(25, 145);
	$pdf->MultiCell(180,5,"Is statistical process control required on product? ",1);
	//linha 12 da tabela
	$pdf->SetXY(5, 150);
	...
	$pdf->MultiCell(10,5,$msg1,1,'C');
	$pdf->SetXY(25, 150);
	$pdf->MultiCell(180,5,"Is statistical process control presently used on similar products? ",1);
	//linha 13 da tabela - titulo
	$pdf->SetFont('Arial','B',8);
	$pdf->SetXY(5, 155);
	$pdf->MultiCell(200,5,"Where statistical process control is used on similar products:  ",1,'C');
	//linha 14 da tabela
	$pdf->SetFont('Arial','',8);
	$pdf->SetXY(5, 160);
	...
	$pdf->MultiCell(10,5,$msg1,1,'C');
	$pdf->SetXY(25, 160);
	$pdf->MultiCell(180,5,"- Are the processes in control and stable? ",1);
	//linha 15 da tabela
	$pdf->SetXY(5, 165);
	...
	$pdf->MultiCell(10,5,$msg1,1,'C');
	$pdf->SetXY(25, 165);
	$pdf->MultiCell(180,5,"- Are Cpk´s greater than 1.33 ",1);
	//fim da tabela
//linha 7
$pdf->SetXY(5, 172);
$pdf->SetFont('Arial','B',8);
...
$pdf->SetXY(11, 177);
$pdf->MultiCell(15,5,"Feasible");
$pdf->SetXY(27, 177);
$pdf->SetFont('Arial','',8);
$pdf->MultiCell(100,5,"Product can be produced as specified with no revision. ");
//linha 9
$pdf->SetFont('Arial','B',8);
$pdf->SetXY(5, 182);
...
$pdf->SetXY(27, 182);
$pdf->SetFont('Arial','',8);
$pdf->MultiCell(100,5,"Changes recommended (See Attached)");
//linha 10
$pdf->SetFont('Arial','B',8);
$pdf->SetXY(5, 187);
...
$pdf->MultiCell(5,5,$msg,1,'C');
$pdf->SetXY(11, 187);
$pdf->MultiCell(15,5,"Not Feasible");
$pdf->SetXY(27, 187);
$pdf->SetFont('Arial','',8);
$pdf->MultiCell(100,5,"Design revision required to produce product within the specified requirements. ");
//linha 11
	//coluna 1
	$pdf->SetFont('Arial','B',8);
	$pdf->SetXY(5, 195);
	$pdf->MultiCell(30,5,"Sign-Off");
	$pdf->SetFont('Arial','',8);
	$pdf->SetXY(6, 200);
	...
	$pdf->MultiCell(100,5,"Team Member/Title/Date ");
//linha 12
include('pdf/ingles/apqp_viabilidade_imp2.php');
?>
