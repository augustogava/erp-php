...
$pdf->SetXY(117, 40);
$pdf->MultiCell(70,10,"Resultados dos Ensaios pelo Fornecedor ",1,'C');
$pdf->SetXY(187, 40);
...
if(mysql_num_rows($sql)){
	while($res=mysql_fetch_array($sql)){
		...
		$tam1[0]=flinha($res["numero"],11);
		$tam1[1]=flinha($res["tp"],11);
		if($tam1[1]==0){$tam1[1]=1;}
		$tam1[2]=flinha("$res[descricao] - $res[espec]",65);
		$tam1[3]=1;
		$tam1[4]=flinha($res["forn"],65);
