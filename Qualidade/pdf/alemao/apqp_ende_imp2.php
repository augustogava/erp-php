...
$pdf->MultiCell(200,5,"Produktionsteil-Freigabe leistungstestbericht",'C');
...
$pdf->SetXY(105, 18);
$pdf->MultiCell(50,5,"Kundenteilenummer \n $peca",1);
$pdf->SetXY(155, 18);
$pdf->MultiCell(50,5,"Zeichnungsnummer / E/A Stand \n $rev",1);
//linha 2
$pdf->SetXY(5, 28);
$pdf->MultiCell(50,5,"Names der Labors \n $local",1);
$pdf->SetXY(55, 28);
$pdf->MultiCell(50,5,"Lieferantenteilenummer / Stand \n $num",1);
$pdf->SetXY(105, 28);
$pdf->MultiCell(100,5,"Teilename \n $nome",1);
//linha 3
$pdf->SetFont('Arial','B',7);
$pdf->SetXY(5, 40);
$pdf->MultiCell(10,5,"Bezugs-Nr.",1,'C');
$pdf->SetXY(15, 40);
$pdf->MultiCell(15,10,"Ref. numer",1,'C');
$pdf->SetXY(30, 40);
$pdf->MultiCell(75,10,"Anforderungen",1,'C');
$pdf->SetXY(105, 40);
$pdf->MultiCell(15,10,"Test Freq",1,'C');
$pdf->SetXY(120, 40);
$pdf->MultiCell(10,5,"Getes. Menge",1,'C');
$pdf->SetXY(130, 40);
$pdf->MultiCell(55,5,"Lieferanten-Testergebnisse und Testbedingugen",1,'C');
$pdf->SetXY(185, 40);
$pdf->MultiCell(10,10,"i.O",1,'C');
$pdf->SetXY(195, 40);
