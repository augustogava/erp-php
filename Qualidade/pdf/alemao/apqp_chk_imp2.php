...
switch($anexo){
	case 1: $anexo2="FMEA des Projektes"; break;
	case 2: $anexo2="Informationen des Projektes"; break;
	case 3: $anexo2="Neue Ausrustungs-, Werkzeugzahnstange und Ausrustung des Tests"; break;
	case 4: $anexo2="Produktqualitat / Prozeß"; break;
	case 5: $anexo2="Installationen"; break;
	case 6: $anexo2="Flussdiagramm des Prozesses"; break;
	case 7: $anexo2="FMEA des Prozesses"; break;
	case 8: $anexo2="Plan der Steuerung"; break;
}
$y=50;
$pecacli=$res["pecacli"];
$rev=$res["rev"];
...
$pdf->SetXY(50, 7);
$pdf->MultiCell(200,5,"Checkliste des APQP - A$anexo - $anexo2",0,'C');
$pdf->SetXY(260, 5);
...
$pdf->SetXY(65, 18);
$pdf->MultiCell(60,5,"Zeichnungsnummer - E/A Stand \n $rev",1);
$pdf->SetXY(125, 18);
$pdf->MultiCell(80,5,"Teilename \n $nome",1);
$pdf->SetXY(205, 18);
$pdf->MultiCell(85,5,"Kundenname \n $nomecli",1);
//linha 2
$pdf->SetXY(5, 28);
$pdf->MultiCell(120,5,"names des Lieferanten \n $razao",1);
$pdf->SetXY(125, 28);
$pdf->MultiCell(80,5,"Lieferantenteilenummer - Stand \n $num",1);
$pdf->SetXY(205, 28);
$pdf->MultiCell(60,5,"Freigabe von  \n $quem",1);
$pdf->SetXY(265, 28);
$pdf->MultiCell(25,5,"Datum \n $dtquem",1);
//linha 3		
$pdf->SetFont('Arial','B',8);
$pdf->SetXY(5, 40);
$pdf->MultiCell(130,10,"Frage",1,'C');
$pdf->SetXY(135, 40);
$pdf->MultiCell(10,10,"Ya",1,'C');
$pdf->SetXY(145, 40);
$pdf->MultiCell(10,10,"Nein",1,'C');
$pdf->SetXY(155, 40);
$pdf->MultiCell(60,10,"Bemerkung/Erforderliche MaBnahmen ",1,'C');
$pdf->SetXY(215, 40);
$pdf->MultiCell(45,10,"Verantwortliche Person",1,'C');
$pdf->SetXY(260, 40);
$pdf->MultiCell(30,10,"Termin",1,'C');
//linha 4
