...
$pdf->Cell(35);
$pdf->Cell(0, 18,'Produktionsteil-Freigabe Ergebnisse von Materialprüfungen');
...
$pdf->MultiCell(30,5,"PPAP Nr $ppap \n Blatt: $pg");
$pdf->SetXY(5, 18);
$pdf->SetFont('Arial','',8);
$pdf->MultiCell(100,5,"Lieferant \n $razao",1);
$pdf->SetXY(105, 18);
...
//linha 2
$pdf->SetXY(5, 28);
$pdf->MultiCell(50,5,"Name des Laboraturiums \n $local",1);
$pdf->SetXY(55, 28);
$pdf->MultiCell(50,5,"Teilenummer / Stand (Lieferant) \n $num",1);
$pdf->SetXY(105, 28);
$pdf->MultiCell(100,5,"Teilename \n $nome",1);
//linha 3
$pdf->SetFont('Arial','B',8);
$pdf->SetXY(5, 40);
$pdf->MultiCell(15,5,"Art der Analyse",1,'C');
$pdf->SetXY(20, 40);
$pdf->MultiCell(15,5,"Typ von Prüfung",1,'C');
$pdf->SetXY(35, 40);
$pdf->MultiCell(70,5,"Nummer der Materialspezifikation, Datum, Spezifikation",1,'C');
$pdf->SetXY(105, 40);
$pdf->MultiCell(12,5,"Spek Char.",1,'C');
$pdf->SetXY(117, 40);
$pdf->MultiCell(70,10,"Testergebnisse des Lieferanten",1,'C');
$pdf->SetXY(187, 40);
$pdf->MultiCell(8,10,"i.O",1,'C');
$pdf->SetXY(195, 40);
$pdf->MultiCell(10,10,"N.i.O ",1,'C');
//linha 4
$y=50;
