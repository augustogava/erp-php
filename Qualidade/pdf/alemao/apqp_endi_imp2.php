...
$pdf->Cell(35);
$pdf->Cell(0, 18, 'Produktionsteil-Froigabe Messbericht');
$pdf->SetFont('Arial','B',8);
$pdf->SetXY(180, 5);
$pdf->MultiCell(40,5,"PPAP Nr. $numero \n Blatt: $pg");
$pdf->SetXY(5, 18);
$pdf->SetFont('Arial','',8);
$pdf->MultiCell(110,5,"Lieferantenname \n $razao",1);
$pdf->SetXY(115, 18);
$pdf->MultiCell(45,5,"Kundenteilenummer \n $cliente",1);
$pdf->SetXY(160, 18);
$pdf->MultiCell(45,5,"Zeichnungsnummer / E/A Stand \n $rev",1);
//linha 2
$pdf->SetXY(5, 28);
$pdf->MultiCell(50,5,"name der Prüfstelle \n $local",1);
$pdf->SetXY(55, 28);
$pdf->MultiCell(60,5,"Lieferantenteilenummer / Stand \n $num",1);
$pdf->SetXY(115, 28);
$pdf->MultiCell(90,5,"Teilename \n $nome",1);
//linha 3
$pdf->SetFont('Arial','B',8);
$pdf->SetXY(5, 40);
$pdf->MultiCell(10,5,"Merkmals Nr.",1,'C');
$pdf->SetXY(15, 40);
$pdf->MultiCell(80,15,"Abmessung / Spezifikation",1,'C');
$pdf->SetXY(95, 40);
$pdf->MultiCell(12,15,"Char.",1,'C');
$pdf->SetXY(107, 40);
$pdf->MultiCell(80,15,"Messergebnisse des Lieferanten",1,'C');
$pdf->SetXY(187, 40);
$pdf->MultiCell(8,15,"i.O",1,'C');
$pdf->SetXY(195, 40);
$pdf->MultiCell(10,15,"N.i.O",1,'C');
...
if(mysql_num_rows($sql)){
	while($res=mysql_fetch_array($sql)){
		if($y>=250){
			...
			$pdf->SetXY(5, 18);
			$pdf->SetFont('Arial','',8);
			$pdf->MultiCell(85,5,"Lieferantenname \n $razao",1);
			$pdf->SetXY(90, 18);
			$pdf->MultiCell(65,5,"Kundenteilenummer \n $cliente",1);
			$pdf->SetXY(155, 18);
			$pdf->MultiCell(50,5,"Zeichnungsnummer \n $rev",1);
			//linha 2
			$pdf->SetXY(5, 28);
			$pdf->MultiCell(75,5,"Name der Prüfstelle \n $local",1);
			$pdf->SetXY(80, 28);
			$pdf->MultiCell(55,5,"Lieferantenteilenummer \n $num",1);
			$pdf->SetXY(135, 28);
			$pdf->MultiCell(70,5,"Teilename \n $nome",1);
			//linha 3
			$pdf->SetFont('Arial','B',8);
			$pdf->SetXY(5, 40);
			$pdf->MultiCell(10,5,"Merkmals Nr.",1,'C');
