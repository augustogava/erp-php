...
$pdf->SetXY(45, 5);
$pdf->Cell(32);
$pdf->Cell(0, 8, 'Ergebnisse von Materialprüfungen');
...
$pdf->SetXY(5, 28);
$pdf->MultiCell(110,5,"Materieller Lieferant: $resp[forn_mat]");
$pdf->SetXY(5, 33);
$pdf->MultiCell(110,5,"Kunde spezifizierter Lieferanten/Verkäufer Code: $resp[forncod]");

$pdf->SetFont('Arial','',6);
$pdf->SetXY(5, 37);
$pdf->MultiCell(100,2.5,"* wenn Quellzustimmung angefordert wird, umfassen Sie den Lieferanten (Quelle) u. Kunde zugewiesenen Code.");
...
$pdf->SetXY(109, 38);
$pdf->MultiCell(96,5,"Name des Labors: $local",1);

//linha 3
$pdf->SetFont('Arial','B',7.5);
$pdf->SetXY(5, 43);
$pdf->MultiCell(55,5,"MaterialanweisungcZahl / Neuausgabe / Datum",1,'C');
$pdf->SetXY(60, 43);
$pdf->MultiCell(25,5,"Begrenzungen",1,'C');
$pdf->SetXY(60, 48);
...
$pdf->SetXY(109, 43);
$pdf->MultiCell(80,5,"Testergebnisse (Datum)",1,'C');
$pdf->SetXY(109, 48);
$pdf->MultiCell(40,5,"Durch Organisation",1,'C');
$pdf->SetXY(149, 48);
$pdf->MultiCell(40,5,"Durch Kunden",1,'C');
$pdf->SetXY(189, 43);
$pdf->MultiCell(8,10,"O.K.",1,'C');
$pdf->SetXY(197, 43);
$pdf->MultiCell(8,10,"",1,'C');
$pdf->SetXY(196.5, 43);
$pdf->MultiCell(9,5,"Nicht O.K.",0,'C');
