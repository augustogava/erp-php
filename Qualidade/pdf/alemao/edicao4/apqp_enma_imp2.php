...
$pdf->SetXY(115, 38);
$pdf->MultiCell(90,5,"Name des Labors: $local",1);

//linha 3
$pdf->SetFont('Arial','B',7.5);
$pdf->SetXY(5, 43);
$pdf->MultiCell(61,5,"MaterialanweisungcZahl / Neuausgabe / Datum",1,'C');
$pdf->SetXY(66, 43);
...
$pdf->SetXY(115, 43);
$pdf->MultiCell(72,10,"LieferantencTestergebnisse (Datum)",1,'C');
$pdf->SetXY(187, 43);
...
if(mysql_num_rows($sql)){
	while($res=mysql_fetch_array($sql)){
		...
		$tam1[0]=flinha("$res[descricao] - $res[espec]",61);	
