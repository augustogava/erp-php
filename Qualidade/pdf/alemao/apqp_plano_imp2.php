...
$pdf->SetXY(5, 4);
$pdf->MultiCell(290,5,"PROCESS CONTROL PLAN (PRÜFPLAN)",0,'C');
$pdf->SetFont('Arial','',8);
$pdf->SetXY(260, 8);
$pg=1;
$pdf->SetXY(260, 5);
...
$pdf->MultiCell(80,5,"Kundenamme \n $cliente",1);
$pdf->SetXY(85, 18);
$pdf->MultiCell(50,5,"Teilenummer (Kunden) \n $peca",1);
$pdf->SetXY(135, 18);
$pdf->MultiCell(50,5,"Technischer Änderungsstand/Datum \n $rev",1);
$pdf->SetXY(185, 18);
$pdf->MultiCell(105,10,"",1);
if($resp["fase"]==1){ $fig1="2"; }else{ $fig1="1"; }
$pdf->Image("imagens/icon14_check$fig1.jpg",190,20,4,4);
$pdf->SetXY(195, 18);
$pdf->MultiCell(30,10,"Protyp");
if($resp["fase"]==2){ $fig2="2"; }else{ $fig2="1"; }
$pdf->Image("imagens/icon14_check$fig2.jpg",220,20,4,4);
$pdf->SetXY(225, 18);
$pdf->MultiCell(30,10,"Vorserie");
if($resp["fase"]==3){ $fig3="2"; }else{ $fig3="1"; }
$pdf->Image("imagens/icon14_check$fig3.jpg",250,20,4,4);
$pdf->SetXY(255, 18);
$pdf->MultiCell(30,10,"Serie");
//linha 2
$pdf->SetXY(5, 28);
$pdf->MultiCell(35,5,"Prüfplan Nr. \n $resp[numero]",1);
$pdf->SetXY(40, 28);
$pdf->MultiCell(95,5,"Teilename / Besthereibung \n $res[nome]",1);
$pdf->SetXY(135, 28);
$pdf->MultiCell(90,5,"Lieferant/Standort \n $rese[razao]",1);
$pdf->SetXY(225, 28);
$pdf->MultiCell(30,5,"Lieferantkennnumer \n ",1);
$pdf->SetXY(255, 28);
$pdf->MultiCell(35,5,"Datum der Erstfreifabe \n ".banco2data($resp["rev"])."",1);
//linha 3
$pdf->SetXY(5, 38);
$pdf->MultiCell(130,5,"Kernteam \n $resp[equipe]",1);
$pdf->SetXY(135, 38);
$pdf->MultiCell(50,5,"Lieferant/Standort Freigabe/Datum \n ".$resp["quem"]." / ".banco2data($resp["dtquem"])."",1);
$pdf->SetXY(185, 38);
$pdf->MultiCell(70,5,"Teilenummer/Rev.(Lieferant) \n ".$res["numero"]." - ".$res["rev"]."",1);
$pdf->SetXY(255, 38);
$pdf->MultiCell(35,5,"Änderungsdatum \n ".banco2data($resp["ini"])."",1);
//linha 4
$pdf->SetXY(5, 48);
$pdf->MultiCell(130,5,"Datum/Freigabe durch Kundenentwicklung / Data (se requerido) \n ".$resp["apro1"]." / ".banco2data($resp["apro1_data"])."",1);
$pdf->SetXY(135, 48);
$pdf->MultiCell(90,5,"Datum/Freigabe d. Kunden-Qualitätsbereich (falls erforderlich) \n ".$resp["apro2"]." / ".banco2data($resp["apro2_data"])."",1);
$pdf->SetXY(225, 48);
$pdf->MultiCell(65,5,"Kontaktperson/Telefon  \n $resp[contato]",1);
//linha 5
$pdf->SetXY(5, 58);
$pdf->MultiCell(130,5,"Datum/Weitere Freigabe (falls erforderlich)  \n ".$resp["apro3"]." / ".banco2data($resp["apro3_data"])."",1);
$pdf->SetXY(135, 58);
$pdf->MultiCell(155,5,"Datum/Weitere Freigabe (falls erforderlich) \n ".$resp["apro4"]." / ".banco2data($resp["apro4_data"])."",1);
//linha 6
$pdf->SetXY(5, 70);
$pdf->MultiCell(15,5,"Teil / ProzenB - Nummer",1,'C');
$pdf->SetXY(20, 70);
$pdf->MultiCell(35,5,"ProzeBname / Bescheibung d.Arbeistsgangs",1,'C');
$pdf->SetXY(55, 70);
$pdf->MultiCell(35,5,"Maschine, Gerät, Vorrichtung, Produktions - werkzeug",1,'C');
$pdf->SetXY(90, 70);
$pdf->MultiCell(50,10,"Merkmale",1,'C');
	$pdf->SetXY(90, 80);
	$pdf->MultiCell(6,5,"Nr.",1,'C');
	$pdf->SetXY(96, 80);
	$pdf->MultiCell(20,5,"Produkt",1,'C');
	$pdf->SetXY(116, 80);
	$pdf->MultiCell(24,5,"ProzeB",1,'C');
$pdf->SetXY(140, 70);
$pdf->MultiCell(5,5,"K M  ",1,'C');
$pdf->SetXY(145, 70);
$pdf->MultiCell(115,5,"Methoden",1,'C');
	$pdf->SetXY(145, 75);
	$pdf->MultiCell(30,5,"Produkt, ProzeB- spezifika. Tolera.",1,'C');
	$pdf->SetXY(175, 75);
	$pdf->MultiCell(25,5,"Bewertung Einges. Prüfsys.",1,'C');
	$pdf->SetXY(200, 75);
	$pdf->MultiCell(30,5,"Stichprobe",1,'C');
		$pdf->SetXY(200, 80);
		$pdf->MultiCell(15,5,"Umfang",1,'C');
		$pdf->SetXY(215, 80);
		$pdf->MultiCell(15,5,"Häufigkeit",1,'C');
	$pdf->SetXY(230, 75);
	$pdf->MultiCell(30,10,"Metodo de Controle",1,'C');
$pdf->SetXY(260, 70);
$pdf->MultiCell(30,5,"Reaktionsplan/ \n Korrektivtätigkeit \n ",1,'C');
...
if(mysql_num_rows($sql)){
	...
	while($res=mysql_fetch_array($sql)){
		...
		if($y>=185){
			...
			//linha 2
			$pdf->SetXY(5, 30);
			$pdf->MultiCell(15,5,"Teil / ProzeB- nummer",1,'C');
			$pdf->SetXY(20, 30);
			$pdf->MultiCell(35,5,"ProzeBname/ Beschreibung d.Arbeitsgangs",1,'C');
			$pdf->SetXY(55, 30);
			$pdf->MultiCell(35,5,"Maschine, Gerät, Vorrichtung, Produktions- werkzeug",1,'C');
			$pdf->SetXY(90, 30);
			$pdf->MultiCell(50,10,"Merkmale",1,'C');
			...
			$pdf->MultiCell(115,5,"Methoden",1,'C');
				...
				$pdf->MultiCell(30,5,"Stichprobe",1,'C');
					...
					$pdf->MultiCell(15,5,"Häufigkeit",1,'C');
				$pdf->SetXY(230, 35);
				$pdf->MultiCell(30,10,"Lenkungs methode",1,'C');
			$pdf->SetXY(260, 30);
			$pdf->MultiCell(30,5,"Reaktionsplan/ \n Korrektivtätigkeit \n ",1,'C');
