...
$pg=1;
	...
	$pdf->SetFont('Arial','B',8);
	$pdf->SetXY(5, 80);
	$pdf->MultiCell(10,10,"Nr.",1);
	$pdf->SetXY(15, 80);
	$pdf->MultiCell(70,5,"Prufer A",1,'C');
	$pdf->SetXY(85, 80);
	$pdf->MultiCell(60,5,"Prufer B",1,'C');
	$pdf->SetXY(145, 80);
	$pdf->MultiCell(60,5,"Prufer C",1,'C');
	$pdf->SetXY(15, 85);
	$pdf->MultiCell(20,5,"Prufungen 1",1,'C');
	$pdf->SetXY(35, 85);
	$pdf->MultiCell(20,5,"Prufungen 2",1,'C');
	$pdf->SetXY(55, 85);
	$pdf->MultiCell(30,5,"Prufungen 3",1,'C');
	$pdf->SetXY(85, 85);
	$pdf->MultiCell(20,5,"Prufungen 1",1,'C');
	$pdf->SetXY(105, 85);
	$pdf->MultiCell(20,5,"Prufungen 2",1,'C');
	...
	$pdf->MultiCell(20,5,"Prufungen 2",1,'C');
	$pdf->SetXY(185, 85);
	$pdf->MultiCell(20,5,"Prufungen 3",1,'C');
//linha 8
$pdf->SetFont('Arial','',8);
$y=90;
for($i=1;$i<=10;$i++){
...
if($y>=180){
	...
	$pdf->SetXY(5, 18);
	$pdf->SetFont('Arial','',8);
	$pdf->MultiCell(65,5,"Kundennamme \n $cliente",1);
	$pdf->SetXY(70, 18);
	$pdf->MultiCell(70,5,"Teilenummer(Kunden) \n $peca",1);
	$pdf->SetXY(140, 18);
	$pdf->MultiCell(65,5,"Technischer Anderungsstand/Datum \n $rev",1);
	//linha 2
	$pdf->SetXY(5, 28);
	$pdf->MultiCell(100,5,"Names des Lieferanten\n $razao",1);
	$pdf->SetXY(105, 28);
	$pdf->MultiCell(100,5,"Teilename \n $nome",1);
	//linha 3
	$pdf->SetXY(5, 38);
	$pdf->MultiCell(100,5,"Nummer des Mebmittels \n $disp",1);
	$pdf->SetXY(105, 38);
	$pdf->MultiCell(70,5,"Names des Mebmittels\n $dispo",1);
	$pdf->SetXY(175, 38);
	$pdf->MultiCell(30,5,"Durchgefuhrt Datum\n $data",1);
	//linha 4
	$pdf->SetXY(5, 48);
	$pdf->MultiCell(60,5,"Merkmal Nr.\n $num",1);
	$pdf->SetXY(65, 48);
	$pdf->MultiCell(40,5,"Names des Merkmal\n $carac",1);
	$pdf->SetXY(105, 48);
	$pdf->MultiCell(60,5,"Spezifikation\n $espec",1);
	$pdf->SetXY(165, 48);
	$pdf->MultiCell(40,5,"Toleranz \n $tol",1);
	//linhs 5
	$pdf->SetXY(5,58);
	$pdf->MultiCell(100,5,"Vorbereitet Von \n $por",1);
	$pdf->SetXY(105, 58);
	$pdf->MultiCell(35,5,"Prufungen \n $ens",1);
	$pdf->SetXY(140, 58);
	$pdf->MultiCell(35,5,"Prufer Quantitat \n $ope",1);
	$pdf->SetXY(175, 58);
	$pdf->MultiCell(30,5,"Teile \n $amo",1);
	//linha 6
	$pdf->SetXY(5, 68);
...
$pdf->SetFont('Arial','B',8);
$pdf->SetXY(5, $y);
$pdf->MultiCell(200,5,"Ergebnisse von messsystemanalyse ",1,'C');
$tol2=valor2banco($tol);
	...
	$pdf->SetXY(70, $y);
	$pdf->MultiCell(65,5,"Mebeinheit-Analyse",1,'C');
	$pdf->SetXY(135, $y);
	$pdf->MultiCell(35,5,"% Gesamtstreuung (TV)",1,'C');
	$pdf->SetXY(170, $y);
	$pdf->MultiCell(35,5,"% Toleranz",1,'C');
	//linha 2
	$y=$y+5;
	$pdf->SetXY(5, $y);
	$pdf->MultiCell(65,5,"Wiederholbarkeit - Mebmittelstreuung (EV)",1);
	$pdf->SetXY(70, $y);
	...
	$y=$y+5;
	$pdf->SetXY(5, $y);
	$pdf->MultiCell(65,5,"Vergleichbarkeit - Pruferstreuung (AV)",1);
	$pdf->SetXY(70, $y);
	...
	$y=$y+5;
	$pdf->SetXY(5, $y);
	$pdf->MultiCell(65,5,"Wiederholbarkeit und Vergleichbarkeit (R&R)",1);
	$pdf->SetXY(70, $y);
	...
	$y=$y+5;
	$pdf->SetXY(5, $y);
	$pdf->MultiCell(65,5,"Streuung Von Teil-Zu-Teil (PV)",1);
	$pdf->SetXY(70, $y);
	...
	$y=$y+5;
	$pdf->SetXY(5, $y);
	$pdf->MultiCell(65,5,"Gesamtstreuung (TV)",1);
	$pdf->SetXY(70, $y);
...
$pdf->MultiCell(65,5,"Entscheidung: $ok");
$pdf->SetXY(70, $y);
$pdf->MultiCell(65,5,"Verantwortung: $resp[quem]");
$pdf->SetXY(135, $y);
$pdf->MultiCell(70,5,"Datum: ".banco2data($resp["dtquem"])."");

//linha 12 LAUDO
$y=$y+7;
$pdf->SetXY(5, $y);
$pdf->MultiCell(200,5,"Meinung",1,'C');
//linha 13
$y=$y+5;
$pdf->SetXY(5, $y);
...
$pdf->SetXY(30, $y);
$pdf->MultiCell(65,5,"Gesamtveranderung");
$pdf->SetXY(60, $y);
$pdf->MultiCell(65,5,"Toleranz");
//CAIXA
$y=$y+5;
$pdf->SetXY(39, $y);
$pdf->MultiCell(4,4,"",1);
...
$pdf->SetXY(135, $y);
$pdf->MultiCell(75,5,"- Ausreichendes System");
//CAIXA2
$y=$y+5;
$pdf->SetXY(39, $y);
$pdf->MultiCell(4,4,"",1);
...
$pdf->SetXY(135, $y);
$pdf->MultiCell(75,5,"- Annehmbares System (muß verbessert werden)");
//CAIXA3
$y=$y+5;
$pdf->SetXY(39, $y);
$pdf->MultiCell(4,4,"",1);
...
$pdf->SetXY(135, $y);
$pdf->MultiCell(75,5,"- Unzulangliches System (Mißbilligt)");
