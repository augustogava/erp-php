...
$pdf->SetXY(25, 42);
$pdf->MultiCell(45,4,"Merkmals Beschreibung \n ",1);
$pdf->SetXY(25, 46);
$pdf->MultiCell(45,4,$desc,0);
$pdf->SetXY(70, 42);
$pdf->MultiCell(75,4,"Form,Nest,Produktionsprozess \n ",1);
$pdf->SetXY(70, 46);
$pdf->MultiCell(75,4,$espec,0);
$pdf->SetXY(145, 42);
$pdf->MultiCell(30,4,"Unterer Grenzwert \n ",1);
$pdf->SetXY(145, 46);
$pdf->MultiCell(30,4,$lie,0);
$pdf->SetXY(175, 42);
$pdf->MultiCell(30,4,"Oberer Grenzwert \n ",1);
$pdf->SetXY(175, 46);
$pdf->MultiCell(30,4,$lse,0);
//linha 5
$pdf->SetXY(5, 50);
...
$pdf->SetXY(135, 50);
$pdf->MultiCell(35,4,"Untergruppe Grobe \n ",1);
$pdf->SetXY(135, 54);
$pdf->MultiCell(100,4,$tam,0);
$pdf->SetXY(170, 50);
$pdf->MultiCell(35,4,"Untergruppe Quantitat \n ",1);
$pdf->SetXY(170, 54);
...
if($x>=200){
	...
	//linha 4
	$pdf->SetXY(5, 42);
	$pdf->MultiCell(15,4,"Merkmals Nr. \n ",1);
	$pdf->SetXY(5, 46);
	$pdf->MultiCell(15,4,$num,0);
	$pdf->SetXY(20, 42);
	$pdf->MultiCell(30,4,"Merkmals Beschreibung \n ",1);
	$pdf->SetXY(20, 46);
	$pdf->MultiCell(30,4,$desc,0);
	$pdf->SetXY(50, 42);
	$pdf->MultiCell(105,4,"Form,Nest,Produktionsprozess \n ",1);
	$pdf->SetXY(50, 46);
	$pdf->MultiCell(105,4,$espec,0);
	$pdf->SetXY(155, 42);
	$pdf->MultiCell(25,4,"Unterer Grenzwert \n ",1);
	$pdf->SetXY(155, 46);
	$pdf->MultiCell(25,4,$lie,0);
	$pdf->SetXY(180, 42);
	$pdf->MultiCell(25,4,"Oberer Grenzwert \n ",1);
	$pdf->SetXY(180, 46);
...
$pdf->SetXY(40, $x);
$pdf->MultiCell(35,5,"Oberer Grenzwert:".banco2valor3($resc["lse"])."",0,'C');
$pdf->SetXY(75, $x);
$pdf->MultiCell(35,5,"X:".banco2valor3($resp["xbar"])."",0,'C');
$pdf->SetXY(110, $x);
$pdf->MultiCell(30,5,"R:".banco2valor3($resp["rbar"])."",0,'C');
$pdf->SetXY(140, $x);
$pdf->MultiCell(30,5,"Mindestwert:".banco2valor3($resp["min"])."",0,'C');
$pdf->SetXY(170, $x);
$pdf->MultiCell(30,5,"Maximaler Wert:".banco2valor3($resp["max"])."",0,'C');
//linha nova
$x=$x+5;
$pdf->SetXY(5, $x);
...
$pdf->SetXY(5, $x);
if($resp["sit"]==0){ $show="pendente"; }elseif($resp["sit"]==1){ $show="approved"; }else{ $show="reproved"; }
