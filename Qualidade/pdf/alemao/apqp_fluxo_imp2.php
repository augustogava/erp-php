...
$pdf->Cell(60);
$pdf->Cell(0, 18, 'PROZESSFLUSSDIAGRAMM');
...
$pdf->SetXY(5, 18);
$pdf->MultiCell(100,5,"Kundennamme \n ",1);
$pdf->SetXY(5, 23);
...
$pdf->SetXY(155, 18);
$pdf->MultiCell(50,5,"Zeichungsnummer - E/A Stand \n ",1);
$pdf->SetXY(155, 23);
...
//linha 3
$pdf->SetXY(5, 38);
$pdf->MultiCell(100,5,"Freigegeben von \n $quem",1);
$pdf->SetXY(105, 38);
$pdf->MultiCell(50,5,"Datum \n $dtquem",1);
$pdf->SetXY(155, 38);
$pdf->MultiCell(50,5,"Lieferantenteilenummer / Stand \n $num2",1);
//linha 4
$pdf->Image('imagens/op_1.jpg',8,51,6,6);
$pdf->SetXY(15, 50);
$pdf->MultiCell(30,10,"Betrieb");
$pdf->Image('imagens/op_2.jpg',38,51,6,6);
$pdf->SetXY(45, 50);
$pdf->MultiCell(40,10,"Betrieb und Besichtigung");
$pdf->Image('imagens/op_3.jpg',78,51,6,6);
$pdf->SetXY(85, 50);
$pdf->MultiCell(30,10,"Besichtigung");
$pdf->Image('imagens/op_4.jpg',108,51,6,6);
$pdf->SetXY(115, 50);
$pdf->MultiCell(30,10,"Verzögerung");
$pdf->Image('imagens/op_5.jpg',138,51,6,6);
$pdf->SetXY(145, 50);
$pdf->MultiCell(30,10,"Beförderung");
$pdf->Image('imagens/op_6.jpg',168,51,6,6);
$pdf->SetXY(175, 50);
$pdf->MultiCell(30,10,"Entscheidung");
//linha 5
$pdf->SetFont('Arial','B',8);
$pdf->SetXY(5, 60);
$pdf->MultiCell(30,10,"ProzaBfluss",1,'C');
$pdf->SetXY(35, 60);
$pdf->MultiCell(20,5,"Betrieb Nummer",1,'C');
$pdf->SetXY(55, 60);
$pdf->MultiCell(70,10,"Beschreibung / Arbeitsgangs",1,'C');
$pdf->SetXY(125, 60);
$pdf->MultiCell(80,10,"Bemerkung",1,'C');
