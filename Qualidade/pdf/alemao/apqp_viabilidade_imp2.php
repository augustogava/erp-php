...
$pdf->Cell(35);
$pdf->Cell(0, 18, 'ANHANG E ÜBEREINSTIMMUNGSERKLÄRUNG ZUR HERSTELLBAKEIT');
$pdf->SetXY(100, 18);
$pdf->SetFont('Arial','',8);
...
$pdf->SetXY(5, 54);
$pdf->SetFont('Arial','B',8);
$pdf->MultiCell(100,10,"Bemerkungen");
//linha 5
$pdf->SetXY(5, 60);
$pdf->SetFont('Arial','',8);
$pdf->MultiCell(100,10,"Als der Antrag der Änderung im Anhang");
//linha 6
$pdf->SetXY(5, 70);
$pdf->SetFont('Arial','',8);
