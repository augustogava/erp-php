...
$pg=1;
	...
	$pdf->Cell(30);
	$pdf->Cell(0, 18, 'Datenblatt zur Mebmittel-Wiederholdbarkeit und - Vergleichbarkeit');
	$pdf->SetFont('Arial','',8);
	$pdf->SetXY(5, 18);
...
if($y>=180){
	...
	$pdf->SetXY(105, 28);
	$pdf->MultiCell(100,5,"Names des Mebmittels \n $nome",1);
	//linha 3
	$pdf->SetXY(5, 38);
	$pdf->MultiCell(100,5,"Merkmal Nr. \n $disp",1);
	$pdf->SetXY(105, 38);
...
$tol2=valor2banco($tol);
	...
	$pdf->SetXY(170, $y);
	$pdf->MultiCell(35,5,"% Tolereazn",1,'C');
	//linha 2
	$y=$y+5;
	$pdf->SetXY(5, $y);
...
$pdf->SetXY(5, $y);
if($resp["sit"]==0){ $ok="pendente"; }elseif($resp["sit"]==1){ $ok="approved"; }else{ $ok="reproved"; }
