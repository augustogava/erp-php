...
$pdf->SetXY(5, 3);
$pdf->MultiCell(290,5,"Fehler - Moglicheits - und EinfluB - Analyse",0,'C');
$pdf->SetXY(5, 18);
$pdf->SetFont('Arial','',8);
$cliente=$res[pecacli];
...
$fmea=$resp[numero];
$pg=$pdf->PageNo();
$pdf->MultiCell(50,4,"Teilenummer (Kunden) \n $cliente",1);
$pdf->SetXY(55, 18);
$pdf->MultiCell(50,4,"Zeichnungsnummer - E/A - Stand \n $rev",1);
$pdf->SetXY(105, 18);
$pdf->MultiCell(80,4,"Teilename \n $peca",1);
$pdf->SetXY(185, 18);
$pdf->MultiCell(75,4,"FMEA Nummer \n $fmea",1);
$pdf->SetXY(260, 18);
$pdf->MultiCell(30,4,"Blatt \n $pg",1);
//linha 2
$pdf->SetXY(5, 26);
$pdf->MultiCell(100,4,"Vorbereitet Von \n $resp[prep]",1);
$pdf->SetXY(105, 26);
$pdf->MultiCell(80,4,"Konstruktionsverantwortung \n $resp[resp]",1);
$pdf->SetXY(185, 26);
$pdf->MultiCell(105,4,"Kundennamme \n $res[nomecli]",1);
//linha3
$pdf->SetXY(5, 34);
$pdf->MultiCell(100,4,"Names des Lieferanten \n $rese[razao]",1);
$pdf->SetXY(105, 34);
$pdf->MultiCell(80,4,"Modell Jahr(e) / Fahrzeug(e) \n ",1);
$pdf->SetXY(185, 34);
$pdf->MultiCell(105,4,"Teilenummer / Stand (Lieferanten)\n $res[numero] - $res[rev]",1);
//linha4
$pdf->SetXY(5, 42);
$pdf->MultiCell(180,4,"Team \n $resp[equipe] ",1);
$pdf->SetXY(185, 42);
$pdf->MultiCell(75,4,"Freigegeben von \n $resp[quem]",1);
$pdf->SetXY(260, 42);
$pdf->MultiCell(30,4,"Datum \n ".banco2data($resp["dtquem"])."",1);
//linha5
$pdf->SetXY(5, 50);
$pdf->MultiCell(180,4,"Bemerkungen \n $resp[obs]",1);
$pdf->SetXY(185, 50);
$pdf->MultiCell(37.5,4,"Datum (Urspr.) \n ".banco2data($resp["ini"])."",1);
$pdf->SetXY(222.5, 50);
$pdf->MultiCell(37.5,4,"Datum (Rev.) \n ".banco2data($resp["rev"])."",1);
$pdf->SetXY(260, 50);
$pdf->MultiCell(30,4,"Verweisung Datum \n ".banco2data($resp["chv"])."",1);
//linha6
...
$pdf->MultiCell(22,4," \n Moglicher Fehler \n ",1,'C');
$pdf->SetXY(46, 60);
$pdf->MultiCell(35,4," \n Mogliche Folge(n) des Fehlers \n \n ",1,'C');
$pdf->SetXY(81, 60);
$pdf->MultiCell(4,4,"Bed",1);
$pdf->SetXY(85, 60);
$pdf->MultiCell(4,4,"Klass",1);
$pdf->SetXY(89, 60);
$pdf->MultiCell(28,4," \n Mogliche Ursache(n) des Fehlers \n ",1,'C');
$pdf->SetXY(117, 60);
$pdf->MultiCell(4,4,"Auftr",1,'C');
$pdf->SetXY(121, 60);
$pdf->MultiCell(70,4," \n Gegenwartige PrufmaBnahmen in der Konstruktion \n ",1,'C');
$pdf->SetXY(121, 72);
$pdf->MultiCell(35,8,"Verhinderung",1,'C');
$pdf->SetXY(156, 72);
$pdf->MultiCell(35,8,"Entdeckung",1,'C');
$pdf->SetXY(191, 60);
$pdf->MultiCell(4,4,"Entde",1,'C');
$pdf->SetXY(195, 60);
$pdf->MultiCell(6,4,"   R P Z   ",1,'C');
$pdf->SetXY(201, 60);
$pdf->MultiCell(24,4," \n Empfohlene AbstellmaBnahmen \n \n ",1,'C');
$pdf->SetXY(225, 60);
$pdf->MultiCell(24,4," \n Verantwortung fur die AbstellmaBnahmen \n \n ",1,'C');
$pdf->SetXY(249, 60);
$pdf->MultiCell(41,4,"Ergebnisse der MaBnahmen",1,'C');
$pdf->SetXY(249, 64);
$pdf->MultiCell(23,4," \n Ergriffene MaBnahmen \n ",1,'C');
$pdf->SetXY(272, 64);
$pdf->MultiCell(4,4,"Bed",1,'C');
$pdf->SetXY(276, 64);
$pdf->MultiCell(4,4,"Auftr",1,'C');
$pdf->SetXY(280, 64);
$pdf->MultiCell(4,4,"Entde",1,'C');
...
if(empty($tira)){
$pdf->Output('apqp_fmeaproj.pdf','I');
}
?>
