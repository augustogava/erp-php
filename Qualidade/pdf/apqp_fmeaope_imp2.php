...
$sql=mysql_query("SELECT * FROM apqp_fmeaproc2 WHERE id='$id'");
...
$pdf->SetXY(5, 5);
$pdf->MultiCell(290,5,"FMEA DE OPERAÇÕES",0,'C');
$pdf->SetXY(5, 18);
$pdf->SetFont('Arial','',8);
$cliente=$res[pecacli];
...
$sql=mysql_query("SELECT * FROM apqp_fmeaproci2 WHERE fmea='$id'");
