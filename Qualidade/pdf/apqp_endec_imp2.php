...
$pdf->SetXY(130, 40);
$pdf->MultiCell(55,5,"Resultados dos Ensaios",1,'C');
$pdf->SetXY(130, 45);
$pdf->MultiCell(27.5,5,"Pelo Fornecedor",1,'C');
$pdf->Line(157.5,50,157.5,255);
$pdf->SetXY(157.5,45);
$pdf->MultiCell(27.5,5,"Pelo Cliente",1,'C');
$pdf->SetXY(185, 40);
...
if(mysql_num_rows($sql2)){
	while($res2=mysql_fetch_array($sql2)){
		...
		if($tam[4]==0){$tama[4]=1;}
		$tama[5]=flinha($res2["forn"],27.5);
		if($tama[5]==0){$tama[5]=1;}
		$tama[6]=flinha($res2["cli"],27.5);
		if($tama[6]==0){$tama[6]=1;}
		...
		$pdf->SetXY(130, $y);
		$pdf->MultiCell(27.5,$w,"$res2[forn]",0);
		$pdf->SetXY(157.5, $y);
		$pdf->MultiCell(27.5,$w,"$res2[cli]",0);		
		$pdf->SetXY(185, $y);
