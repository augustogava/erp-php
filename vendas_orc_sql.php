...
$cod=Input::request("cod");
$cliente=Input::request("cliente");
$validade=Input::request("validade");
$emissao=Input::request("emissao");
$p_pag=Input::request("p_pag");
$instalacao=Input::request("instalacao");
$p_entrega=Input::request("p_entrega");
$frete=Input::request("frete");
$nivel=Input::request("nivel");
$frete_val=Input::request("frete_val");
...
$continuar=Input::request("continuar");
if(empty($acao)) exit;
