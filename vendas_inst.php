...
<table width="300" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td align="center"><table width="300" border="0" cellpadding="0" cellspacing="1" bgcolor="#003366">
		...
		?>
		  <tr bgcolor="#FFFFFF" class="texto"> 
            <td>&nbsp;<? print "$resnome $resc[bairro_ins] $resc[cep_ins] $resc[cidade_ins] $resc[estado_ins]";  ?></td>
            <td width="20" align="center"><a href="#" onClick="return seleciona('<? print $res["id"]; ?>','<? print "$resnome $resc[bairro_ins] $resc[cep_ins] $resc[cidade_ins] $resc[estado_ins]";  ?>');"><img src="imagens/icon_14_use.gif" alt="Selecionar" width="14" height="14" border="0"></a></td>
          </tr>
		  <?
			}
		}
