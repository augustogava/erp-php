...
function seleciona(nome,id){
	opener.form1.<? print "$pag"."n"; ?>.value=nome;
	opener.form1.<? print "$pag"; ?>.value=id;
	window.close();
}
windowWidth=320;
windowHeight=300;
    ...
    <td><form name="form1" method="post" action="">
        <table width="400" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr class="textobold"> 
            ...
            <input name="buscar" type="hidden" id="buscar5" value="true">            <input name="pag" type="hidden" id="buscar" value="<?= $pag; ?>"></td>
          </tr>
        </table>
      </form></td>
  </tr>
  ...
  <tr>
    <td><table width="400" border="0" cellpadding="0" cellspacing="1" bgcolor="#003366">
      ...
      <tr bgcolor="#FFFFFF" class="texto">
        ...
        <td width="23" align="center"><a href="#" onClick="return seleciona('<? print $res["nome"]; ?>','<? print $res["id"]; ?>');"><img src="imagens/icon_14_use.gif" alt="Selecionar" width="14" height="14" border="0"></a></td>
      </tr>
      <?
			}
		}
          ...
          <td align="center"><table width="1%" border="0" cellspacing="0" cellpadding="0">
              <tr valign="top"> 
				...
				if($wp>1){
					$antz=true;
				?>
                  <a href="<? print "cortinas_prod.php?wp=$pg_anterior&bcli=$bcli"; ?>" class="paginacao2"> 
                  <? } ?>
                ...
                <td align="center"> 
                  ...
                  <a href="<? print "cortinas_prod.php?wp=$link_impressos&bcli=$bcli"; ?>" class="paginacao"> 
                  <? } ?>
                ...
                <td> 
                  ...
                  <a href="<? print "cortinas_prod.php?wp=$pg_proxima&bcli=$bcli"; ?>" class="paginacao2"> 
                  <? } ?>
