...
if($acao=="alt"){
	$sql=mysql_query("SELECT * FROM material WHERE id='$id'");
...
<? if($acao=="entrar"){ ?>
  ...
  <tr> 
    <td align="left" valign="top"><table width="300" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td><div align="center"><a href="material.php?acao=inc" class="textobold">Incluir 
              um Material </a> </div></td>
        </tr>
      </table>
      <table width="450" border="0" cellpadding="0" cellspacing="1" bgcolor="#003366">
        <tr class="textoboldbranco"> 
          <td width="196">&nbsp;Material</td>
          <td width="62"> &nbsp;Valor </td>
          <td width="62">Peso</td>
          <td width="18">&nbsp;</td>
          <td width="20">&nbsp;</td>
        </tr>
