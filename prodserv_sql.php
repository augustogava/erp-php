...
$codprod=Input::request("codprod");
$min=Input::request("min");
$max=Input::request("max");
$est=Input::request("est");
$vm=Input::request("vm");
$comi=Input::request("comi");
$cm=Input::request("cm");
$cs=Input::request("cs");
$pv=Input::request("pv");
$icms=Input::request("icms");
$ipi=Input::request("ipi");
$margem=Input::request("margem");
$percicms=Input::request("percicms");
$pesol=Input::request("pesol");
$pesob=Input::request("pesob");
$ultima_entrega=Input::request("ultima_entrega");
$prev_entrega=Input::request("prev_entrega");
$preco_ult_compra=Input::request("preco_ult_compra");
$comissao=Input::request("comissao");
$icmsv=Input::request("icmsv");
$ipiv=Input::request("ipiv");
$isento=Input::request("isento");
$id_mat=Input::request("id_mat");
...
$valorizado=Input::request("valorizado");
$class=Input::request("class");
$ume=Input::request("ume");
$ums=Input::request("ums");
$tabe=Input::request("tabe");
$tabs=Input::request("tabs");
$sitri=Input::request("sitri");
$clafis=Input::request("clafis");
$descricao=Input::request("descricao");
$espec=Input::request("espec");
$virtual=Input::request("virtual");
$material=Input::request("material");
$tamanho=Input::request("tamanho");
$cor=Input::request("cor");
$embalagem=Input::request("embalagem");
$prazo_entrega=Input::request("prazo_entrega");
$cod_ult_forn=Input::request("cod_ult_forn");
$destaque=Input::request("destaque");
$altura=Input::request("altura");
$largura=Input::request("largura");
$profundidade=Input::request("profundidade");
$cubagem=Input::request("cubagem");
$desc_curta=Input::request("desc_curta");
$correlacionado1=Input::request("correlacionado1");
$correlacionado2=Input::request("correlacionado2");
$corredor=Input::request("corredor");
$prateleira=Input::request("prateleira");
$posi=Input::request("posi");
$tindicado1=Input::request("tindicado1");
$tindicado2=Input::request("tindicado2");
$tindicado3=Input::request("tindicado3");
$tindicado4=Input::request("tindicado4");
$frete=Input::request("frete");
$ecat=Input::request("ecat");
$porta=Input::request("porta");
$cortina=Input::request("cortina");
$fixacao=Input::request("fixacao");
$linha=Input::request("linha");
$cortina_not=Input::request("cortina_not");
$id=Input::request("id");
$cat=Input::request("cat");
$imp=Input::request("imp");
$marg=Input::request("marg");
$ii=Input::request("ii");
$di=Input::request("di");
$valor=Input::request("valor");
$qtd=Input::request("qtd");
$rateado=Input::request("rateado");
$custo=Input::request("custo");
$icmstv=Input::request("icmstv");
$ipitv=Input::request("ipitv");
$fretev=Input::request("fretev");
$seguro=Input::request("seguro");
$segurov=Input::request("segurov");
if(empty($acao)) exit;
