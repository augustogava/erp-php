  ...
  <tr>
    <td align="left" valign="top"><table width="422" cellpadding="0" cellspacing="1" bgcolor="#003366">
      <tr>
        ...
        <td width="213" bgcolor="#FFFFFF" class="texto">&nbsp;<a href="pedidospendentes_his.php?cli=<?php echo  $clid; ?>" class="texto"><?php print $res["fantasia"]; ?></a></td>
        <td width="49" bgcolor="#003366" class="textoboldbranco">&nbsp;C&oacute;digo</td>
        <td width="105" bgcolor="#FFFFFF" class="texto">&nbsp;<?php print $res["id"]; ?></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td bgcolor="#FFFFFF" class="texto">&nbsp;<?php print $res["contato"]; ?></td>
        <td bgcolor="#003366" class="textoboldbranco">&nbsp;Cargo</td>
        <td bgcolor="#FFFFFF" class="texto">&nbsp;<?php print $res["cargo"]; ?></td>
      </tr>
      <tr>
        <td bgcolor="#003366" class="textoboldbranco">&nbsp;CNPJ</td>
        <td bgcolor="#FFFFFF" class="texto">&nbsp;<?php print $res["cnpj"]; ?></td>
        <td bgcolor="#003366" class="textoboldbranco">&nbsp;IE</td>
        <td bgcolor="#FFFFFF" class="texto">&nbsp;<?php print $res["ei"]; ?></td>
      </tr>
      <tr>
        <td bgcolor="#003366" class="textoboldbranco">CPF</td>
        <td colspan="3" bgcolor="#FFFFFF" class="texto"><?php print $res["cpf"]; ?></td>
      </tr>
      <tr>
        <td bgcolor="#003366" class="textoboldbranco">&nbsp;Endereco</td>
        <td colspan="3" bgcolor="#FFFFFF" class="texto">&nbsp;<?php print $res["endereco"]; ?></td>
      </tr>
      <tr>
        <td bgcolor="#003366" class="textoboldbranco">&nbsp;Bairro</td>
        <td colspan="3" bgcolor="#FFFFFF" class="texto">&nbsp;<?php print $res["bairro"]; ?></td>
      </tr>
      <tr>
        <td bgcolor="#003366" class="textoboldbranco">&nbsp;Cidade</td>
        <td colspan="3" bgcolor="#FFFFFF" class="texto">&nbsp;<?php print $res["cidade"]; ?></td>
      </tr>
      <tr>
        <td bgcolor="#003366" class="textoboldbranco">&nbsp;CEP</td>
        <td bgcolor="#FFFFFF" class="texto">&nbsp;<?php print $res["cep"]; ?></td>
        <td bgcolor="#003366" class="textoboldbranco">&nbsp;Estado</td>
        <td bgcolor="#FFFFFF" class="texto">&nbsp;<?php $sqlc=mysql_query("SELECT * FROM estado WHERE id='$res[estado]'"); $resc=mysql_fetch_array($sqlc); print $resc["nome"]; ?></td>
      </tr>
<?php 
  ...
  <tr>
    <td align="left" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#003366">
      ...
      <tr bgcolor="#FFFFFF" class="texto">
        <td width="286">&nbsp;<?php print $res["produto_nome"]; ?></td>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input name="Submit222" type="button" class="microtxt" value="Ver Pedido" onClick="window.location='vendas.php?acao=alt&id=<?php echo  $vd; ?>'"></td>
  </tr>
</table>
</body>
</html>
