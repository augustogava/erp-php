...
<table width="594" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr> 
    <td align="center" valign="top" class="textobold">EXTRATO 
      <?php if($bdias==0){ print "DO DIA"; }else{ print "$bdias DIAS"; } ?>
    </td>
  </tr>
  <tr> 
    <td align="left" valign="top"><table width="594" border="0" cellpadding="0" cellspacing="1" bgcolor="#003366">
        ...
        <tr bgcolor="#FFFFFF" class="texto" onMouseover="changeto('#CCCCCC')" onMouseout="changeback('#FFFFFF')"> 
          <td align="center"><?php print banco2data($res["data"]); ?></td>
          <td>&nbsp;<?php print $res["nome"]; ?></td>
          <td>&nbsp;<?php print $res["documento"]; ?></td>
          <td align="right"> 
            <?php if($neg){ print "<font color=\"#ff0000\">-".banco2valor($val)."</font>"; }else{ print banco2valor($val); } ?>
            &nbsp;</td>
          <td>&nbsp;<?php print $res["hist"]; ?></td>
          <td align="right"><?php print banco2valor($res["saldo_ant"]); ?>&nbsp;</td>
        </tr>
        <?php
			}
		}
        ...
        <form name="form2" method="post" action="">
          <tr> 
            ...
            <td width="403" align="right" class="textobold">Saldo atual&nbsp; 
              <input name="textfield" type="text" class="formulario" value="<?php print $sld; ?>" size="15" readonly> 
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Saldo + limite&nbsp; <input name="textfield2" type="text" class="formulario" value="<?php print $sld2; ?>" size="15" readonly></td>
          </tr>
        </form>
      </table></td>
  </tr>
