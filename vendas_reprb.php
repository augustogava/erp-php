...
function seleciona(nome,id){
	opener.formbus.repre.value=nome;
	opener.formbus.representante.value=id;
	window.close();
}
windowWidth=320;
windowHeight=300;
...
<table width="300" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td><table width="300" border="0" cellpadding="0" cellspacing="1" bgcolor="#003366">
		...
		<?
		$sql=mysql_query("SELECT * FROM representante $busca ORDER BY nome ASC");
        ...
        <?
			...
			if($results_tot>$maxpag){
				...
				$sql=mysql_query("SELECT * FROM representante $busca ORDER BY nome ASC LIMIT $param, $maxpag");
