...
<table width="594" border="0" cellpadding="0" cellspacing="0">
  <tr> 
    <td><table width="594" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td> <form name="form1" method="post" action="pdf/moni_esta_radh_imp.php" onSubmit="return verifica(this)">
<table width="591" border="0" cellpadding="0" cellspacing="0" class="texto">
  <tr>
    ...
    <td width="564" align="right"><div align="left"><span class="textobold style1 style1"><span class="titulos">Monitoramento &gt; Estat&iacute;stica &gt; Relat&oacute;rio de Acesso por</span></span><span class="titulos"> Data e Hora</span> </div></td>
  </tr>
  <tr>
    <td align="center">&nbsp;</td>
    <td align="right">&nbsp;</td>
...
<table width="39%" border="1" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC">
                <tr>
                  <td><table width="229" border="0" cellspacing="3" cellpadding="0">
                    <tr>
                      <td colspan="2" align="center" bgcolor="#003366" class="textoboldbranco">Busca</td>
                    </tr>
                    <tr class="textobold">
                      <td>Data:                        </td>
                      <td><input name="data" type="text" class="formulario" id="data" size="20" onKeyPress="return validanum(this, event)" onKeyUp="mdata(this)">
                        <a href="#" onClick="return abre('moni_esta_raex_imp_busc.php','busca','width=320,height=300,scrollbars=1');"></a></td>
                    </tr>
                    <tr class="textobold">
                      <td width="104">Hora  Inicial: </td>
                      <td width="116"><label>
                        <input name="hora_i" type="text" class="formulario" id="hora_i" size="20" onKeyPress="return validanum(this, event)" onKeyUp="mhora(this)">
                      </label></td>
                    </tr>
                    <tr class="textobold">
                      <td>Hora Final: </td>
