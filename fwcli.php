...
if(!empty($bcli)){
	$busca="WHERE nome LIKE '%$bcli%' OR fantasia LIKE '%$bcli%'";
}
?>
<html>
<head>
  ...
  <tr>
    <td><table width="300" border="0" cellpadding="0" cellspacing="1" bgcolor="#003366">
		...
		<tr bgcolor="#FFFFFF" class="texto"> 
          ...
          <td width="20" align="center"><a href="#" onClick="return seleciona('<?php print htmlspecialchars($res["nome"], ENT_QUOTES); ?>','<?php print $res["id"]; ?>');"><img src="imagens/icon_14_use.gif" alt="Selecionar" width="14" height="14" border="0"></a></td>
        </tr>
		<?php
			}
		}
          ...
          <td align="center"><table width="1%" border="0" cellspacing="0" cellpadding="0">
              <tr valign="top"> 
				...
				if($wp>1){
					$antz=true;
				?>
                  <a href="<?php print "fwcli.php?wp=$pg_anterior&bcli=$bcli&btipo=$btipo"; ?>" class="paginacao2"> 
                  <?php } ?>
                ...
                <td align="center"> 
                  ...
                  <a href="<?php print "fwcli.php?wp=$link_impressos&bcli=$bcli&btipo=$btipo"; ?>" class="paginacao"> 
                  <?php } ?>
                ...
                <td> 
                  ...
                  <a href="<?php print "fwcli.php?wp=$pg_proxima&bcli=$bcli&btipo=$btipo"; ?>" class="paginacao2"> 
                  <?php } ?>
