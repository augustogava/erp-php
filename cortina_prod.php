...
function seleciona(nome,id){
	opener.form1.<?php echo  $cp2; ?>.value=nome;
	opener.form1.<?php echo  $cp1; ?>.value=id;
	window.close();
}
windowWidth=320;
windowHeight=300;
          ...
          <td align="center"><table width="1%" border="0" cellspacing="0" cellpadding="0">
              <tr valign="top"> 
				...
				if($wp>1){
					$antz=true;
				?>
                  <a href="<?php print "perfil_prod.php?wp=$pg_anterior&bcli=$bcli"; ?>" class="paginacao2"> 
                  <?php } ?>
                ...
                <td align="center"> 
                  ...
                  <a href="<?php print "perfil_prod.php?wp=$link_impressos&bcli=$bcli"; ?>" class="paginacao"> 
                  <?php } ?>
                ...
                <td> 
                  ...
                  <a href="<?php print "perfil_prod.php?wp=$pg_proxima&bcli=$bcli"; ?>" class="paginacao2"> 
                  <?php } ?>
