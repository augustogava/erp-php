            ...
            <table width="100%"  border="0" cellpadding="0" cellspacing="0">
			  ...
			  ?>
                  <tr bgcolor="#FFFFFF" class="texto" onMouseover="changeto('#CCCCCC')" onMouseout="changeback('#FFFFFF')">
                    ...
                    <td align="center"><a href="status.php?acao=blok&usu=<?php echo  $res["user"]; ?>&fun=<?php echo  $res["funcionario"]; ?>" onMouseOver="this.T_DELAY=10; this.T_WIDTH=225;  return escape('Bloquear esse usuário para acesso ao Manager')"><img src="imagens/icon14_cancelar.gif" width="16" height="16" border="0"></a></td>
                    <td align="center"><a href="status.php?acao=externo&usu=<?php echo  $res["user"]; ?>&fun=<?php echo  $res["funcionario"]; ?>" onMouseOver="this.T_DELAY=10; this.T_WIDTH=225;  return escape('Bloquear esse usuário para acesso Externo(Fora da Empresa)')"><img src="imagens/icon14_cancelar3.gif" width="16" height="16" border="0"></a></td>
                  </tr>
                  <?php
			  	}
			  }
