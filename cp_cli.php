...
function seleciona(nome,id){
	...
	opener.form1.cliente_tipo.value='<?php print $bt; ?>';
	window.close();
}
windowWidth=320;
windowHeight=300;
  ...
  <tr> 
    <td><form name="form1" method="post" action="">
        <table width="300" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr class="textobold"> 
            <td>&nbsp;Tipo:</td>
            <td> <input name="btipo" type="radio" value="clientes" checked>
              Cliente 
              <input type="radio" name="btipo" value="fornecedores">
              Fornecedor 
          ...
          <td align="center"><table width="1%" border="0" cellspacing="0" cellpadding="0">
              <tr valign="top"> 
				...
				if($wp>1){
					$antz=true;
				?>
                  <a href="<?php print "cp_cli.php?wp=$pg_anterior&bcli=$bcli&btipo=$btipo"; ?>" class="paginacao2"> 
                  <?php } ?>
                ...
                <td align="center"> 
                  ...
                  <a href="<?php print "cp_cli.php?wp=$link_impressos&bcli=$bcli&btipo=$btipo"; ?>" class="paginacao"> 
                  <?php } ?>
                ...
                <td> 
                  ...
                  <a href="<?php print "cp_cli.php?wp=$pg_proxima&bcli=$bcli&btipo=$btipo"; ?>" class="paginacao2"> 
                  <?php } ?>
