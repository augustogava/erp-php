...
$ps=Input::request("ps");
$cp1=Input::request("cp1");
$cp2=Input::request("cp2");
if($buscar){
	unset($wp);
}
if(!empty($ps)){
...
function seleciona(nome,id){
	opener.form1.correlacionado11.value=nome;
	opener.form1.correlacionado1.value=id;
	window.close();
}
windowWidth=320;
windowHeight=300;
          ...
          <td align="center"><table width="1%" border="0" cellspacing="0" cellpadding="0">
              <tr valign="top"> 
				...
				if($wp>1){
					$antz=true;
				?>
                  <a href="<?php print "prodserv_bus.php?wp=$pg_anterior&bcli=$bcli"; ?>" class="paginacao2"> 
                  <?php } ?>
                ...
                <td align="center"> 
                  ...
                  <a href="<?php print "prodserv_bus.php?wp=$link_impressos&bcli=$bcli"; ?>" class="paginacao"> 
                  <?php } ?>
                ...
                <td> 
                  ...
                  <a href="<?php print "prodserv_bus.php?wp=$pg_proxima&bcli=$bcli"; ?>" class="paginacao2"> 
                  <?php } ?>
