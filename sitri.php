...
if($acao=="alt"){
	$sql=mysql_query("SELECT * FROM sitri WHERE id='$id'");
...
<tr>
    <td align="left" valign="top"><table width="590" border="0" cellpadding="0" cellspacing="0" class="texto">
      <tr>
        ...
        <td width="563" align="right"><div align="left" class="titulos">Situa&ccedil;&atilde;o Tribut&aacute;ria </div></td>
      </tr>
      <tr>
        <td align="center">&nbsp;</td>
        <td align="right">&nbsp;</td>
    ...
    <td align="left" valign="top"><table width="400" border="0" cellspacing="0" cellpadding="0">
      ...
      <table width="400" border="0" cellpadding="0" cellspacing="1" bgcolor="#003366">
        ...
        <tr bgcolor="#FFFFFF" class="texto" onMouseover="changeto('#CCCCCC')" onMouseout="changeback('#FFFFFF')"> 
          ...
          <td width="19" align="center"><a href="#" onClick="return pergunta('Deseja excluir esta Situação Tributária?','sitri_sql.php?acao=exc&id=<?php print $res["id"]; ?>')"><img src="imagens/icon14_lixeira.gif" alt="Excluir" width="14" height="14" border="0"></a></td>
        </tr>
        <?php
			  	}
			  }
        ...
        <table width="400" border="0" cellpadding="0" cellspacing="0">
          <tr bgcolor="#003366"> 
            <td colspan="2" align="center" class="textoboldbranco"> 
              <?php if($acao=="inc"){ print"Incluir Situação Tributária"; }else{ print"Alterar Situação Tributária";} ?>            </td>
          </tr>
          <tr> 
