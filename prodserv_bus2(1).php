...
$busca="WHERE (class='C' OR class='P') ";
if(!empty($bcli)){
	$busca.="AND nome LIKE '%$bcli%' AND apelido LIKE '%$bcli%' ";
}
?>
<html>
<head>
  ...
  <tr>
    <td><table width="300" border="0" cellpadding="0" cellspacing="1" bgcolor="#003366">
      ...
      <tr bgcolor="#FFFFFF" class="texto">
        <td colspan="2" align="center">NENHUM PRODUTO ENCONTRADO</td>
      </tr>
      <?php
		}else{
			//BLOCO PAGINACAO
          ...
          <td align="center"><table width="1%" border="0" cellspacing="0" cellpadding="0">
              <tr valign="top"> 
				...
				if($wp>1){
					$antz=true;
				?>
                  <a href="<?php print "prodserv_bus2.php?wp=$pg_anterior&bcli=$bcli"; ?>" class="paginacao2"> 
                  <?php } ?>
                ...
                <td align="center"> 
                  ...
                  <a href="<?php print "prodserv_bus2.php?wp=$link_impressos&bcli=$bcli"; ?>" class="paginacao"> 
                  <?php } ?>
                ...
                <td> 
                  ...
                  <a href="<?php print "prodserv_bus2.php?wp=$pg_proxima&bcli=$bcli"; ?>" class="paginacao2"> 
                  <?php } ?>
