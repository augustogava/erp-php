...
if($acao=="inc"){
	...
	$_SESSION["mensagem"]="Lista de requisiчѕes alterada com sucesso!";
	exit;
}elseif($acao=="alt"){
	...
	if($sql){
		$_SESSION["mensagem"]="Cotaчуo alterada com sucesso!";
	}else{
		$_SESSION["mensagem"]="A cotaчуo nуo pєde ser alterada!";
	}
	if($maisum){
		$sql=mysql_query("INSERT INTO compras_cotacao_list (cotacao) VALUES ('$id')");
	...
	if($sql){
		...
		$_SESSION["mensagem"]="Cotaчуo excluэda com sucesso!";
	}else{
		$_SESSION["mensagem"]="O Cotaчуo nуo pєde ser excluэda!";
	}
	header("Location:compras_cot.php");
	exit;
}
