          ...
          <td align="center"><table width="1%" border="0" cellspacing="0" cellpadding="0">
              <tr valign="top"> 
				...
				if($wp>1){
					$antz=true;
				?>
                  <a href="<? print "cpvc_pvc_sup.php?wp=$pg_anterior&bcli=$bcli"; ?>" class="paginacao2"> 
                  <? } ?>
                ...
                <td align="center"> 
                  ...
                  <a href="<? print "cpvc_pvc_sup.php?wp=$link_impressos&bcli=$bcli"; ?>" class="paginacao"> 
                  <? } ?>
                ...
                <td> 
                  ...
                  <a href="<? print "cpvc_pvc_sup.php?wp=$pg_proxima&bcli=$bcli"; ?>" class="paginacao2"> 
                  <? } ?>
