...
<div class="erp-container-fluid">
    ...
    <div class="erp-pagination">
        ...
        <a href="?wp=<?=$pagina_atual-1?>" class="erp-pagination-item"><i class="fas fa-chevron-left"></i> Anterior</a>
        <?php endif; ?>
        ...
        <a href="?wp=<?=$pagina_atual+1?>" class="erp-pagination-item">Proxima <i class="fas fa-chevron-right"></i></a>
        <?php endif; ?>
    </div>
    <?php endif; ?>
