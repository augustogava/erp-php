      ...
      <table width="300" border="0" cellpadding="0" cellspacing="1" bgcolor="#003366">
		...
		?>
		  <tr bgcolor="#FFFFFF" class="texto"> 
            ...
            <td width="20" align="center"><a href="#" onClick="return seleciona('<? print $res["id"]; ?>');"><img src="imagens/icon_14_use.gif" alt="Selecionar" width="14" height="14" border="0"></a></td>
          </tr>
		  <?
			}
		}
          ...
          <td align="center"><table width="1%" border="0" cellspacing="0" cellpadding="0">
              <tr valign="top"> 
				...
				if($wp>1){
					$antz=true;
				?>
                  <a href="<? print "nf_prodserv.php?wp=$pg_anterior&bcli=$bcli"; ?>" class="paginacao2"> 
                  <? } ?>
                ...
                <td align="center"> 
                  ...
                  <a href="<? print "nf_prodserv.php?wp=$link_impressos&bcli=$bcli"; ?>" class="paginacao"> 
                  <? } ?>
                ...
                <td> 
                  ...
                  <a href="<? print "nf_prodserv.php?wp=$pg_proxima&bcli=$bcli"; ?>" class="paginacao2"> 
                  <? } ?>
