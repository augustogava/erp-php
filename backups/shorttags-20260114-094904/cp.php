...
<?php } ?>
                            ...
                            <td class="erp-text-center">
                                <a href="#" onclick="return abre('cp_hist.php?id=<?=$res["id"]?>','a','width=470,height=300,scrollbars=1');">
<?php if($res["pago"]=="N"){ ?>
...
<?php if($res["pago"]=="S" and $sit!="C"){ ?>
                                <a href="#" onclick="return pergunta('Deseja desfazer o pagamento desta parcela?','cp_sql.php?acao=desf&ct=<?=$id?>&id=<?=$res["id"]?>');" class="erp-table-action" style="color:#e74c3c;">
                ...
                <table class="erp-table">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><strong style="color:#e74c3c;">R$ <?=banco2valor($valor2-$tp2)?></strong></td>
                            <td>
<?php 
$sit_class = "info";
$sit_text = "";
