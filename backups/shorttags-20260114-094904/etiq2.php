...
$pdf->Set_Char_Size(1);
	...
	while($res=mysql_fetch_array($sql)){
		...
		//FollowUp
		mysql_query("INSERT INTO followup (cliente,data,hora,titulo,descricao,tipo) VALUES('$res[id]','$data','$hora','Aчуo Marketing','Foi enviado a seguinte Aчуo de Marketing para este cliente: $nome','3')");
