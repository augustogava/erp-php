        ...
        <tr>
          <td><table width="100%" border="0" cellpadding="3" cellspacing="0" class="texto">
            ...
            <tr>
              ...
              <td width="227" class="textobold"><input name="numero" type="text" disabled class="formulario" id="numero" value="<?= $res["numero"]; ?>" size="50" maxlength="40">
              </td>
              ...
              <td width="234"><p class="textobold">
                  <input name="rev" type="text" class="formularioselect" id="rev4" value="<?= $res["rev"]; ?>" size="5" maxlength="20" disabled>
              </p></td>
            </tr>
            <tr>
              <td class="textobold">Cliente</td>
              <td><input name="clienteasd" type="text" class="formularioselect" id="clienteasd" value="<? $sql2=mysql_query("SELECT * FROM clientes WHERE id='$res[cliente]'"); $res2=mysql_fetch_array($sql2); print $res2["nome"]; ?>" maxlength="150" disabled></td>
              <td align="right" class="textobold"><div align="left">N&deg; Pe&ccedil;a Cliente </div></td>
              <td>
                <input name="pcli" type="text" class="formularioselect" id="rev3" value="<?= $res["pecacli"]; ?>" size="5" maxlength="20" disabled>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              <td class="textobold">Cliente
                <input name="cliente" type="hidden" id="cliente" value="<? print $res["cliente"]; ?>"></td>
              <td><input name="nomecli" type="text" class="formulario" id="nomecli" value="<? print $res["nomecli"]; ?>" size="45" readonly>
            ...
            <tr align="center">
              <td colspan="4" class="textobold"><table width="700" border="0" cellpadding="3" cellspacing="0" class="texto">
                  <tr>
                    <td width="3%" align="center"><input name="cp[0]" type="checkbox" id="cp0" value="apqp_fluxo" <? if(!empty($nome)){ if(in_array("Diagrama de Fluxo",$nome)){ print "Checked"; } } ?>></td>
                    <td width="21%" class="textobold">Diagrama de Fluxo </td>
                    <td width="4%" align="center"><input name="cp[6]" type="checkbox" id="cp6" value="apqp_endi"  <? if(!empty($nome)){ if(in_array("Ensaio Dimensional",$nome)){ print "Checked"; } } ?>></td>
                    <td width="21%" class="textobold">Ensaio Dimensional </td>
                    <td width="3%" align="center"><input name="cp[12]" type="checkbox" id="cp12" value="apqp_plano" <? if(!empty($nome)){ if(in_array("Plano de Controle",$nome)){ print "Checked"; } } ?>></td>
                    <td width="18%" class="textobold">Plano de Controle </td>
                    <td width="4%" align="center"><input name="cp[18]" type="checkbox" id="cp18" value="apqp_sum" <? if(!empty($nome)){ if(in_array("Sumário e Aprovação do APQP",$nome)){ print "Checked"; } } ?>></td>
                  ...
                  <tr>
                    ...
                    <td align="center"><input name="cp[7]" type="checkbox" id="cp7" value="apqp_enma" <? if(!empty($nome)){ if(in_array("Ensaio Material",$nome)){ print "Checked"; } } ?>></td>
                  ...
                  <tr>
                    <td align="center"><input name="cp[2]" type="checkbox" id="cp2" value="apqp_fmeaproc" <? if(!empty($nome)){ if(in_array("FMEA de Processo",$nome)){ print "Checked"; } } ?>></td>
                    <td class="textobold">Fmea de Processo </td>
                    <td align="center"><input name="cp[8]" type="checkbox" id="cp8" value="apqp_ende" <? if(!empty($nome)){ if(in_array("Ensaio Desempenho",$nome)){ print "Checked"; } } ?>></td>
                    <td class="textobold">Ensaio Desempenho</td>
                    <td align="center"><input name="cp[14]" type="checkbox" id="cp14" value="apqp_viabilidade" <? if(!empty($nome)){ if(in_array("Viabilidade",$nome)){ print "Checked"; } } ?>></td>
                  ...
                  <tr>
                    <td align="center"><input name="cp[3]" type="checkbox" id="cp3" value="apqp_rr" <? if(!empty($nome)){ if(in_array("Estudos de R&R",$nome)){ print "Checked"; } } ?>></td>
                    <td class="textobold">Estudos de R&amp;R </td>
                    <td align="center"><input name="cp[9]" type="checkbox" id="cp9" value="apqp_sub" <? if(!empty($nome)){ if(in_array("Certificado de Submissão",$nome)){ print "Checked"; } } ?>></td>
                  ...
                  <tr>
                    <td align="center"><input name="cp[4]" type="checkbox" id="cp4" value="apqp_cap" <? if(!empty($nome)){ if(in_array("Estudos de Capabilidade",$nome)){ print "Checked"; } } ?>></td>
                  ...
                  <tr>
                    ...
                    <td align="center"><input name="cp[11]" type="checkbox" id="cp11" value="apqp_inst"<? if(!empty($nome)){ if(in_array("Instruções do Operador",$nome)){ print "Checked"; } } ?>></td>
            ...
            <tr align="center">
              <td colspan="4" class="textobold">
                <input name="pc" type="hidden" id="pc" value="<?= $pc; ?>">
