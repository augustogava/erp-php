    ...
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#003366">
            <tr>
              <td width="569" class="textoboldbranco">RELAT&Oacute;RIOS</td>
            ...
            <tr align="left" bgcolor="#FFFFFF">
              <td colspan="2" id="apqp4"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr align="center">
                  <td width="124"><a href="moni_esta_raus.php"><img src="imagens/icon_dv2.jpg" alt="Cronograma" width="35" height="40" border="0"></a></td>
                  <td width="124"><a href="moni_esta_raex.php"><img src="imagens/icon_dv2.jpg" width="34" height="40" border="0"></a></td>
                  <td width="124"><a href="moni_esta_radh.php"><img src="imagens/icon_dv2.jpg" width="34" height="40" border="0"></a></td>
                  <td width="124"><a href="moni_esta_raudh.php"><img src="imagens/icon_dv2.jpg" width="34" height="40" border="0"></a></td>
                  <td width="124"><a href="moni_esta_raac.php"><img src="imagens/icon_dv2.jpg" width="34" height="40" border="0"></a></td>
                  <td width="124"><a href="moni_esta_ralp.php"><img src="imagens/icon_dv2.jpg" width="34" height="40" border="0"></a></td>
                  </tr>
