        ...
        <tr>
          <td><table width="394" border="0" cellpadding="0" cellspacing="3">
              ...
              <td width="258"><table width="108%"  border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="29%"><span class="textobold">
                      <input name="cod" type="text" class="formulario" id="cod" size="10" maxlength="10" value="<? print $cod;?>" <? if($acao=="alt"){ print "readonly"; } ?>>
                    </span></td>
                    <td width="38%" class="textobold"><div align="center">Data do Cadastro :</div></td>
                    <td width="33%" class="textobold"><input name="data1" type="text" class="formulario" id="data1" onKeyPress="return validanum(this, event)" onKeyUp="mdata(this)" size="10" maxlength="10" value="<? print $data1;?>">&nbsp;<a href="#" class="" onClick="window.open('agenda_pop.php?window_position=metr_lab_cad','','scrollbars=no,width=155,height=138');"><img src="imagens/icon14_cal.gif" width="14" height="14" border="0"></a></td>
                  </tr>
              </table></td>
            </tr>
            <tr>
              <td class="textobold">Empresa:</td>
              <td class="textobold"><input name="empresa" type="text" class="formulario" id="empresa" size="50" maxlength="50" value="<? print $empresa;?>"></td>
            </tr>
            <tr>
              <td class="textobold">Fantasia:</td>
              <td class="textobold"><input name="fantasia" type="text" class="formulario" id="fantasia" size="50" maxlength="50" value="<? print $fantasia;?>"></td>
            </tr>
            <tr>
              <td class="textobold">Endere&ccedil;o:</td>
              <td><input name="endereco" type="text" class="formulario" id="endereco" size="50" maxlength="50" value="<? print $endereco;?>"></td>
            </tr>
            <tr>
              <td class="textobold">Bairro: </td>
              <td><input name="bairro" type="text" class="formulario" id="bairro" size="50" maxlength="50" value="<? print $bairro;?>"></td>
            </tr>
            <tr>
              <td class="textobold">Cidade:</td>
              <td><input name="cidade" type="text" class="formulario" id="cidade" size="50" maxlength="50" value="<? print $cidade;?>"></td>
            </tr>
            <tr>
              <td class="textobold">Cep: </td>
              <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="56%"><input name="cep" type="text" class="formulario" id="cep" size="10" maxlength="9" onKeyPress="return validanum(this, event)" onKeyUp="mcep(this)" value="<? print $cep;?>"></td>
            ...
            <tr>
              ...
              <td><input name="pais" type="text" class="formulario" id="pais" size="50" maxlength="50" value="<? print $pais;?>"></td>
            </tr>
            <tr>
              <td class="textobold">Fone:</td>
              <td><input name="fone" type="text" class="formulario" id="fone" size="20" maxlength="9" value="<? print $fone;?>"></td>
            </tr>
            <tr>
              <td class="textobold">Fax:</td>
              <td><input name="fax" type="text" class="formulario" id="fax" size="20" maxlength="9" value="<? print $fax;?>"></td>
            </tr>
            <tr>
              <td class="textobold">CPF:</td>
              <td><input name="cpf" type="text" class="formulario" id="cpf" size="20" maxlength="14" onKeyPress="return validanum(this, event)" onKeyUp="mcpf(this)" onBlur="bloqueia();" value="<? print $cpf;?>" <? if($acao=="alt"){ print "readonly"; } ?>></td>
            </tr>
            <tr>
              <td class="textobold">CNPJ:</td>
              <td><input name="cnpj" type="text" class="formulario" id="cnpj" size="20" maxlength="15" onKeyPress="return validanum(this, event)" onKeyUp="mcgc(this)" onBlur="bloqueia2();" value="<? print $cnpj;?>" <? if($acao=="alt"){ print "readonly"; } ?>></td>
            </tr>
            <tr>
              <td class="textobold">Incri&ccedil;&atilde;o Municipal:</td>
              <td><input name="insc_m" type="text" class="formulario" id="insc_m" size="20" maxlength="20" value="<? print $insc_m;?>"></td>
            </tr>
            <tr>
              <td class="textobold">Incri&ccedil;&atilde;o Estadual:</td>
              <td><input name="insc_e" type="text" class="formulario" id="insc_e" size="20" maxlength="20" value="<? print $insc_e;?>"></td>
            </tr>
            <tr>
              <td class="textobold">E-mail:</td>
              <td><input name="email" type="text" class="formulario" id="email" size="50" maxlength="50" value="<? print $email;?>"></td>
            </tr>
            <tr>
              <td class="textobold">Site:</td>
              <td><input name="site" type="text" class="formulario" id="site" size="50" maxlength="50" value="<? print $site;?>"></td>
            </tr>
            <tr>
              <td class="textobold">&Uacute;ltima Atualiza&ccedil;&atilde;o: </td>
              <td><input name="atualizacao" type="text" class="formulario" id="atualizacao" size="50" maxlength="50" value="<?=$atualizacao; ?>" readonly=""></td>
            </tr>
          </table></td>
        </tr>
      </table>
