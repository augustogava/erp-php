  ...
  <tr>
    <td align="left" valign="top" class="chamadas"><table width="590" border="0" cellpadding="0" cellspacing="0" class="texto">
      <tr>
        ...
        <td width="563" align="right"><div align="left" class="textobold style3">APQP - Sum&aacute;rio e Aprova&ccedil;&atilde;o do APQP&nbsp;<? print $npc; ?></div></td>
      </tr>
      <tr>
        <td align="center">&nbsp;</td>
        <td align="right">&nbsp;</td>
            ...
            <tr>
              <td><table width="693" border="0" cellspacing="0" cellpadding="3">
                <tr>
                  ...
                  <td><input name="tap11" type="text" class="formularioselect" id="tap1" value="<?= $res["ap1"]; ?>" ></td>
                  <td width="36" align="center" class="textobold">Data:</td>
                  <td width="71"><input name="dap1" type="text" class="formularioselect" id="dap1" onKeyPress="return validanum(this, event)" onKeyUp="mdata(this)" value="<?= banco2data($res["dap1"]); ?>" size="7" maxlength="10" ></td>
				   <? 
				  if(empty($res["ap1"])){
				  ...
				  ?>
                  <td width="122" align="center"><input name="ap1" type="submit" class="microtxt" id="ap1" value="aprovar" onClick="<?= $javas; ?>">
                ...
                <tr>
                  ...
                  <td><input name="dap2" type="text" class="formularioselect" id="dap2" onKeyPress="return validanum(this, event)" onKeyUp="mdata(this)" value="<?= banco2data($res["dap2"]); ?>" size="7" maxlength="10" ></td>
				  <? 
				  if(empty($res["ap2"])){
				  	$javas="if(confirm('Deseja Aprovar Sum&aacute;rio?')){form1.acao.value='s4';form1.submit();}else{ return false; }";
				  }else{
				  ...
				  ?>
                  <td align="center"><input name="ap2" type="submit" class="microtxt" id="ap2" value="aprovar" onClick="<?= $javas; ?>">
                ...
                <tr>
                  ...
                  <td align="center" class="textobold">Data:</td>
                  <td><input name="dap3" type="text" class="formularioselect" id="dap3" onKeyPress="return validanum(this, event)" onKeyUp="mdata(this)" value="<?= banco2data($res["dap3"]); ?>" size="7" maxlength="10" ></td>
				  <? 
				  if(empty($res["ap3"])){
				  	$javas="if(confirm('Deseja Aprovar Sum&aacute;rio?')){form1.acao.value='s4';form1.submit();}else{ return false; }";
				  }else{
				  ...
				  ?>
                  <td align="center"><input name="ap3" type="submit" class="microtxt" id="ap3" value="aprovar" onClick="<?= $javas; ?>">
                ...
                <tr>
                  ...
                  <td align="center" class="textobold">Data:</td>
                  <td><input name="dap4" type="text" class="formularioselect" id="dap4" onKeyPress="return validanum(this, event)" onKeyUp="mdata(this)" value="<?= banco2data($res["dap4"]); ?>" size="7" maxlength="10"></td>
				  <? 
				  if(empty($res["ap4"])){
				  	$javas="if(confirm('Deseja Aprovar Sum&aacute;rio?')){form1.acao.value='s4';form1.submit();}else{ return false; }";
				  }else{
				  ...
				  ?>
                  <td align="center"><input name="ap4" type="submit" class="microtxt" id="ap4" value="aprovar" onClick="<?= $javas; ?>">
                ...
                <tr>
                  ...
                  <td align="center" class="textobold">Data:</td>
                  <td><input name="dap5" type="text" class="formularioselect" id="dap5" onKeyPress="return validanum(this, event)" onKeyUp="mdata(this)" value="<?= banco2data($res["dap5"]); ?>" size="7" maxlength="10"></td>
				  <? 
				  if(empty($res["ap5"])){
				  	$javas="if(confirm('Deseja Aprovar Sum&aacute;rio?')){form1.acao.value='s4';form1.submit();}else{ return false; }";
				  }else{
				  ...
				  ?>
                  <td align="center"><input name="ap5" type="submit" class="microtxt" id="ap5" value="aprovar" onClick="<?= $javas; ?>">
                ...
                <tr>
                  ...
                  <td align="center" class="textobold">Data:</td>
                  <td><input name="dap6" type="text" class="formularioselect" id="dap6" onKeyPress="return validanum(this, event)" onKeyUp="mdata(this)" value="<?= banco2data($res["dap6"]); ?>" size="7" maxlength="10" ></td>
				  <? 
				  if(empty($res["ap6"])){
				  	$javas="if(confirm('Deseja Aprovar Sum&aacute;rio?')){form1.acao.value='s4';form1.submit();}else{ return false; }";
				  }else{
				  ...
				  ?>
                  <td align="center"><input name="ap6" type="submit" class="microtxt" id="ap6" value="aprovar" onClick="<?= $javas; ?>">
...
&nbsp;
<input name="acao2" type="button" class="microtxt" value="Salvar em Disco" onClick="salvar('sumario','<?=$res["id"];?>')">
&nbsp;
