...
<a href="javascript:window.close();" onClick="marca('<? print $res["id"]; ?>','<?=$res["codigo"]." - ".$res["descricao"];?>');"></a>
<? if($wpaginar){ ?>
            ...
            <tr>
              <td align="center">
				...
				if($wp>1){
					$antz=true;
				?>
                      <a href="<? print "rec_plac_lise.php?wp=$pg_anterior&bdesc=$bdesc&bcod=$bcod"; ?>" class="texto">
                      <? } ?>
            ...
            Anterior</a>
				...
				?>
                    <td align="center">
                      ...
                      <a href="<? print "rec_plac_lise.php?wp=$link_impressos&bdesc=$bdesc&bcod=$bcod"; ?>" class="texto">
                      <? } ?>
				...
				?>
                    <td>
                      ...
                      <a href="<? print "rec_plac_lise.php?wp=$pg_proxima&bdesc=$bdesc&bcod=$bcod"; ?>" class="texto">
                      <? } ?>
