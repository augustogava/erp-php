...
<table width="594" border="0" cellpadding="0" cellspacing="0">
  <tr> 
    <td><table width="594" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td> <form name="form1" method="post" action="pdf/moni_esta_raudh_imp.php" onSubmit="return verifica(this)">
<table width="591" border="0" cellpadding="0" cellspacing="0" class="texto">
  <tr>
    ...
    <td width="564" align="right"><div align="left"><span class="textobold style1 style1"><span class="titulos">Monitoramento &gt; Estat&iacute;stica &gt; Relat&oacute;rio de Acesso po</span></span><span class="titulos">r Usu&aacute;rio, Data e Hora </span></div></td>
  </tr>
  <tr>
    <td align="center">&nbsp;</td>
    <td align="right">&nbsp;</td>
                  ...
                  <td><table width="412" border="0" cellspacing="3" cellpadding="0">
                    ...
                    <tr class="textobold">
                      <td>Nome Usu&aacute;rio:
                        <input name="usuario" type="hidden" id="usuario"></td>
                      <td><input name="usuarion" type="text" class="formulario" id="usuarion" size="50" onKeyPress="return validanum(this, event)" >
                        <a href="#" onClick="return abre('moni_esta_raudh_imp_busc.php','busca','width=320,height=300,scrollbars=1');"><img src="imagens/icon_14_search.gif" width="14" height="14" border="0"></a></td>
                    </tr>
                    <tr class="textobold">
                      <td width="86">Data: </td>
                      <td width="271"><label>
