...
<table width="594" border="0" cellpadding="0" cellspacing="0">
  <tr> 
    <td><table width="594" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td> <form name="form1" method="post" action="pdf/moni_esta_raus_imp.php" onSubmit="return verifica(this)">
<table width="591" border="0" cellpadding="0" cellspacing="0" class="texto">
  <tr>
    ...
    <td width="564" align="right"><div align="left"><span class="textobold style1 style1"><span class="titulos">Monitoramento &gt; Estat&iacute;stica &gt; Relat&oacute;rio de Acesso por Usu&aacute;rio </span></span></div></td>
  </tr>
  <tr>
    <td align="center">&nbsp;</td>
    <td align="right">&nbsp;</td>
                  ...
                  <td><table width="412" border="0" cellspacing="3" cellpadding="0">
                    ...
                    <tr class="textobold">
                      ...
                      <td><input name="nome_cli" type="text" class="formulario" id="nome_cli" size="50" onKeyPress="return validanum(this, event)" onKeyUp="mdata(this)">
                        <a href="#" onClick="return abre('moni_esta_raus_imp_busc.php','busca','width=320,height=300,scrollbars=1');"><img src="imagens/icon_14_search.gif" width="14" height="14" border="0"></a></td>
                    </tr>
                    <tr class="textobold">
