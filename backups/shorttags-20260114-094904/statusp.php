...
<? if($acao=="entrar"){ ?>
  <tr> 
    <td align="left" valign="top"><form action="" method="post" name="formid" id="formid" onSubmit="return <? if($errtent){ print "bloqueia"; }else{ print "verifica"; } ?>(this)">
        ...
        <table width="99%" border="0" cellpadding="0" cellspacing="0" bgcolor="#F7FFE8">
          ...
          <tr>
            <td width="639" align="left" bgcolor="#FFFFFF"><table width="100%"  border="0" cellpadding="0" cellspacing="0" class="texto">
                <tr>
                  <td width="23%"><strong>Pedido:</strong><? print completa($res["id"],10); ?></td>
                  <td width="30%"><strong>Data da Compra:</strong> <? print banco2data($res["data"]); ?></td>
                  <td width="47%"><strong>Hora da Compra:</strong> <? print $res["hora"]; ?></td>
                </tr>
                <tr>
            ...
            - a contar da data de aprova&ccedil;&atilde;o </td>
                ...
                <tr>
                  <td colspan="3"><strong>Em
                        <?= date("d/m/Y"); ?>
            a situa&ccedil;&atilde;o do pedido &eacute;:</strong> <? print $situ; ?></td>
                </tr>
                <tr>
                  <td colspan="3">&nbsp;</td>
                </tr>
	...
	$total=0;
		...
		?>
                  <tr bgcolor="#FFFFFF" class="texto" onMouseover="changeto('#CCCCCC')" onMouseout="changeback('#FFFFFF')">
                    <td align="left"">&nbsp;<? print "$res[produto_nome] - $res[medidas]"; ?></td>
                    <td align="left" >&nbsp;R$ <? print banco2valor($res["produto_preco"]) ?></td>
                    <td align="center" ><span class="texto_preto"><? print $res["qtd"] ?></span></td>
                    <td align="right" >R$ <? print banco2valor($res["produto_preco"]*$res["qtd"]) ?>&nbsp;</td>
                  </tr>
                  <?
	  	}
	  }
	  ?>
                  <tr align="right" bgcolor="#FFFFFF" class="texto" onMouseover="changeto('#CCCCCC')" onMouseout="changeback('#FFFFFF')">
                    ...
                    <td><strong>R$ <? print banco2valor($total); ?>&nbsp;</strong></td>
                  </tr>
              </table></td>
          </tr>
        </table>
