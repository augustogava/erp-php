...
<html lang="pt-BR">
<head>
<title><?=$acao=="alt"?"Editar":"Novo"?> Funcionario - ERP System</title>
<meta charset="UTF-8">
    ...
    <div class="erp-card">
        <div class="erp-card-header">
            <h1 class="erp-card-title">
                <i class="fas fa-<?=$acao=="alt"?"edit":"plus-circle"?>"></i>
                <?=$acao=="alt"?"Editar":"Novo"?> Funcionario
                <?=$acao=="alt"?" #".$id:""?>
            </h1>
            <div>
    ...
    <form name="form1" method="post" action="">
        ...
        <div style="display:flex;gap:12px;justify-content:flex-end;margin-top:24px;">
            ...
            <button type="submit" name="acao" value="<?=$acao=="alt"?"alterar":"incluir"?>" class="erp-btn erp-btn-success">
                <i class="fas fa-<?=$acao=="alt"?"save":"check"?>"></i> <?=$acao=="alt"?"Salvar Alteracoes":"Cadastrar Funcionario"?>
            </button>
        </div>
    </form>
</div>
