...
if($acao=="incluir"){
	...
	$b2=valor2banco($b2);
	$val=valor2banco($val);
	$sql=mysql_query("INSERT INTO perfil (perfil,b1,b2,val) VALUES ('$perfil','$b1','$b2','$val')");
	if($sql){
	...
	$b2=valor2banco($b2);
	$val=valor2banco($val);
	$sql=mysql_query("UPDATE perfil SET perfil='$perfil',b1='$b1',b2='$b2',val='$val' WHERE id='$id'");
	if($sql){
          ...
          <td><table width="300" border="0" cellspacing="0" cellpadding="0">
            ...
            <table width="300" border="0" cellpadding="0" cellspacing="1" bgcolor="#003366">
              ...
              <tr bgcolor="#FFFFFF" class="texto" onMouseover="changeto('#CCCCCC')" onMouseout="changeback('#FFFFFF')"> 
                <td>&nbsp;<? $sql2=mysql_query("SELECT * FROM prodserv WHERE id='$res[perfil]'"); $res2=mysql_fetch_array($sql2); print $res2["nome"]; ?></td>
                <td width="20" align="center"><a href="perfil.php?acao=alt&id=<? print $res["id"]; ?>"><img src="imagens/icon14_alterar.gif" alt="Alterar" width="14" height="14" border="0"></a></td>
                <td width="20" align="center"><a href="#" onClick="return pergunta('Deseja excluir este perfil?','perfil.php?acao=exc&id=<? print $res["id"]; ?>')"><img src="imagens/icon14_lixeira.gif" alt="Excluir" width="14" height="14" border="0"></a></td>
              </tr>
			  <?
			  	}
			  }
              ...
              <table width="300" border="0" cellpadding="0" cellspacing="0">
                <tr bgcolor="#003366"> 
                  <td colspan="2" align="center" class="textoboldbranco"> 
                    <? if($acao=="inc"){ print"Incluir Perfil"; }else{ print"Alterar Perfil";} ?>                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td width="227" class="textobold"><input name="b1" type="text" class="formulario" id="b1" value="<? print banco2valor($res["b1"]); ?>" size="10" onKeyDown="formataMoeda(this,retornaKeyCode(event))" onKeyUp="formataMoeda(this,retornaKeyCode(event))" <? if($class=="I") print "readonly"; ?> onBlur="ccusto(this.form);"></td>
                </tr>
                <tr>
                  <td class="textobold">&nbsp;Banda2(CI)</td>
                  <td class="textobold"><input name="b2" type="text" class="formulario" id="b2" value="<? print banco2valor($res["b2"]); ?>" size="10" onKeyDown="formataMoeda(this,retornaKeyCode(event))" onKeyUp="formataMoeda(this,retornaKeyCode(event))" <? if($class=="I") print "readonly"; ?> onBlur="ccusto(this.form);"></td>
                </tr>
                <tr>
                  <td class="textobold">&nbsp;Valor M&sup2; </td>
                  <td class="textobold"><input name="val" type="text" class="formulario" id="val" value="<? print banco2valor($res["val"]); ?>" size="10" onKeyDown="formataMoeda(this,retornaKeyCode(event))" onKeyUp="formataMoeda(this,retornaKeyCode(event))" <? if($class=="I") print "readonly"; ?> onBlur="ccusto(this.form);"></td>
                </tr>
                <tr align="center"> 
