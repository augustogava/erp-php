...
function seleciona(nome,id){
	...
	opener.form1.cliente_tipo.value='<? print $bt; ?>';
	window.close();
}
windowWidth=320;
windowHeight=300;
          ...
          <td align="center"><table width="1%" border="0" cellspacing="0" cellpadding="0">
              <tr valign="top"> 
				...
				if($wp>1){
					$antz=true;
				?>
                  <a href="<? print "nf_cli.php?wp=$pg_anterior&bcli=$bcli&btipo=$btipo"; ?>" class="paginacao2"> 
                  <? } ?>
                ...
                <td align="center"> 
                  ...
                  <a href="<? print "nf_cli.php?wp=$link_impressos&bcli=$bcli&btipo=$btipo"; ?>" class="paginacao"> 
                  <? } ?>
                ...
                <td> 
                  ...
                  <a href="<? print "nf_cli.php?wp=$pg_proxima&bcli=$bcli&btipo=$btipo"; ?>" class="paginacao2"> 
                  <? } ?>
