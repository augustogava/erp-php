          ...
          <td align="center"><table width="1%" border="0" cellspacing="0" cellpadding="0">
              <tr valign="top"> 
				...
				if($wp>1){
					$antz=true;
				?>
                  <a href="<? print "moni_esta_raudh_imp_busc.php?wp=$pg_anterior&bcli=$bcli"; ?>" class="paginacao2"> 
                  <? } ?>
                ...
                <td align="center"> 
                  ...
                  <a href="<? print "moni_esta_raudh_imp_busc.php?wp=$link_impressos&bcli=$bcli"; ?>" class="paginacao"> 
                  <? } ?>
                ...
                <td> 
                  ...
                  <a href="<? print "moni_esta_raudh_imp_busc.php?wp=$pg_proxima&bcli=$bcli"; ?>" class="paginacao2"> 
                  <? } ?>
