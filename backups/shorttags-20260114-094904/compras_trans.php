    ...
    <td align="center"><table width="300" border="0" cellpadding="0" cellspacing="1" bgcolor="#003366">
		...
		?>
		  <tr bgcolor="#FFFFFF" class="texto"> 
            ...
            <td width="20" align="center"><a href="#" onClick="return seleciona('<? print $res["id"]; ?>','<?= htmlspecialchars($resnome,ENT_QUOTES); ?>');"><img src="imagens/icon_14_use.gif" alt="Selecionar" width="14" height="14" border="0"></a></td>
          </tr>
		  <?
			}
		}
