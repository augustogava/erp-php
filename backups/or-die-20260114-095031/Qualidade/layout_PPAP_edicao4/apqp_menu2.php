...
$pc=$_SESSION["mpc"];
$npc=$_SESSION["npc"];
if(empty($pc)) header("Location:apqp_pc.php");
if($acao=="exc"){
    ...
    <td width="594"><table width="594" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td align="left" valign="top"><table width="594" border="0" cellpadding="0" cellspacing="1" bgcolor="#003366">
            ...
            <tr bgcolor="#FFFFFF">
              <td id="apqp1" colspan="2"><table width="590" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr align="center">
                  ...
                  <td width="118"><?php
			$sql=mysql_query("select * from apqp_cron WHERE peca='$pc' AND ativ='Desenho (Se aplic&aacute;vel)' AND responsavel<>''");
			if(mysql_num_rows($sql)){
				$link="<a href=\"apqp_des.php\">";
			}else{
				$link="<a href=\"#\" onclick=\"window.alert('Documento bloqueado! Pois n&atilde;o faz parte do Cronograma.')\">";
			}
			?>
                      <?php echo  $link; ?>
                    <img src="imagens/apqp_desen.gif" alt="Desenhos" width="32" height="32" border="0"></a> </td>
                  <td width="118"><?php
			$sql=mysql_query("select * from apqp_cron WHERE peca='$pc' AND ativ='FMEA de Projeto (Se aplic&aacute;vel)' AND responsavel<>''");
			if(mysql_num_rows($sql)){
			...
			?>
                      <?php echo  $link; ?>
                    <img src="imagens/apqp_fmeaproj.gif" alt="Fmea Proj." width="32" height="32" border="0"></a></td>
                  <td width="118"><?php
			...
			?>
                      <?php echo  $link; ?>
                    <img src="imagens/apqp_viab.gif" alt="Viabilidade" width="32" height="32" border="0"></a></td>
                </tr>
			...
			if(mysql_num_rows($sql)){
				...
				$link="<a href=\"#\" onclick=\"window.alert('Documento bloqueado! Pois n&atilde;o faz parte do Cronograma.')\" class=\"textobold\">";
			}
			?>
                      <?php echo  $link; ?>
                    Desenhos</a></td>
			...
			?>
                      <?php echo  $link; ?>
                    <img src="imagens/apqp_fluxo.gif" alt="Fluxo" width="32" height="32" border="0"></a></td>
                  <td width="118"><?php
			...
			?>
                      <?php echo  $link; ?>
                    <img src="imagens/apqp_fmeaproc.gif" alt="Fmea Proc." width="32" height="32" border="0"></a></td>
                  <td width="118"><?php
			...
			?>
                      <?php echo  $link; ?>
                    <img src="imagens/apqp_plano.gif" alt="Plano Controle" width="32" height="32" border="0"></a></td>
                  <td width="118"><?php
			$sql=mysql_query("select * from apqp_cron WHERE peca='$pc' AND ativ='Instru&ccedil;&otilde;es do Operador' AND responsavel<>''");
			if(mysql_num_rows($sql)){
			...
			?>
                      <?php echo  $link; ?>
                    <img src="imagens/apqp_instru.gif" alt="Int. Operador" width="32" height="32" border="0"></a></td>
                  <td width="118"><?php
			...
			?>
                      <?php echo  $link; ?>
                    <img src="imagens/apqp_rr.gif" alt="R&amp;R" width="32" height="32" border="0"></a></td>
                </tr>
                <tr align="center" class="textobold">
                  <td width="118"><?php
			$sql=mysql_query("select * from apqp_cron WHERE peca='$pc' AND ativ='Diagrama de Fluxo' AND responsavel<>''");
			...
			?>
                      <?php echo  $link; ?>
                    Instru&ccedil;&otilde;es do Operador </a></td>
                  <td width="118"><?php
			$sql=mysql_query("select * from apqp_cron WHERE peca='$pc' AND ativ='Estudos de R&R' AND responsavel<>''");
			if(mysql_num_rows($sql)){
			...
			?>
                      <?php echo  $link; ?>
                    <img src="imagens/apqp_capa.gif" alt="Capabilidade" width="32" height="32" border="0"></a></td>
                  <td width="118"><?php
			...
			?>
                      <?php echo  $link; ?>
                    <img src="imagens/apqp_dimen.gif" alt="Dimensional" width="32" height="32" border="0"></a></td>
                  <td width="118"><?php
			...
			?>
                      <?php echo  $link; ?>
                    <img src="imagens/apqp_material.gif" alt="Material" width="32" height="32" border="0"></a></td>
                  <td width="118"><?php
			...
			?>
                      <?php echo  $link; ?>
                    <img src="imagens/apqp_desem.gif" alt="Desempenho" width="32" height="32" border="0"></a></td>
                  <td width="118"><?php
			$sql=mysql_query("select * from apqp_cron WHERE peca='$pc' AND ativ='Relat&oacute;rio de Aprova&ccedil;&atilde;o de Apar&ecirc;ncia (Se aplic&aacute;vel)' AND responsavel<>''");
			if(mysql_num_rows($sql)){
			...
			?>
                      <?php echo  $link; ?>
                    <img src="imagens/apqp_apar.gif" alt="Apar&ecirc;ncia" width="32" height="32" border="0"></a></td>
                </tr>
                <tr align="center" class="textobold">
                  <td width="118"><?php
			$sql=mysql_query("select * from apqp_cron WHERE peca='$pc' AND ativ='Estudos de Capabilidade' AND responsavel<>''");
			...
			?>
                      <?php echo  $link; ?>
                    Aprova&ccedil;&atilde;o de Apar&ecirc;ncia </a></td>
                </tr>
                <tr align="center">
                  <td width="118"><?php
			$sql=mysql_query("select * from apqp_cron WHERE peca='$pc' AND ativ='Certificado de Submiss&atilde;o' AND responsavel<>''");
			if(mysql_num_rows($sql)){
			...
			?>
                      <?php echo  $link; ?>
                    <img src="imagens/apqp_subm.gif" alt="Submiss&atilde;o" width="32" height="32" border="0"></a></td>
                  <td width="118"><?php
			$sql=mysql_query("select * from apqp_cron WHERE peca='$pc' AND ativ='Sumario de Aprova&ccedil;&atilde;o do APQP (Valida&ccedil;&atilde;o final)' AND responsavel<>''");
			if(mysql_num_rows($sql)){
			...
			?>
                      <?php echo  $link; ?>
                    <img src="imagens/apqp_sumapro.gif" alt="Aprova&ccedil;&atilde;o" width="32" height="32" border="0"></a></td>
			...
			?>
                      <?php echo  $link; ?>
                    <img src="imagens/logo.png" alt="Aprov. Interina" width="44" height="32" border="0"></a></td>
                </tr>
                <tr align="center" class="textobold">
                  <td width="118"><?php
			$sql=mysql_query("select * from apqp_cron WHERE peca='$pc' AND ativ='Certificado de Submiss&atilde;o' AND responsavel<>''");
			...
			?>
                      <?php echo  $link; ?>
                    Certifica&ccedil;&atilde;o de Submiss&atilde;o </a></td>
                  <td width="118"><?php
			$sql=mysql_query("select * from apqp_cron WHERE peca='$pc' AND ativ='Sumario de Aprova&ccedil;&atilde;o do APQP (Valida&ccedil;&atilde;o final)' AND responsavel<>''");
			if(mysql_num_rows($sql)){
			...
			?>
                      <?php echo  $link; ?>
                    Sum&aacute;rio e Aprova&ccedil;&atilde;o do APQP</a> </td>
			...
			?>
                      <?php echo  $link; ?>
                    Aprova&ccedil;&atilde;o Interina</a></td>
                </tr>
              </table></td>
            </tr>
        </table></td>
