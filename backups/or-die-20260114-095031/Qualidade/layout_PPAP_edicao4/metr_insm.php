  ...
  <tr>
    <td><table width="590" border="0" cellpadding="0" cellspacing="0" class="texto">
      <tr>
        ...
        <td width="563" align="right"><div align="left" class="textobold style1">Instrumento de Medição</div></td>
      </tr>
    </table></td>
  </tr>
  <tr>
  ...
  <tr>
    <td>
      <div align="center">
        ...
        <input name="voltar" type="button" class="treemenu" value="Voltar" onClick="window.location='metr_insm_busca.php';">		
        &nbsp;&nbsp;&nbsp;&nbsp;
		<?php if ($acao=="alt"){ ?>
