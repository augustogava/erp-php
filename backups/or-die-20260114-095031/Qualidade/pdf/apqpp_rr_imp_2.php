...
if(!empty($car)){
	$s="and apqp_rr.car='$car'";
}
$gg=1;
$sqlh=mysql_query("SELECT * FROM apqp_rr,apqp_car WHERE apqp_rr.peca='$pc' AND apqp_rr.car=apqp_car.id AND apqp_car.disp='1' $s");
