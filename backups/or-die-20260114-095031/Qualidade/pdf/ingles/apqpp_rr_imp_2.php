...
if(mysql_num_rows($sqlh)) 
	...
	$pdf->SetFont('Arial','',8);
		...
		$pdf->SetXY(145, 38);
		$pdf->MultiCell(60,5,"Name Code\n $dispo",1);
		//linha 4
		$pdf->SetXY(5, 48);
		$pdf->MultiCell(40,5,"Char. No. \n $num",1);
		$pdf->SetXY(45, 48);
		$pdf->MultiCell(40,5,"Characteristc \n $carac",1);
		$pdf->SetXY(85, 48);
	...
	$pdf->MultiCell(205,5,"Out of the control limits: ".$resp["apf"]." R: ".banco2valor3($resp["rbar"])." LSCR: ".banco2valor3($resp["uclr"])."",0,'C');
	//em baixo rodape
