...
$pdf->SetXY(5, 3);
$pdf->MultiCell(290,5,"FMEA DE PROJETO",0,'C');
...
$sql=mysql_query("SELECT fmea1.*,op.numero FROM apqp_op AS op, apqp_fmeaproj AS fmea, apqp_fmeaproji AS fmea1 WHERE fmea.peca='$pc' AND fmea.id=fmea1.fmea AND fmea1.item=op.id AND op.peca='$pc' ORDER BY op.numero ASC, fmea1.ordem ASC");
