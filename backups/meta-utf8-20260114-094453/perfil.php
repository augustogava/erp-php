...
if($acao=="incluir"){
	...
	$b2=valor2banco($b2);
	$val=valor2banco($val);
	$sql=mysql_query("UPDATE perfil SET nome='$nome',perfil='$perfil',b1='$b1',b2='$b2' WHERE id='$id'") or die("UPDATE perfil SET nome='$nome',perfil='$perfil',b1='$b1',b2='$b2',val='$val' WHERE id='$id'");
	if($sql){
          ...
          <td><form name="form1" method="post" action="" onSubmit="return verifica(this)">
              <table width="300" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  ...
                  <td class="textobold"><input name="nome" type="text" class="formularioselect" id="nome" value="<?= $res["nome"]; ?>"></td>
                </tr>
                <tr>
