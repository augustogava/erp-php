        ...
        <table width="550" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr align="center">
            ...
            <td align="left" class="textobold"><select name="situacao" id="situacao">
              ...
              <option value="Em Produ��o" <? if($res["situacao"]=="Em Produ��o"){ print "Selected"; } ?>>Em Produ&ccedil;&atilde;o</option>
              ...
              <option value="Aguardando Aprova��o Lay-out" <? if($res["situacao"]=="Aguardando Aprova��o Lay-out"){ print "Selected"; } ?>>Aguardando Aprova��o Lay-out</option>
