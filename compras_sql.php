...
$entregaa=Input::request("entregaa");
$faturamento=Input::request("faturamento");
$dentrega=Input::request("dentrega");
$dentregan=Input::request("dentregan");
...
$recebimento=Input::request("recebimento");
...
$qtd_ent=Input::request("qtd_ent", []);
$oper=Input::request("oper", []);
$ent=Input::request("ent", []);
