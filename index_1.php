...
<script>
function statuss(){
window.status = "Cyber Manager 3.5.1";
setTimeout("statuss()", 1);
}
</script>
<html>
<head>
<title>Qualitymanager 3.5.1</title>
<meta charset="UTF-8">
      ...
      <table width="100%" height="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr bgcolor="#FFFFFF">
          ...
          <td align="left" valign="middle" background="imagens/fundo_top.gif" class="fundo_top"><div align="right">
            <table width="646" border="0" align="left" cellpadding="1" cellspacing="1">
              <tr>
                <td width="86"><div align="center"><a href="http://www.suporte.cybermanager.com.br" target="_blank"><img src="imagens/menu/suporte.jpg" width="86" height="21" border="0"></a></div></td>
                ...
                <td width="86"><div align="center"><a href="#" onClick="MM_openBrWindow('downloads/index.html','','width=522,height=225')"><img src="imagens/menu/downloads.jpg" width="86" height="21" border="0"></a></div></td>
                <td width="89"><div align="center"><a href="#" onClick="MM_openBrWindow('upgrades/index.html','','width=522,height=225')"><img src="imagens/menu/upgrades.jpg" width="89" height="21" border="0"></a></div></td>
                ...
                <td width="89"><div align="center"><a href="#" onClick="MM_openBrWindow('manual/man_index.html','','width=680,height=501')"><img src="imagens/menu/manual.jpg" width="89" height="21" border="0"></a></div></td>
                </tr>
            </table>
            </div></td>
        </tr>
