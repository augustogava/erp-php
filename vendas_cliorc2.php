...
<table width="300" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    <td align="center"><br>
      <a href="vendas_cliorc.php?acao=add" class="textobold"><span class="texto">Incluir Cliente </span></a></td></tr>
  <tr>
    <td><table width="300" border="0" cellpadding="0" cellspacing="1" bgcolor="#003366">
        ...
        <?php
			...
			if($results_tot>$maxpag){
				...
				$sql=mysql_query("SELECT * FROM clientesORDER BY nome ASC LIMIT $param, $maxpag");
    ...
    <td><table width="300" border="0" cellpadding="0" cellspacing="1" bgcolor="#003366">
      ...
      <?php
			...
			if($results_tot>$maxpag){
				...
				$sql=mysql_query("SELECT * FROM cliente_contato WHERE cliente='$cli' ORDER BY nome ASC LIMIT $param, $maxpag");
				$results_parc=mysql_num_rows($sql);
				$result_div=$results_tot/$maxpag;
				$n_inteiro=(int)$result_div;
				if($n_inteiro<$result_div){
