          ...
          <td><table width="300" border="0" cellspacing="0" cellpadding="0">
            ...
            <table width="300" border="0" cellpadding="0" cellspacing="1" bgcolor="#003366">
              ...
              <tr bgcolor="#FFFFFF" class="texto" onMouseover="changeto('#CCCCCC')" onMouseout="changeback('#FFFFFF')"> 
                <td>&nbsp;<?php $sql2=mysql_query("SELECT * FROM prodserv WHERE id='$res[perfil]'"); $res2=mysql_fetch_array($sql2); print $res2["nome"]; ?></td>
          ...
          <td><form name="form1" method="post" action="" onSubmit="return verifica(this)">
              <table width="300" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  ...
                  <td class="textobold"><input name="val" type="text" class="formulario" id="val" value="<?php print banco2valor($res["val"]); ?>" size="10" onKeyDown="formataMoeda(this,retornaKeyCode(event))" onKeyUp="formataMoeda(this,retornaKeyCode(event))" <?php if($class=="I") print "readonly"; ?> onBlur="ccusto(this.form);"></td>
                </tr>
                <tr align="center"> 
