...
function seleciona(id,nome){
	opener.form1.transp.value=id;
	opener.form1.transportadora.value=nome;
	window.close();
}
windowWidth=320;
windowHeight=300;
    ...
    <td align="center"><table width="300" border="0" cellpadding="0" cellspacing="1" bgcolor="#003366">
		...
		?>
		  <tr bgcolor="#FFFFFF" class="texto"> 
            ...
            <td width="20" align="center"><a href="#" onClick="return seleciona('<?php print $res["id"]; ?>','<?php echo  htmlspecialchars($resnome,ENT_QUOTES); ?>');"><img src="imagens/icon_14_use.gif" alt="Selecionar" width="14" height="14" border="0"></a></td>
          </tr>
		  <?php
			}
		}
